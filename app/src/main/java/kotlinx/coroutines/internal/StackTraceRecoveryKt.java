...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM7875constructorimpl2;
        ...
        try {
            ...
            objM7875constructorimpl = Result.m7875constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m7878exceptionOrNullimpl(objM7875constructorimpl) == null) {
            obj2 = objM7875constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM7875constructorimpl2 = Result.m7875constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM7875constructorimpl2 = Result.m7875constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m7878exceptionOrNullimpl(objM7875constructorimpl2) == null) {
            obj = objM7875constructorimpl2;
        }
