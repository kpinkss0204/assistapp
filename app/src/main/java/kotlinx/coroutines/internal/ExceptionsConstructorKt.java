...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM7875constructorimpl = Result.m7875constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m7881isFailureimpl(objM7875constructorimpl)) {
                objM7875constructorimpl = null;
            }
            return (E) objM7875constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM7875constructorimpl = Result.m7875constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m7881isFailureimpl(objM7875constructorimpl) ? null : objM7875constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM7875constructorimpl = Result.m7875constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m7881isFailureimpl(objM7875constructorimpl)) {
            objM7875constructorimpl = numValueOf;
        }
        return ((Number) objM7875constructorimpl).intValue();
    }
