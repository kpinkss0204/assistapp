...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM7875constructorimpl = Result.m7875constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m7881isFailureimpl(objM7875constructorimpl) ? null : objM7875constructorimpl);
