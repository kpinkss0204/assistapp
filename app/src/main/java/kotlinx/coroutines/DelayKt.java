...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo9451scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m9372delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m9373toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9373toDelayMillisLRDsOJo(long j) {
        boolean zM9239isPositiveimpl = Duration.m9239isPositiveimpl(j);
        if (zM9239isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m9223getInWholeMillisecondsimpl(Duration.m9241plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM9239isPositiveimpl) {
