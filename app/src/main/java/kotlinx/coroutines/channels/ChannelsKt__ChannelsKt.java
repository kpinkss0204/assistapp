...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM7875constructorimpl = Result.m7875constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m9399boximpl(Result.m7882isSuccessimpl(objM7875constructorimpl) ? ChannelResult.INSTANCE.m9414successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m9412closedJP2dKIU(Result.m7878exceptionOrNullimpl(objM7875constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo9384trySendJP2dKIU = sendChannel.mo9384trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m9409isSuccessimpl(sendChannel.mo9384trySendJP2dKIU(obj))) {
            return;
        }
