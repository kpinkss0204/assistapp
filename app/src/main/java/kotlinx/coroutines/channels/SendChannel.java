...
public interface SendChannel<E> {
    ...
    Object mo9384trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m9409isSuccessimpl(objMo9384trySendJP2dKIU)) {
                return true;
            }
            Throwable thM9403exceptionOrNullimpl = ChannelResult.m9403exceptionOrNullimpl(objMo9384trySendJP2dKIU);
