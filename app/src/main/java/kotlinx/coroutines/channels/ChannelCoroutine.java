...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo9391receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo9391receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo9392tryReceivePtdJZtk() {
        return this._channel.mo9392tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo9384trySendJP2dKIU(E e) {
        return this._channel.mo9384trySendJP2dKIU(e);
    }
