...
public interface ReceiveChannel<E> {
    ...
    Object mo9391receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo9392tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo9392tryReceivePtdJZtk = receiveChannel.mo9392tryReceivePtdJZtk();
            if (ChannelResult.m9409isSuccessimpl(objMo9392tryReceivePtdJZtk)) {
                return (E) ChannelResult.m9405getOrThrowimpl(objMo9392tryReceivePtdJZtk);
            }
            Throwable thM9403exceptionOrNullimpl = ChannelResult.m9403exceptionOrNullimpl(objMo9392tryReceivePtdJZtk);
            if (thM9403exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM9403exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo9391receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
