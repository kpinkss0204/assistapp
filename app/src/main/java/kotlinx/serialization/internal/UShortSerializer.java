...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m8154boximpl(m9509deserializeBwKQO78(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m9510serializei8woANY(encoder, ((UShort) obj).getData());
    }
    ...
    public void m9510serializei8woANY(Encoder encoder, short value) {
    ...
    public short m9509deserializeBwKQO78(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m8160constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
}
