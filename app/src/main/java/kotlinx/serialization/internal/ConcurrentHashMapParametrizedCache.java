...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo9471getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            ...
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList2, resultM7874boximpl);
