...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m8047boximpl(m9501deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m9502serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }
    ...
    public void m9502serialize2TYgG_w(Encoder encoder, long value) {
    ...
    public long m9501deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m8053constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
