...
public final class PolymorphicModuleBuilder<Base> {
    ...
    public final void m9512default(Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultSerializerProvider) {
