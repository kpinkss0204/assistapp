        ...
        */
        public void windowUpdate(int r8, long r9) {
            ...
            L2c:
                ...
                monitor-enter(r8)
                if (r1 != 0) goto L43
                io.grpc.okhttp.OkHttpClientTransport r0 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L8d
                io.grpc.okhttp.OutboundFlowController r0 = io.grpc.okhttp.OkHttpClientTransport.access$200(r0)     // Catch: java.lang.Throwable -> L8d
                r1 = 0
                int r9 = (int) r9     // Catch: java.lang.Throwable -> L8d
                r0.windowUpdate(r1, r9)     // Catch: java.lang.Throwable -> L8d
                monitor-exit(r8)     // Catch: java.lang.Throwable -> L8d
                return
            L43:
                io.grpc.okhttp.OkHttpClientTransport r0 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L8d
                java.util.Map r0 = io.grpc.okhttp.OkHttpClientTransport.access$2600(r0)     // Catch: java.lang.Throwable -> L8d
                ...
                io.grpc.okhttp.OkHttpClientStream r0 = (io.grpc.okhttp.OkHttpClientStream) r0     // Catch: java.lang.Throwable -> L8d
                if (r0 == 0) goto L68
                io.grpc.okhttp.OkHttpClientTransport r2 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L8d
                io.grpc.okhttp.OutboundFlowController r2 = io.grpc.okhttp.OkHttpClientTransport.access$200(r2)     // Catch: java.lang.Throwable -> L8d
                io.grpc.okhttp.OkHttpClientStream$TransportState r0 = r0.transportState()     // Catch: java.lang.Throwable -> L8d
                io.grpc.okhttp.OutboundFlowController$StreamState r0 = r0.getOutboundFlowState()     // Catch: java.lang.Throwable -> L8d
                int r9 = (int) r9     // Catch: java.lang.Throwable -> L8d
                r2.windowUpdate(r0, r9)     // Catch: java.lang.Throwable -> L8d
                goto L72
            L68:
                io.grpc.okhttp.OkHttpClientTransport r9 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch: java.lang.Throwable -> L8d
                boolean r9 = r9.mayHaveCreatedStream(r1)     // Catch: java.lang.Throwable -> L8d
                if (r9 != 0) goto L72
                r9 = 1
                goto L73
            L72:
