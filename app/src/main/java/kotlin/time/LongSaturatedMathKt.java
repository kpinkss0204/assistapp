...
public final class LongSaturatedMathKt {
    ...
    public static final long m9334saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM9251toLongimpl = Duration.m9251toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m9333checkInfiniteSumDefinedPjuGub4(j, j2, jM9251toLongimpl);
        }
        if (((jM9251toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m9335saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM9251toLongimpl;
        return ((j ^ j3) & (jM9251toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* JADX INFO: renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m9333checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m9237isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m9335saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM9208divUwyO8pc = Duration.m9208divUwyO8pc(j2, 2);
        long jM9251toLongimpl = Duration.m9251toLongimpl(jM9208divUwyO8pc, durationUnit);
        return (1 | (jM9251toLongimpl - 1)) == Long.MAX_VALUE ? jM9251toLongimpl : m9334saturatingAddNuflL3o(m9334saturatingAddNuflL3o(j, durationUnit, jM9208divUwyO8pc), durationUnit, Duration.m9240minusLRDsOJo(j2, jM9208divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m9307getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m9306getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m9258unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    public static final long saturatingOriginsDiff(long j, long j2, DurationUnit unit) {
        ...
        if (((j2 - 1) | 1) == Long.MAX_VALUE) {
            if (j == j2) {
                return Duration.INSTANCE.m9308getZEROUwyO8pc();
            }
            return Duration.m9258unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m9241plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m9258unaryMinusUwyO8pc(infinityOfSign(j3));
        }
