...
public final class JavaDataStorage {
    ...
    static final class C06911<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        final /* synthetic */ T $defaultValue;
        final /* synthetic */ Preferences.Key<T> $key;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06911(Preferences.Key<T> key, T t, Continuation<? super C06911> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C06911(this.$key, this.$defaultValue, continuation);
        }
    ...
    public final <T> T getSync(Preferences.Key<T> key, T defaultValue) {
        ...
        return (T) BuildersKt__BuildersKt.runBlocking$default(null, new C06911(key, defaultValue, null), 1, null);
    }
    ...
    static final class C06921 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Preferences>, Object> {
        final /* synthetic */ Preferences.Key<T> $key;
        final /* synthetic */ T $value;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06921(Preferences.Key<T> key, T t, Continuation<? super C06921> continuation) {
            super(2, continuation);
            this.$key = key;
            this.$value = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C06921(this.$key, this.$value, continuation);
        }
        ...
        static final class C01921 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ Preferences.Key<T> $key;
            final /* synthetic */ T $value;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01921(Preferences.Key<T> key, T t, Continuation<? super C01921> continuation) {
                super(2, continuation);
                this.$key = key;
                this.$value = t;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01921 c01921 = new C01921(this.$key, this.$value, continuation);
                c01921.L$0 = obj;
                return c01921;
            }
            ...
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C01921) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            Object objEdit = PreferencesKt.edit(JavaDataStorage.this.dataStore, new C01921(this.$key, this.$value, null), this);
    ...
    public final <T> Preferences putSync(Preferences.Key<T> key, T value) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default(null, new C06921(key, value, null), 1, null);
    }
    ...
    static final class C06901 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<Preferences.Key<?>, ? extends Object>>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C06901(continuation);
        }
    ...
    public final Map<Preferences.Key<?>, Object> getAllSync() {
        return (Map) BuildersKt__BuildersKt.runBlocking$default(null, new C06901(null), 1, null);
    }
    ...
    static final class C06891 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Preferences>, Object> {
        final /* synthetic */ Function1<MutablePreferences, Unit> $transform;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06891(Function1<? super MutablePreferences, Unit> function1, Continuation<? super C06891> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C06891(this.$transform, continuation);
        }
            ...
            try {
                if (i == 0) {
                    ...
                    if (!Intrinsics.areEqual(JavaDataStorage.this.editLock.get(), Boxing.boxBoolean(true))) {
                        ...
                        this.label = 1;
                        obj = PreferencesKt.edit(JavaDataStorage.this.dataStore, new C01911(this.$transform, null), this);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
        ...
        static final class C01911 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function1<MutablePreferences, Unit> $transform;
            /* synthetic */ Object L$0;
            int label;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01911(Function1<? super MutablePreferences, Unit> function1, Continuation<? super C01911> continuation) {
                super(2, continuation);
                this.$transform = function1;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01911 c01911 = new C01911(this.$transform, continuation);
                c01911.L$0 = obj;
                return c01911;
            }
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C01911) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public final Preferences editSync(Function1<? super MutablePreferences, Unit> transform) {
        ...
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default(null, new C06891(transform, null), 1, null);
    }
}
