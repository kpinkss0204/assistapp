...
class OnlineStateTracker {
    ...
    void handleWatchStreamStart() {
        if (this.watchStreamFailures == 0) {
            ...
            this.onlineStateTimer = this.workerQueue.enqueueAfterDelay(AsyncQueue.TimerId.ONLINE_STATE_TIMEOUT, DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM, new Runnable() { // from class: com.google.firebase.firestore.remote.OnlineStateTracker$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7839x16bdafa1();
                }
            });
        }
    }
