...
public final class zzbe {
    ...
    public static zzaq zza(String str, zzaf zzafVar, zzh zzhVar, List<zzaq> list) {
        ...
        double dZzb = AudioStats.AUDIO_AMPLITUDE_NONE;
        switch (b2) {
            case 0:
            ...
            case 6:
                ...
                if (list.size() > 1) {
                    ...
                    dZzb2 = dZza;
                    if (dZzb2 < AudioStats.AUDIO_AMPLITUDE_NONE) {
            ...
            case 16:
                ...
                if (dZza2 < AudioStats.AUDIO_AMPLITUDE_NONE) {
                    dMin = Math.max(dZza2 + dZzb3, AudioStats.AUDIO_AMPLITUDE_NONE);
                } else {
                    dMin = Math.min(dZza2, dZzb3);
                }
                if (list.size() == 2) {
                    double dZza3 = zzg.zza(zzhVar.zza(list.get(1)).zze().doubleValue());
                    if (dZza3 < AudioStats.AUDIO_AMPLITUDE_NONE) {
                        dZzb3 = Math.max(dZzb3 + dZza3, AudioStats.AUDIO_AMPLITUDE_NONE);
                    } else {
            ...
            case 19:
                ...
                if (list.size() > 1) {
                    ...
                    dZzb = dZza4 < AudioStats.AUDIO_AMPLITUDE_NONE ? ((double) zzafVar.zzb()) + dZza4 : dZza4;
                }
