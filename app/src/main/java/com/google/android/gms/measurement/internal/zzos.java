...
public final class zzos extends zzjd {
    ...
    */
    ...
    public static long zza(long j, long j2) {
        return (j + (j2 * ExponentialBackoff.DEFAULT_BACKOFF_MAX_DELAY_MS)) / CalendarModelKt.MillisecondsIn24Hours;
    }
    ...
    */
    ...
    final boolean zza(String str, double d) {
        try {
            ...
            editorEdit.putLong(ServerValues.NAME_OP_TIMESTAMP, Double.doubleToRawLongBits(d));
