...
import com.example.assistapp.features.ScheduleSharing.ScheduleListActivity
    ...
    private inner class GestureListener : GestureDetector.SimpleOnGestureListener() {
        ...
        override fun onDoubleTap(e: MotionEvent): Boolean {
            ...
            if (tapCount == 1) {
                ...
                binding.featureText.text = "일정 목록 화면으로 이동합니다."
                speak("일정 목록 화면으로 이동합니다.")
                startActivity(Intent(this@Feature2Activity, ScheduleListActivity::class.java))
                finish()
            }
            return true
        }
