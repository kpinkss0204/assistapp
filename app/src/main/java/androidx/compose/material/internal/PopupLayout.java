...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(Function0<Unit> function0, String str, View view, Density density, PopupPositionProvider popupPositionProvider, UUID uuid) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m2027getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        float fM7027constructorimpl = Dp.m7027constructorimpl(8);
        this.maxSupportedElevation = fM7027constructorimpl;
        ...
        this.dismissOnOutsideClick = new Function2<Offset, IntRect, Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$dismissOnOutsideClick$1
            ...
            public final Boolean invoke(Offset offset, IntRect intRect) {
                boolean z = false;
                if (offset != null && (Offset.m4327getXimpl(offset.getPackedValue()) < intRect.getLeft() || Offset.m4327getXimpl(offset.getPackedValue()) > intRect.getRight() || Offset.m4328getYimpl(offset.getPackedValue()) < intRect.getTop() || Offset.m4328getYimpl(offset.getPackedValue()) > intRect.getBottom())) {
                    z = true;
                }
        ...
        setElevation(density.mo657toPx0680j_4(fM7027constructorimpl));
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopup_androidKt.INSTANCE.m2025getLambda1$material_release(), null, 2, null);
    }
    ...
    public final IntSize m2027getPopupContentSizebOM6tXw() {
        return (IntSize) this.popupContentSize.getValue();
    }

    /* JADX INFO: renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m2028setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize intSizeM2027getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM2027getPopupContentSizebOM6tXw = m2027getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long packedValue = intSizeM2027getPopupContentSizebOM6tXw.getPackedValue();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long jMo629calculatePositionllwVHH4 = this.positionProvider.mo629calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, packedValue);
        this.params.x = IntOffset.m7155getXimpl(jMo629calculatePositionllwVHH4);
        this.params.y = IntOffset.m7156getYimpl(jMo629calculatePositionllwVHH4);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0074, code lost:
        ...
        if (r5.dismissOnOutsideClick.invoke((r6.getRawX() == 0.0f || r6.getRawY() == 0.0f) ? null : androidx.compose.ui.geometry.Offset.m4316boximpl(androidx.compose.ui.geometry.OffsetKt.Offset(r6.getRawX(), r6.getRawY())), r0).booleanValue() != false) goto L28;
     */
    @Override // android.view.View
    /*
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L5a:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m4316boximpl(r3)
        L6a:
