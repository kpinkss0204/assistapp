...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m7032equalsimpl0(this.defaultElevation, defaultFloatingActionButtonElevation.defaultElevation) && Dp.m7032equalsimpl0(this.pressedElevation, defaultFloatingActionButtonElevation.pressedElevation) && Dp.m7032equalsimpl0(this.hoveredElevation, defaultFloatingActionButtonElevation.hoveredElevation)) {
            return Dp.m7032equalsimpl0(this.focusedElevation, defaultFloatingActionButtonElevation.focusedElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m7033hashCodeimpl(this.defaultElevation) * 31) + Dp.m7033hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7033hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7033hashCodeimpl(this.focusedElevation);
    }
}
