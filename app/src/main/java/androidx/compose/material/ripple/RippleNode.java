...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2038addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    private RippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.rippleSize = Size.INSTANCE.m4405getZeroNHjbRc();
    ...
    public final long m2050getRippleColor0d7_KjU() {
        return this.color.mo1820invoke0d7_KjU();
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* JADX INFO: renamed from: onRemeasured-ozmzZPI */
    public void mo647onRemeasuredozmzZPI(long size) {
        float fMo657toPx0680j_4;
        this.hasValidSize = true;
        Density densityRequireDensity = DelegatableNodeKt.requireDensity(this);
        this.rippleSize = IntSizeKt.m7209toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            fMo657toPx0680j_4 = RippleAnimationKt.m2042getRippleEndRadiuscSwnlzA(densityRequireDensity, this.bounded, this.rippleSize);
        } else {
            fMo657toPx0680j_4 = densityRequireDensity.mo657toPx0680j_4(this.radius);
        }
        this.targetRadius = fMo657toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo2038addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m2055drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m2050getRippleColor0d7_KjU());
        }
