...
public final class RippleAnimation {
    ...
    */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00962(RippleAnimation.this, null), 3, null);
        ...
        static final class C00962 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00962(RippleAnimation rippleAnimation, Continuation<? super C00962> continuation) {
                super(2, continuation);
                this.this$0 = rippleAnimation;
            }
    ...
    static final class C04692 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04692 c04692 = RippleAnimation.this.new C04692(continuation);
            c04692.L$0 = obj;
            return c04692;
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04692(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m2041draw4WTKRHQ(DrawScope drawScope, long j) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m2043getRippleStartRadiusuvyYCjk(drawScope.mo5124getSizeNHjbRc()));
        }
        if (this.origin == null) {
            this.origin = Offset.m4316boximpl(drawScope.mo5123getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m4316boximpl(OffsetKt.Offset(Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc()) / 2.0f, Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM4327getXimpl = Offset.m4327getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp2 = MathHelpersKt.lerp(fM4327getXimpl, Offset.m4327getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM4328getYimpl = Offset.m4328getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long jOffset = OffsetKt.Offset(fLerp2, MathHelpersKt.lerp(fM4328getYimpl, Offset.m4328getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long jM4567copywmQWz5c$default = Color.m4567copywmQWz5c$default(j, Color.m4570getAlphaimpl(j) * fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m5105drawCircleVaOC9Bg$default(drawScope, jM4567copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
