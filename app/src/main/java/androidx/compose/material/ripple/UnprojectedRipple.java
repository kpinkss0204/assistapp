...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2057setColorDxMtmZc(long color, float alpha) {
        long jM2056calculateRippleColor5vOe2sY = m2056calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m4569equalsimpl0(color2.m4578unboximpl(), jM2056calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m4558boximpl(jM2056calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m4622toArgb8_81llA(jM2056calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m2056calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m4567copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
