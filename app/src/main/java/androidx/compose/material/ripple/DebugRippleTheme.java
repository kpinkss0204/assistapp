...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1800defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM2053defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2053defaultRippleColor5vOe2sY(Color.INSTANCE.m4594getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return jM2053defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM2052defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2052defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4594getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return rippleAlphaM2052defaultRippleAlphaDxMtmZc;
    }
}
