...
public final class CompatRippleTheme implements RippleTheme {
    ...
    public long mo1800defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM1924rippleColor5vOe2sY = rippleDefaults.m1924rippleColor5vOe2sY(((Color) objConsume).m4578unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return jM1924rippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        Object objConsume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        RippleAlpha rippleAlphaM1923rippleAlphaDxMtmZc = rippleDefaults.m1923rippleAlphaDxMtmZc(((Color) objConsume).m4578unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return rippleAlphaM1923rippleAlphaDxMtmZc;
    }
}
