...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1819apply7g2Lkgo(long j, float f, Composer composer, int i) {
        ...
        if (Dp.m7026compareTo0680j_4(f, Dp.m7027constructorimpl(0)) > 0 && !colors.isLight()) {
            composer.startReplaceGroup(1169013963);
            ComposerKt.sourceInformation(composer, "71@2841L42");
            j = ColorKt.m4613compositeOverOWjLjI(ElevationOverlayKt.m1845calculateForegroundColorCLU3JFs(j, f, composer, i & WebSocketProtocol.PAYLOAD_SHORT), j);
