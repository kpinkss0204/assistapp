...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4569equalsimpl0(this.checkedThumbColor, defaultSwitchColors.checkedThumbColor) && Color.m4569equalsimpl0(this.checkedTrackColor, defaultSwitchColors.checkedTrackColor) && Color.m4569equalsimpl0(this.uncheckedThumbColor, defaultSwitchColors.uncheckedThumbColor) && Color.m4569equalsimpl0(this.uncheckedTrackColor, defaultSwitchColors.uncheckedTrackColor) && Color.m4569equalsimpl0(this.disabledCheckedThumbColor, defaultSwitchColors.disabledCheckedThumbColor) && Color.m4569equalsimpl0(this.disabledCheckedTrackColor, defaultSwitchColors.disabledCheckedTrackColor) && Color.m4569equalsimpl0(this.disabledUncheckedThumbColor, defaultSwitchColors.disabledUncheckedThumbColor) && Color.m4569equalsimpl0(this.disabledUncheckedTrackColor, defaultSwitchColors.disabledUncheckedTrackColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m4575hashCodeimpl(this.checkedThumbColor) * 31) + Color.m4575hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m4575hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m4575hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m4575hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m4575hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m4575hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m4575hashCodeimpl(this.disabledUncheckedTrackColor);
    }
}
