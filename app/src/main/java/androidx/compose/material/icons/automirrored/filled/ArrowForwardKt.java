...
public final class ArrowForwardKt {
    ...
    public static final ImageVector getArrowForward(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.ArrowForward", Dp.m7027constructorimpl(24.0f), Dp.m7027constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
