...
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.ExitToApp", Dp.m7027constructorimpl(24.0f), Dp.m7027constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
