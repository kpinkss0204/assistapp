...
public final class ArrowBackKt {
    ...
    public static final ImageVector getArrowBack(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.ArrowBack", Dp.m7027constructorimpl(24.0f), Dp.m7027constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
