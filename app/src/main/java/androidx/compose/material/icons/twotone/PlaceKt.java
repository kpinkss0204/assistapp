...
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Place", Dp.m7027constructorimpl(24.0f), Dp.m7027constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder.close();
        ImageVector.Builder.m5258addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 0.3f, null, 1.0f, 1.0f, iM4921getButtKaPHkGw, iM4931getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
