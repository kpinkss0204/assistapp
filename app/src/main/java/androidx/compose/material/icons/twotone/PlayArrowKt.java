...
public final class PlayArrowKt {
    ...
    public static final ImageVector getPlayArrow(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PlayArrow", Dp.m7027constructorimpl(24.0f), Dp.m7027constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
