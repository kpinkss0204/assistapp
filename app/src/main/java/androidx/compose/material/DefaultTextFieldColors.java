...
final class DefaultTextFieldColors implements TextFieldColors {
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1016171324, i, -1, "androidx.compose.material.DefaultTextFieldColors.leadingIconColor (TextFieldDefaults.kt:807)");
        }
        if (!z) {
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1519634405, i, -1, "androidx.compose.material.DefaultTextFieldColors.leadingIconColor (TextFieldDefaults.kt:822)");
        }
        if (!z) {
            j = this.disabledLeadingIconColor;
        } else if (z2) {
    ...
    public State<Color> trailingIconColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(225259054, i, -1, "androidx.compose.material.DefaultTextFieldColors.trailingIconColor (TextFieldDefaults.kt:834)");
        }
        if (!z) {
    ...
    public State<Color> trailingIconColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1383318157, i, -1, "androidx.compose.material.DefaultTextFieldColors.trailingIconColor (TextFieldDefaults.kt:849)");
        }
        if (!z) {
            j = this.disabledTrailingIconColor;
        } else if (z2) {
    ...
    public State<Color> indicatorColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(998675979, i, -1, "androidx.compose.material.DefaultTextFieldColors.indicatorColor (TextFieldDefaults.kt:864)");
        }
        ...
        if (z) {
            ...
            ComposerKt.sourceInformation(composer2, "876@38330L33");
    ...
    public State<Color> backgroundColor(boolean z, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1423938813, i, -1, "androidx.compose.material.DefaultTextFieldColors.backgroundColor (TextFieldDefaults.kt:881)");
        }
    ...
    public State<Color> placeholderColor(boolean z, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(264799724, i, -1, "androidx.compose.material.DefaultTextFieldColors.placeholderColor (TextFieldDefaults.kt:886)");
        }
    ...
    public State<Color> labelColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(727091888, i, -1, "androidx.compose.material.DefaultTextFieldColors.labelColor (TextFieldDefaults.kt:895)");
        }
        State<Boolean> stateCollectIsFocusedAsState = FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14);
        if (!z) {
    ...
    public State<Color> textColor(boolean z, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(9804418, i, -1, "androidx.compose.material.DefaultTextFieldColors.textColor (TextFieldDefaults.kt:908)");
        }
    ...
    public State<Color> cursorColor(boolean z, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1446422485, i, -1, "androidx.compose.material.DefaultTextFieldColors.cursorColor (TextFieldDefaults.kt:913)");
        }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4569equalsimpl0(this.textColor, defaultTextFieldColors.textColor) && Color.m4569equalsimpl0(this.disabledTextColor, defaultTextFieldColors.disabledTextColor) && Color.m4569equalsimpl0(this.cursorColor, defaultTextFieldColors.cursorColor) && Color.m4569equalsimpl0(this.errorCursorColor, defaultTextFieldColors.errorCursorColor) && Color.m4569equalsimpl0(this.focusedIndicatorColor, defaultTextFieldColors.focusedIndicatorColor) && Color.m4569equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldColors.unfocusedIndicatorColor) && Color.m4569equalsimpl0(this.errorIndicatorColor, defaultTextFieldColors.errorIndicatorColor) && Color.m4569equalsimpl0(this.disabledIndicatorColor, defaultTextFieldColors.disabledIndicatorColor) && Color.m4569equalsimpl0(this.leadingIconColor, defaultTextFieldColors.leadingIconColor) && Color.m4569equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldColors.disabledLeadingIconColor) && Color.m4569equalsimpl0(this.errorLeadingIconColor, defaultTextFieldColors.errorLeadingIconColor) && Color.m4569equalsimpl0(this.trailingIconColor, defaultTextFieldColors.trailingIconColor) && Color.m4569equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldColors.disabledTrailingIconColor) && Color.m4569equalsimpl0(this.errorTrailingIconColor, defaultTextFieldColors.errorTrailingIconColor) && Color.m4569equalsimpl0(this.backgroundColor, defaultTextFieldColors.backgroundColor) && Color.m4569equalsimpl0(this.focusedLabelColor, defaultTextFieldColors.focusedLabelColor) && Color.m4569equalsimpl0(this.unfocusedLabelColor, defaultTextFieldColors.unfocusedLabelColor) && Color.m4569equalsimpl0(this.disabledLabelColor, defaultTextFieldColors.disabledLabelColor) && Color.m4569equalsimpl0(this.errorLabelColor, defaultTextFieldColors.errorLabelColor) && Color.m4569equalsimpl0(this.placeholderColor, defaultTextFieldColors.placeholderColor) && Color.m4569equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldColors.disabledPlaceholderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((Color.m4575hashCodeimpl(this.textColor) * 31) + Color.m4575hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4575hashCodeimpl(this.cursorColor)) * 31) + Color.m4575hashCodeimpl(this.errorCursorColor)) * 31) + Color.m4575hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.backgroundColor)) * 31) + Color.m4575hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m4575hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4575hashCodeimpl(this.errorLabelColor)) * 31) + Color.m4575hashCodeimpl(this.placeholderColor)) * 31) + Color.m4575hashCodeimpl(this.disabledPlaceholderColor);
    }
