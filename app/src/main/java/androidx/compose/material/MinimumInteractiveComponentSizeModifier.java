...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo348measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo5903measureBRTryo0.getWidth(), measureScope.mo651roundToPx0680j_4(DpSize.m7125getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo5903measureBRTryo0.getHeight(), measureScope.mo651roundToPx0680j_4(DpSize.m7123getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measureScope, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5903measureBRTryo0, MathKt.roundToInt((iMax - placeableMo5903measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo5903measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m7122equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m7127hashCodeimpl(this.size);
    }
}
