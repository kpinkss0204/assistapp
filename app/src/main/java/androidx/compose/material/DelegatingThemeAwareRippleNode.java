...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    public final void attachNewRipple() {
        this.rippleNode = delegate(androidx.compose.material.ripple.RippleKt.m2048createRippleModifierNodeTDGSqEk(this.interactionSource, this.bounded, this.radius, new ColorProducer() { // from class: androidx.compose.material.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1
            @Override // androidx.compose.ui.graphics.ColorProducer
            /* JADX INFO: renamed from: invoke-0d7_KjU, reason: not valid java name */
            public final long mo1820invoke0d7_KjU() {
                long jMo1820invoke0d7_KjU = this.this$0.color.mo1820invoke0d7_KjU();
                if (jMo1820invoke0d7_KjU != 16) {
                    return jMo1820invoke0d7_KjU;
                }
                ...
                return RippleDefaults.INSTANCE.m1924rippleColor5vOe2sY(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ContentColorKt.getLocalContentColor())).m4578unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ColorsKt.getLocalColors())).isLight());
            }
            ...
            public final RippleAlpha invoke() {
                ...
                RippleConfiguration rippleConfiguration = (RippleConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, RippleKt.getLocalRippleConfiguration());
                return (rippleConfiguration == null || (rippleAlpha = rippleConfiguration.getRippleAlpha()) == null) ? RippleDefaults.INSTANCE.m1923rippleAlphaDxMtmZc(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ContentColorKt.getLocalContentColor())).m4578unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ColorsKt.getLocalColors())).isLight()) : rippleAlpha;
            }
        }));
    }
