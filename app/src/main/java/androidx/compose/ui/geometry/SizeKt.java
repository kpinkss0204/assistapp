...
public final class SizeKt {
    ...
    public static /* synthetic */ void m4407getCenteruvyYCjk$annotations(long j) {
    }

    /* JADX INFO: renamed from: isSpecified-uvyYCjk, reason: not valid java name */
    public static final boolean m4408isSpecifieduvyYCjk(long j) {
    ...
    public static /* synthetic */ void m4409isSpecifieduvyYCjk$annotations(long j) {
    }

    /* JADX INFO: renamed from: isUnspecified-uvyYCjk, reason: not valid java name */
    public static final boolean m4410isUnspecifieduvyYCjk(long j) {
        return j == InlineClassHelperKt.UnspecifiedPackedFloats;
    }

    /* JADX INFO: renamed from: isUnspecified-uvyYCjk$annotations, reason: not valid java name */
    public static /* synthetic */ void m4411isUnspecifieduvyYCjk$annotations(long j) {
    }

    /* JADX INFO: renamed from: takeOrElse-TmRCtEA, reason: not valid java name */
    public static final long m4413takeOrElseTmRCtEA(long j, Function0<Size> function0) {
    ...
    public static final long m4412lerpVgWVRYQ(long j, long j2, float f) {
        ...
        return Size.m4387constructorimpl((((long) Float.floatToRawIntBits(fLerp)) << 32) | (((long) Float.floatToRawIntBits(fLerp2)) & 4294967295L));
    }

    /* JADX INFO: renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m4416timesd16Qtg0(int i, long j) {
        return Size.m4399times7Ah8Wj8(j, i);
    }

    /* JADX INFO: renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m4414timesd16Qtg0(double d, long j) {
        return Size.m4399times7Ah8Wj8(j, (float) d);
    }

    /* JADX INFO: renamed from: times-d16Qtg0, reason: not valid java name */
    public static final long m4415timesd16Qtg0(float f, long j) {
        return Size.m4399times7Ah8Wj8(j, f);
    }

    /* JADX INFO: renamed from: toRect-uvyYCjk, reason: not valid java name */
    public static final Rect m4417toRectuvyYCjk(long j) {
        return RectKt.m4367Recttz77jQw(Offset.INSTANCE.m4343getZeroF1C5BW0(), j);
    }

    /* JADX INFO: renamed from: getCenter-uvyYCjk, reason: not valid java name */
    public static final long m4406getCenteruvyYCjk(long j) {
    ...
    public static final long Size(float f, float f2) {
        return Size.m4387constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
}
