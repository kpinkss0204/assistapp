...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m4352getSizeNHjbRc$annotations() {
    }
    ...
    public final long m4360getSizeNHjbRc() {
    ...
    public final Rect m4364translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m4327getXimpl(offset), this.top + Offset.m4328getYimpl(offset), this.right + Offset.m4327getXimpl(offset), this.bottom + Offset.m4328getYimpl(offset));
    }
    ...
    public final long m4359getCenterRightF1C5BW0() {
    ...
    public final long m4356getBottomRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains-k-4lQ0M, reason: not valid java name */
    public final boolean m4353containsk4lQ0M(long offset) {
        return Offset.m4327getXimpl(offset) >= this.left && Offset.m4327getXimpl(offset) < this.right && Offset.m4328getYimpl(offset) >= this.top && Offset.m4328getYimpl(offset) < this.bottom;
    }
