...
public final class CornerRadiusKt {
    ...
    public static final long m4313lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m4302getXimpl(j), CornerRadius.m4302getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m4303getYimpl(j), CornerRadius.m4303getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m4296constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
}
