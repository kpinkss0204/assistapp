    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (scrollCaptureScrollByAction != null) {
                ...
                Offset offsetM4316boximpl = Offset.m4316boximpl(OffsetKt.Offset(0.0f, f));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                obj = scrollCaptureScrollByAction.invoke(offsetM4316boximpl, this);
        ...
        float fM4328getYimpl = Offset.m4328getYimpl(((Offset) obj).getPackedValue());
        if (z) {
            fM4328getYimpl = -fM4328getYimpl;
        }
        return Boxing.boxFloat(fM4328getYimpl);
    }
}
