...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo5045getSizeNHjbRc() {
            return this.this$0.getDrawParams().m5043getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* JADX INFO: renamed from: setSize-uvyYCjk, reason: not valid java name */
        public void mo5046setSizeuvyYCjk(long j) {
            this.this$0.getDrawParams().m5044setSizeuvyYCjk(j);
        }
    ...
    public void mo5028drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4427drawLineWko1d7g(start, end, m5018configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m4932getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo5029drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4427drawLineWko1d7g(start, end, m5016configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m4932getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo5036drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRect(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), m5014configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5037drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRect(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), m5012configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5027drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4425drawImaged4ec7I(image, topLeft, m5014configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public /* synthetic */ void mo5025drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4426drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m5014configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5026drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.drawParams.getCanvas().mo4426drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m5013configurePaintswdJneE(null, style, alpha, colorFilter, blendMode, filterQuality));
    }
    ...
    public void mo5038drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRoundRect(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), CornerRadius.m4302getXimpl(cornerRadius), CornerRadius.m4303getYimpl(cornerRadius), m5014configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5039drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRoundRect(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), CornerRadius.m4302getXimpl(cornerRadius), CornerRadius.m4303getYimpl(cornerRadius), m5012configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5023drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4424drawCircle9KIMszo(center, radius, m5014configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5024drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4424drawCircle9KIMszo(center, radius, m5012configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5030drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawOval(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), m5014configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5031drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawOval(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), m5012configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5021drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawArc(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), startAngle, sweepAngle, useCenter, m5014configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5022drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawArc(Offset.m4327getXimpl(topLeft), Offset.m4328getYimpl(topLeft), Offset.m4327getXimpl(topLeft) + Size.m4396getWidthimpl(size), Offset.m4328getYimpl(topLeft) + Size.m4393getHeightimpl(size), startAngle, sweepAngle, useCenter, m5012configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5033drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawPath(path, m5012configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5032drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawPath(path, m5014configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo5034drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4428drawPointsO7TthRY(pointMode, points, m5016configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m4932getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo5035drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo4428drawPointsO7TthRY(pointMode, points, m5018configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m4932getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    /* JADX INFO: renamed from: draw-yzxVdVo, reason: not valid java name */
    public final void m5020drawyzxVdVo(Density density, LayoutDirection layoutDirection, Canvas canvas, long size, Function1<? super DrawScope, Unit> block) {
        ...
        drawParams2.m5044setSizeuvyYCjk(size);
        canvas.save();
        block.invoke(this);
        canvas.restore();
        ...
        drawParams3.m5044setSizeuvyYCjk(size2);
    }
    ...
    private final Paint obtainFillPaint() {
        ...
        Paint.mo4451setStylek9PVt8s(PaintingStyle.INSTANCE.m4835getFillTiuSbCo());
    ...
    private final Paint obtainStrokePaint() {
        ...
        Paint Paint = AndroidPaint_androidKt.Paint();
        Paint.mo4451setStylek9PVt8s(PaintingStyle.INSTANCE.m4836getStrokeTiuSbCo());
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            ...
            if (!StrokeCap.m4917equalsimpl0(paintObtainStrokePaint.mo4443getStrokeCapKaPHkGw(), stroke.getCap())) {
                paintObtainStrokePaint.mo4449setStrokeCapBeK7IIE(stroke.getCap());
            }
            if (paintObtainStrokePaint.getStrokeMiterLimit() != stroke.getMiter()) {
                paintObtainStrokePaint.setStrokeMiterLimit(stroke.getMiter());
            }
            if (!StrokeJoin.m4927equalsimpl0(paintObtainStrokePaint.mo4444getStrokeJoinLxFBmk8(), stroke.getJoin())) {
                paintObtainStrokePaint.mo4450setStrokeJoinWw9F2mQ(stroke.getJoin());
            }
    ...
    static /* synthetic */ Paint m5014configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        if ((i3 & 32) != 0) {
            i2 = DrawScope.INSTANCE.m5127getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m5013configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, i2);
    }

    /* JADX INFO: renamed from: configurePaint-swdJneE, reason: not valid java name */
    private final Paint m5013configurePaintswdJneE(Brush brush, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintSelectPaint = selectPaint(style);
        if (brush != null) {
            brush.mo4515applyToPq9zytI(mo5124getSizeNHjbRc(), paintSelectPaint, alpha);
        } else {
            if (paintSelectPaint.getInternalShader() != null) {
                paintSelectPaint.setShader(null);
            }
            if (!Color.m4569equalsimpl0(paintSelectPaint.mo4441getColor0d7_KjU(), Color.INSTANCE.m4594getBlack0d7_KjU())) {
                paintSelectPaint.mo4447setColor8_81llA(Color.INSTANCE.m4594getBlack0d7_KjU());
            }
        ...
        if (!BlendMode.m4479equalsimpl0(paintSelectPaint.get_blendMode(), blendMode)) {
            paintSelectPaint.mo4446setBlendModes9anfk8(blendMode);
        }
        if (!FilterQuality.m4663equalsimpl0(paintSelectPaint.mo4442getFilterQualityfv9h1I(), filterQuality)) {
            paintSelectPaint.mo4448setFilterQualityvDHp3xo(filterQuality);
        }
        return paintSelectPaint;
    }

    /* JADX INFO: renamed from: configurePaint-2qPWKa0$default, reason: not valid java name */
    static /* synthetic */ Paint m5012configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        return canvasDrawScope.m5011configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, (i3 & 32) != 0 ? DrawScope.INSTANCE.m5127getDefaultFilterQualityfv9h1I() : i2);
    }

    /* JADX INFO: renamed from: configurePaint-2qPWKa0, reason: not valid java name */
    private final Paint m5011configurePaint2qPWKa0(long color, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintSelectPaint = selectPaint(style);
        long jM5019modulate5vOe2sY = m5019modulate5vOe2sY(color, alpha);
        if (!Color.m4569equalsimpl0(paintSelectPaint.mo4441getColor0d7_KjU(), jM5019modulate5vOe2sY)) {
            paintSelectPaint.mo4447setColor8_81llA(jM5019modulate5vOe2sY);
        }
        if (paintSelectPaint.getInternalShader() != null) {
            paintSelectPaint.setShader(null);
        }
    ...
    static /* synthetic */ Paint m5016configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m5015configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.INSTANCE.m5127getDefaultFilterQualityfv9h1I() : i4);
    }

    /* JADX INFO: renamed from: configureStrokePaint-Q_0CZUI, reason: not valid java name */
    private final Paint m5015configureStrokePaintQ_0CZUI(long color, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintObtainStrokePaint = obtainStrokePaint();
        long jM5019modulate5vOe2sY = m5019modulate5vOe2sY(color, alpha);
        if (!Color.m4569equalsimpl0(paintObtainStrokePaint.mo4441getColor0d7_KjU(), jM5019modulate5vOe2sY)) {
            paintObtainStrokePaint.mo4447setColor8_81llA(jM5019modulate5vOe2sY);
        }
        ...
        if (!BlendMode.m4479equalsimpl0(paintObtainStrokePaint.get_blendMode(), blendMode)) {
            paintObtainStrokePaint.mo4446setBlendModes9anfk8(blendMode);
        }
        ...
        if (!StrokeCap.m4917equalsimpl0(paintObtainStrokePaint.mo4443getStrokeCapKaPHkGw(), cap)) {
            paintObtainStrokePaint.mo4449setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m4927equalsimpl0(paintObtainStrokePaint.mo4444getStrokeJoinLxFBmk8(), join)) {
            paintObtainStrokePaint.mo4450setStrokeJoinWw9F2mQ(join);
        }
        if (!Intrinsics.areEqual(paintObtainStrokePaint.getPathEffect(), pathEffect)) {
            paintObtainStrokePaint.setPathEffect(pathEffect);
        }
        if (!FilterQuality.m4663equalsimpl0(paintObtainStrokePaint.mo4442getFilterQualityfv9h1I(), filterQuality)) {
            paintObtainStrokePaint.mo4448setFilterQualityvDHp3xo(filterQuality);
        }
        return paintObtainStrokePaint;
    }

    /* JADX INFO: renamed from: configureStrokePaint-ho4zsrM$default, reason: not valid java name */
    static /* synthetic */ Paint m5018configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m5017configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.INSTANCE.m5127getDefaultFilterQualityfv9h1I() : i4);
    }

    /* JADX INFO: renamed from: configureStrokePaint-ho4zsrM, reason: not valid java name */
    private final Paint m5017configureStrokePaintho4zsrM(Brush brush, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintObtainStrokePaint = obtainStrokePaint();
        if (brush != null) {
            brush.mo4515applyToPq9zytI(mo5124getSizeNHjbRc(), paintObtainStrokePaint, alpha);
    ...
    private final long m5019modulate5vOe2sY(long j, float f) {
        return f == 1.0f ? j : Color.m4567copywmQWz5c$default(j, Color.m4570getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final /* data */ class DrawParams {
        ...
        public static /* synthetic */ DrawParams m5040copyUg5Nnss$default(DrawParams drawParams, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return drawParams.m5042copyUg5Nnss(density, layoutDirection, canvas2, j);
        }
        ...
        public final DrawParams m5042copyUg5Nnss(Density density, LayoutDirection layoutDirection, Canvas canvas, long size) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.density, drawParams.density) && this.layoutDirection == drawParams.layoutDirection && Intrinsics.areEqual(this.canvas, drawParams.canvas) && Size.m4392equalsimpl0(this.size, drawParams.size);
        }

        public int hashCode() {
            return (((((this.density.hashCode() * 31) + this.layoutDirection.hashCode()) * 31) + this.canvas.hashCode()) * 31) + Size.m4397hashCodeimpl(this.size);
        }

        public String toString() {
            return "DrawParams(density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", canvas=" + this.canvas + ", size=" + ((Object) Size.m4400toStringimpl(this.size)) + ')';
        }
        ...
        public /* synthetic */ DrawParams(Density density, LayoutDirection layoutDirection, EmptyCanvas emptyCanvas, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? DrawContextKt.getDefaultDensity() : density, (i & 2) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 4) != 0 ? new EmptyCanvas() : emptyCanvas, (i & 8) != 0 ? Size.INSTANCE.m4405getZeroNHjbRc() : j, null);
        }
        ...
        /* JADX INFO: renamed from: getSize-NH-jbRc, reason: not valid java name */
        public final long m5043getSizeNHjbRc() {
            return this.size;
        }

        /* JADX INFO: renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m5044setSizeuvyYCjk(long j) {
            this.size = j;
        }
    }
}
