...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4510getSrcOver0nO6VwU();
    }
    ...
    public long mo4441getColor0d7_KjU() {
    ...
    public void mo4447setColor8_81llA(long j) {
        AndroidPaint_androidKt.m4453setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo4446setBlendModes9anfk8(int i) {
        if (BlendMode.m4479equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m4452setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4445getStyleTiuSbCo() {
    ...
    public void mo4451setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m4457setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo4443getStrokeCapKaPHkGw() {
    ...
    public void mo4449setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m4455setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4444getStrokeJoinLxFBmk8() {
    ...
    public void mo4450setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m4456setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo4442getFilterQualityfv9h1I() {
    ...
    public void mo4448setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m4454setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
