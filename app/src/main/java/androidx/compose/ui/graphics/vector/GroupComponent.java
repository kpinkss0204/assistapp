...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m4604getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m5252markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m5252markTintForColor8_81llA(long color) {
        if (this.isTintable && color != 16) {
            long j = this.tintColor;
            if (j == 16) {
                this.tintColor = color;
            } else {
                if (VectorKt.m5275rgbEqualOWjLjI(j, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m5252markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM4799constructorimpl$default = this.groupMatrix;
        if (fArrM4799constructorimpl$default == null) {
            fArrM4799constructorimpl$default = Matrix.m4799constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM4799constructorimpl$default;
        } else {
            Matrix.m4808resetimpl(fArrM4799constructorimpl$default);
        }
        float[] fArr = fArrM4799constructorimpl$default;
        Matrix.m4819translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m4811rotateZimpl(fArr, this.rotation);
        Matrix.m4812scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m4819translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            if (fArr != null) {
                transform.mo5053transform58bKbWc((fArr != null ? Matrix.m4797boximpl(fArr) : null).m4820unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.m5180clipPathmtrdDE$default(transform, path, 0, 2, null);
            }
