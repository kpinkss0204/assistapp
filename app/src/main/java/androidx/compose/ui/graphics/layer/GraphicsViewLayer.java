...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m4343getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m5240applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5240applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m5206getOffscreenke2Ky5w());
        } else {
            m5240applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5200equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5206getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4479equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4510getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo5235setPivotOffsetk4lQ0M(long j) {
        ...
        if (OffsetKt.m4348isUnspecifiedk4lQ0M(j)) {
            ...
            this.viewLayer.setPivotX(IntSize.m7197getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m7196getHeightimpl(this.size) / 2.0f);
            return;
        }
        this.shouldManuallySetCenterPivot = false;
        this.viewLayer.setPivotX(Offset.m4327getXimpl(j));
        this.viewLayer.setPivotY(Offset.m4328getYimpl(j));
    }
    ...
    public void mo5232setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m4622toArgb8_81llA(j));
        }
    }
    ...
    public void mo5237setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m4622toArgb8_81llA(j));
        }
    }
    ...
    public void mo5236setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m7195equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m7197getWidthimpl(size) + x, IntSize.m7196getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m7197getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m7196getHeightimpl(size) / 2.0f);
            }
        } else {
            int i = this.x;
            if (i != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                Canvas canvasBeginRecording = picture.beginRecording(IntSize.m7197getWidthimpl(this.size), IntSize.m7196getHeightimpl(this.size));
                try {
                    ...
                    if (canvasHolder2 != null) {
                        ...
                        if (canvasDrawScope != null) {
                            ...
                            drawParams2.m5044setSizeuvyYCjk(jM7209toSizeozmzZPI);
                            androidCanvas.save();
                            ...
                            drawParams3.m5044setSizeuvyYCjk(size);
                        } else {
                            canvasHolder = canvasHolder2;
                            canvas = internalCanvas;
                        }
