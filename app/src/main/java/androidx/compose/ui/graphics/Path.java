...
public interface Path {
    ...
    void mo4458addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo4460opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo4461setFillTypeoQ8Xj4U(int i);

    /* JADX INFO: renamed from: transform-58bKbWc */
    default void mo4462transform58bKbWc(float[] matrix) {
    }

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo4463translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4841transform58bKbWc(Path path, float[] fArr) {
            Path.super.mo4462transform58bKbWc(fArr);
        }
    ...
    static /* synthetic */ void m4838addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo4458addPathUv8p0NA(path2, j);
    }
    ...
    default Path plus(Path path) {
        ...
        Path.mo4460opN5in7k0(this, path, PathOperation.INSTANCE.m4863getUnionb3I0S0c());
        return Path;
    }

    default Path minus(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo4460opN5in7k0(this, path, PathOperation.INSTANCE.m4860getDifferenceb3I0S0c());
        return Path;
    }
    ...
    default Path and(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo4460opN5in7k0(this, path, PathOperation.INSTANCE.m4861getIntersectb3I0S0c());
        return Path;
    }

    default Path xor(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo4460opN5in7k0(this, path, PathOperation.INSTANCE.m4864getXorb3I0S0c());
        return Path;
    }
    ...
    public static final class Companion {
        ...
        public final Path m4839combinexh6zSI8(int operation, Path path1, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo4460opN5in7k0(path1, path2, operation)) {
                return Path;
            }
