...
public final class StrokeJoin {
    ...
    private static final int Miter = m4925constructorimpl(0);
    private static final int Round = m4925constructorimpl(1);
    private static final int Bevel = m4925constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m4924boximpl(int i) {
        return new StrokeJoin(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m4925constructorimpl(int i) {
        return i;
    }
    ...
    public String toString() {
        return m4929toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4929toStringimpl(int i) {
        return m4927equalsimpl0(i, Miter) ? "Miter" : m4927equalsimpl0(i, Round) ? "Round" : m4927equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}
