...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4657getAutoNrFUSI();
    private long size = Size.INSTANCE.m4404getUnspecifiedNHjbRc();
    ...
    public void mo4758setAmbientShadowColor8_81llA(long j) {
        if (Color.m4569equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo4760setSpotShadowColor8_81llA(long j) {
        if (Color.m4569equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo4761setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m4953equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo4759setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4653equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m4880setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo4758setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4760setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4761setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4959getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo4759setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4657getAutoNrFUSI());
        m4880setSizeuvyYCjk(Size.INSTANCE.m4404getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo568createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
