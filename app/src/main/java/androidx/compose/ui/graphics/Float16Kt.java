...
public final class Float16Kt {
    ...
    private static final short One = Float16.m4676constructorimpl(1.0f);
    private static final short NegativeOne = Float16.m4676constructorimpl(-1.0f);
    ...
    public static final short m4715minAoSsdG0(short s, short s2) {
        if (Float16.m4687isNaNimpl(s) || Float16.m4687isNaNimpl(s2)) {
            return Float16.Companion.m4709getNaNslo4al4();
        }
        return Float16.m4674compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* JADX INFO: renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4714maxAoSsdG0(short s, short s2) {
        if (Float16.m4687isNaNimpl(s) || Float16.m4687isNaNimpl(s2)) {
            return Float16.Companion.m4709getNaNslo4al4();
        }
        return Float16.m4674compareTo41bOqos(s, s2) >= 0 ? s : s2;
