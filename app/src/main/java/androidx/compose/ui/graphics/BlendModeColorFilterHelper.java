...
final class BlendModeColorFilterHelper {
    ...
    public final android.graphics.BlendModeColorFilter m4514BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new android.graphics.BlendModeColorFilter(ColorKt.m4622toArgb8_81llA(color), AndroidBlendMode_androidKt.m4419toAndroidBlendModes9anfk8(blendMode));
    }
