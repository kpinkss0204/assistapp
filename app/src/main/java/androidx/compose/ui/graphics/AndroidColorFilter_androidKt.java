...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m4434actualTintColorFilterxETnrds(long j, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BlendModeColorFilterHelper.INSTANCE.m4514BlendModeColorFilterxETnrds(j, i);
        }
        return new PorterDuffColorFilter(ColorKt.m4622toArgb8_81llA(j), AndroidBlendMode_androidKt.m4420toPorterDuffModes9anfk8(i));
    }

    /* JADX INFO: renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final android.graphics.ColorFilter m4432actualColorMatrixColorFilterjHGOpc(float[] fArr) {
    ...
    public static final android.graphics.ColorFilter m4433actualLightingColorFilterOWjLjI(long j, long j2) {
        return new android.graphics.LightingColorFilter(ColorKt.m4622toArgb8_81llA(j), ColorKt.m4622toArgb8_81llA(j2));
    }

    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter colorFilter) {
        if ((colorFilter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4648getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) colorFilter);
        }
