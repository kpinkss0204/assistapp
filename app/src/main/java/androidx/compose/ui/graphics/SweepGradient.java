...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo4537createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m4348isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m4406getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset(Offset.m4327getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m4396getWidthimpl(size) : Offset.m4327getXimpl(this.center), Offset.m4328getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m4393getHeightimpl(size) : Offset.m4328getYimpl(this.center));
        }
        return ShaderKt.m4887SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m4324equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iM4329hashCodeimpl = ((Offset.m4329hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM4329hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m4346isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m4335toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
