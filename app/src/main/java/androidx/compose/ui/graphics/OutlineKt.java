...
public final class OutlineKt {
    public static final void addOutline(Path path, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.m4838addPathUv8p0NA$default(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }

    /* JADX INFO: renamed from: drawOutline-wDX37Ww$default, reason: not valid java name */
    public static /* synthetic */ void m4827drawOutlinewDX37Ww$default(DrawScope drawScope, Outline outline, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        m4826drawOutlinewDX37Ww(drawScope, outline, j, f2, drawStyle2, colorFilter, (i2 & 32) != 0 ? DrawScope.INSTANCE.m5126getDefaultBlendMode0nO6VwU() : i);
    }

    /* JADX INFO: renamed from: drawOutline-hn5TExg$default, reason: not valid java name */
    public static /* synthetic */ void m4825drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        if ((i2 & 32) != 0) {
            i = DrawScope.INSTANCE.m5126getDefaultBlendMode0nO6VwU();
        }
        m4824drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }
    ...
    public static final void drawOutline(Canvas canvas, Outline outline, Paint paint) {
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            if (roundRectPath != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m4302getXimpl(rounded.getRoundRect().m4375getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m4303getYimpl(rounded.getRoundRect().m4375getBottomLeftCornerRadiuskKHJgLs()), paint);
                return;
            }
        }
        if (!(outline instanceof Outline.Generic)) {
    ...
    private static final boolean hasSameCornerRadius(RoundRect roundRect) {
        return ((CornerRadius.m4302getXimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m4302getXimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m4302getXimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m4302getXimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m4302getXimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m4302getXimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m4302getXimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m4302getXimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m4302getXimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m4302getXimpl(roundRect.m4377getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m4302getXimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m4302getXimpl(roundRect.m4377getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0) && ((CornerRadius.m4303getYimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m4303getYimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m4303getYimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m4303getYimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m4303getYimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m4303getYimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m4303getYimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m4303getYimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m4303getYimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m4303getYimpl(roundRect.m4377getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m4303getYimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m4303getYimpl(roundRect.m4377getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0);
    }

    /* JADX INFO: renamed from: drawOutline-wDX37Ww, reason: not valid java name */
    public static final void m4826drawOutlinewDX37Ww(DrawScope drawScope, Outline outline, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawScope.mo5037drawRectnJ9OG0(j, topLeft(rect), size(rect), f, drawStyle, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            Path roundRectPath = rounded.getRoundRectPath();
            if (roundRectPath != null) {
                drawScope.mo5033drawPathLG529CI(roundRectPath, j, f, drawStyle, colorFilter, i);
                return;
            }
            RoundRect roundRect = rounded.getRoundRect();
            drawScope.mo5039drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m4302getXimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), drawStyle, f, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Generic) {
            drawScope.mo5033drawPathLG529CI(((Outline.Generic) outline).getPath(), j, f, drawStyle, colorFilter, i);
            return;
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public static final void m4824drawOutlinehn5TExg(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawScope.mo5036drawRectAsUm42w(brush, topLeft(rect), size(rect), f, drawStyle, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            Path roundRectPath = rounded.getRoundRectPath();
            if (roundRectPath != null) {
                drawScope.mo5032drawPathGBMwjPU(roundRectPath, brush, f, drawStyle, colorFilter, i);
                return;
            }
            RoundRect roundRect = rounded.getRoundRect();
            drawScope.mo5038drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m4302getXimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, drawStyle, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Generic) {
            drawScope.mo5032drawPathGBMwjPU(((Outline.Generic) outline).getPath(), brush, f, drawStyle, colorFilter, i);
            return;
        }
        throw new NoWhenBranchMatchedException();
    }
