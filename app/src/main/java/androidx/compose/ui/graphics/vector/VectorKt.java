...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4921getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4932getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4508getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4603getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4851getNonZeroRgk1Os();
    ...
    public static final boolean m5275rgbEqualOWjLjI(long j, long j2) {
        return Color.m4574getRedimpl(j) == Color.m4574getRedimpl(j2) && Color.m4573getGreenimpl(j) == Color.m4573getGreenimpl(j2) && Color.m4571getBlueimpl(j) == Color.m4571getBlueimpl(j2);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m4479equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4508getSrcIn0nO6VwU()) || BlendMode.m4479equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4510getSrcOver0nO6VwU());
    }
}
