...
public final class ColorSpaceKt {
    ...
    private static final Connector m4988createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.INSTANCE.identity$ui_graphics_release(colorSpace);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m4975equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4982getRgbxdoWZVw()) && ColorModel.m4975equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m4982getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m4987connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m5003getPerceptualuksYyKA();
        }
        return m4986connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* JADX INFO: renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m4986connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics_release | id$ui_graphics_release2) < 0) {
            return m4988createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        Connector connectorM4988createConnectorYBCOT_4 = connectors.get(i2);
        if (connectorM4988createConnectorYBCOT_4 == null) {
            connectorM4988createConnectorYBCOT_4 = m4988createConnectorYBCOT_4(colorSpace, colorSpace2, i);
            connectors.set(i2, connectorM4988createConnectorYBCOT_4);
        }
        return connectorM4988createConnectorYBCOT_4;
    }
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m4975equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4982getRgbxdoWZVw())) {
            Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
