...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m4609tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m4508getSrcIn0nO6VwU();
            }
            return companion.m4612tintxETnrds(j, i);
        }

        /* JADX INFO: renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m4612tintxETnrds(long color, int blendMode) {
        ...
        public final ColorFilter m4610colorMatrixjHGOpc(float[] colorMatrix) {
        ...
        public final ColorFilter m4611lightingOWjLjI(long multiply, long add) {
