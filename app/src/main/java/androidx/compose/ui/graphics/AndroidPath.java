...
public final class AndroidPath implements Path {
    ...
    public int mo4459getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4850getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4851getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo4461setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4846equalsimpl0(i, PathFillType.INSTANCE.m4850getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = CornerRadius.m4302getXimpl(roundRect.m4377getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m4303getYimpl(roundRect.m4377getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m4302getXimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m4303getYimpl(roundRect.m4378getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m4302getXimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m4303getYimpl(roundRect.m4376getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m4302getXimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m4303getYimpl(roundRect.m4375getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo4458addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m4327getXimpl(offset), Offset.m4328getYimpl(offset));
            return;
        }
    ...
    public void mo4463translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m4327getXimpl(offset), Offset.m4328getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo4462transform58bKbWc(float[] matrix) {
    ...
    public boolean mo4460opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4856equalsimpl0(operation, PathOperation.INSTANCE.m4860getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4856equalsimpl0(operation, PathOperation.INSTANCE.m4861getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4856equalsimpl0(operation, PathOperation.INSTANCE.m4862getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4856equalsimpl0(operation, PathOperation.INSTANCE.m4863getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
