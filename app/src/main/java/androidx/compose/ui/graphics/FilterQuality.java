...
public final class FilterQuality {
    ...
    private static final int None = m4661constructorimpl(0);
    private static final int Low = m4661constructorimpl(1);
    private static final int Medium = m4661constructorimpl(2);
    private static final int High = m4661constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FilterQuality m4660boximpl(int i) {
    ...
    public static boolean m4662equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m4666unboximpl();
    }
    ...
    public static String m4665toStringimpl(int i) {
        return m4663equalsimpl0(i, None) ? "None" : m4663equalsimpl0(i, Low) ? "Low" : m4663equalsimpl0(i, Medium) ? "Medium" : m4663equalsimpl0(i, High) ? "High" : "Unknown";
    }
}
