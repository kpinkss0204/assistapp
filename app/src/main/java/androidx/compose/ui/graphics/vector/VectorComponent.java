...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4384boximpl(Size.INSTANCE.m4405getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m4404getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    drawContext.getTransform().mo5052scale0AR0LA0(f, f2, jM4343getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m5268getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo4435getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m4789getArgb8888_sVssgQ();
    }
    ...
    public final long m5269getViewportSizeNHjbRc$ui_release() {
    ...
    public final void m5270setViewportSizeuvyYCjk$ui_release(long j) {
        this.viewportSize.setValue(Size.m4384boximpl(j));
    }

    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        int iM4789getArgb8888_sVssgQ;
        if (this.root.getIsTintable() && this.root.getTintColor() != 16 && VectorKt.tintableWithAlphaMask(getIntrinsicColorFilter$ui_release()) && VectorKt.tintableWithAlphaMask(colorFilter)) {
            iM4789getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m4788getAlpha8_sVssgQ();
        } else {
            iM4789getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m4789getArgb8888_sVssgQ();
        }
        int i = iM4789getArgb8888_sVssgQ;
        if (this.isDirty || !Size.m4392equalsimpl0(this.previousDrawSize, drawScope.mo5124getSizeNHjbRc()) || !ImageBitmapConfig.m4784equalsimpl0(i, m5268getCacheBitmapConfig_sVssgQ$ui_release())) {
            this.tintFilter = ImageBitmapConfig.m4784equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4788getAlpha8_sVssgQ()) ? ColorFilter.Companion.m4609tintxETnrds$default(ColorFilter.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
            this.rootScaleX = Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc()) / Size.m4396getWidthimpl(m5269getViewportSizeNHjbRc$ui_release());
            this.rootScaleY = Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) / Size.m4393getHeightimpl(m5269getViewportSizeNHjbRc$ui_release());
            this.cacheDrawScope.m5251drawCachedImageFqjB98A(i, IntSizeKt.IntSize((int) Math.ceil(Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc())), (int) Math.ceil(Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo5124getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        ...
        sb.append(Size.m4396getWidthimpl(m5269getViewportSizeNHjbRc$ui_release())).append("\n\tviewportHeight: ");
        sb.append(Size.m4393getHeightimpl(m5269getViewportSizeNHjbRc$ui_release())).append("\n");
