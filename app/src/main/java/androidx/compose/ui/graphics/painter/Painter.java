...
public abstract class Painter {
    ...
    public abstract long mo5244getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m5249drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m5250drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* JADX INFO: renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m5250drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter) {
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(drawScope.getLayoutDirection());
        float fM4396getWidthimpl = Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc()) - Size.m4396getWidthimpl(j);
        float fM4393getHeightimpl = Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) - Size.m4393getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, fM4396getWidthimpl, fM4393getHeightimpl);
        if (f > 0.0f) {
            try {
                if (Size.m4396getWidthimpl(j) > 0.0f && Size.m4393getHeightimpl(j) > 0.0f) {
                    if (this.useLayer) {
                        Rect rectM4367Recttz77jQw = RectKt.m4367Recttz77jQw(Offset.INSTANCE.m4343getZeroF1C5BW0(), SizeKt.Size(Size.m4396getWidthimpl(j), Size.m4393getHeightimpl(j)));
                        Canvas canvas = drawScope.getDrawContext().getCanvas();
                        try {
                            canvas.saveLayer(rectM4367Recttz77jQw, obtainPaint());
                            onDraw(drawScope);
                            canvas.restore();
                        } catch (Throwable th) {
                            canvas.restore();
