...
public final class AndroidTileMode_androidKt {
    ...
    public static final boolean m4472isSupported0vamqd0(int i) {
        return Build.VERSION.SDK_INT >= 31 || !TileMode.m4937equalsimpl0(i, TileMode.INSTANCE.m4942getDecal3opZhB0());
    }

    /* JADX INFO: renamed from: toAndroidTileMode-0vamqd0, reason: not valid java name */
    public static final Shader.TileMode m4473toAndroidTileMode0vamqd0(int i) {
        if (TileMode.m4937equalsimpl0(i, TileMode.INSTANCE.m4941getClamp3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
        if (TileMode.m4937equalsimpl0(i, TileMode.INSTANCE.m4944getRepeated3opZhB0())) {
            return Shader.TileMode.REPEAT;
        }
        if (TileMode.m4937equalsimpl0(i, TileMode.INSTANCE.m4943getMirror3opZhB0())) {
            return Shader.TileMode.MIRROR;
        }
        if (TileMode.m4937equalsimpl0(i, TileMode.INSTANCE.m4942getDecal3opZhB0())) {
    ...
    public static final int toComposeTileMode(Shader.TileMode tileMode) {
        ...
        if (i == 1) {
            return TileMode.INSTANCE.m4941getClamp3opZhB0();
        }
        if (i == 2) {
            return TileMode.INSTANCE.m4943getMirror3opZhB0();
        }
        if (i == 3) {
            return TileMode.INSTANCE.m4944getRepeated3opZhB0();
        }
        if (Build.VERSION.SDK_INT >= 31 && tileMode == Shader.TileMode.DECAL) {
            return TileModeVerificationHelper.INSTANCE.m4945getComposeTileModeDecal3opZhB0();
        }
        return TileMode.INSTANCE.m4941getClamp3opZhB0();
    }
}
