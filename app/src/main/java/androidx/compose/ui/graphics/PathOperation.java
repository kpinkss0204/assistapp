...
public final class PathOperation {
    ...
    private static final int Difference = m4854constructorimpl(0);
    private static final int Intersect = m4854constructorimpl(1);
    private static final int Union = m4854constructorimpl(2);
    private static final int Xor = m4854constructorimpl(3);
    private static final int ReverseDifference = m4854constructorimpl(4);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m4853boximpl(int i) {
        return new PathOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m4854constructorimpl(int i) {
        return i;
    }
    ...
    public static String m4858toStringimpl(int i) {
        return m4856equalsimpl0(i, Difference) ? "Difference" : m4856equalsimpl0(i, Intersect) ? "Intersect" : m4856equalsimpl0(i, Union) ? "Union" : m4856equalsimpl0(i, Xor) ? "Xor" : m4856equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
}
