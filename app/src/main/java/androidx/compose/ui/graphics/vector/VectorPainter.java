...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter(GroupComponent groupComponent) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4384boximpl(Size.INSTANCE.m4405getZeroNHjbRc()), null, 2, null);
    ...
    public final long m5277getSizeNHjbRc$ui_release() {
    ...
    public final void m5279setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m4384boximpl(j));
    }
    ...
    public final long m5278getViewportSizeNHjbRc$ui_release() {
        return this.vector.m5269getViewportSizeNHjbRc$ui_release();
    }

    /* JADX INFO: renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m5280setViewportSizeuvyYCjk$ui_release(long j) {
        this.vector.m5270setViewportSizeuvyYCjk$ui_release(j);
    }
    ...
    public final int m5276getBitmapConfig_sVssgQ$ui_release() {
        return this.vector.m5268getCacheBitmapConfig_sVssgQ$ui_release();
    }
    ...
    public long getIntrinsicSize() {
        return m5277getSizeNHjbRc$ui_release();
    }
