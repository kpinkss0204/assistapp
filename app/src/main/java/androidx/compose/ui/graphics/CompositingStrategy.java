...
public final class CompositingStrategy {
    ...
    private static final int Auto = m4651constructorimpl(0);
    private static final int Offscreen = m4651constructorimpl(1);
    private static final int ModulateAlpha = m4651constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m4650boximpl(int i) {
