...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5292getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4921getButtKaPHkGw();
        }
        return m5291getStrokeLineCapCSYIeUk(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m5291getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m4921getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m4923getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4922getRoundKaPHkGw();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m5294getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4932getMiterLxFBmk8();
        }
        return m5293getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m5293getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m4932getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m4931getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m4933getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        long jM4604getUnspecified0d7_KjU;
        int iM4508getSrcIn0nO6VwU;
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM4604getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
                jM4604getUnspecified0d7_KjU = Color.INSTANCE.m4604getUnspecified0d7_KjU();
            }
        } else {
            jM4604getUnspecified0d7_KjU = Color.INSTANCE.m4604getUnspecified0d7_KjU();
        }
        long j = jM4604getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4508getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4510getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4508getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4507getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4499getModulate0nO6VwU();
                    break;
                case 15:
                    iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4504getScreen0nO6VwU();
                    break;
                case 16:
                    iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4502getPlus0nO6VwU();
                    break;
                default:
                    iM4508getSrcIn0nO6VwU = BlendMode.INSTANCE.m4508getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM4508getSrcIn0nO6VwU;
        float fM7027constructorimpl = Dp.m7027constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM7027constructorimpl2 = Dp.m7027constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM7027constructorimpl, fM7027constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM5291getStrokeLineCapCSYIeUk = m5291getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m4921getButtKaPHkGw());
        int iM5293getStrokeLineJoinkLtJ_vA = m5293getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m4931getBevelLxFBmk8());
        ...
        typedArrayObtainAttributes.recycle();
        builder.m5259addPathoIyEayM(list, namedInt == 0 ? PathFillType.INSTANCE.m4851getNonZeroRgk1Os() : PathFillType.INSTANCE.m4850getEvenOddRgk1Os(), str, obtainBrushFromComplexColor(namedComplexColor), namedFloat, obtainBrushFromComplexColor(namedComplexColor2), namedFloat3, namedFloat4, iM5291getStrokeLineCapCSYIeUk, iM5293getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
