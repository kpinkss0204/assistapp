...
public final class Lab extends ColorSpace {
    ...
    public Lab(String str, int i) {
        super(str, ColorModel.INSTANCE.m4981getLabxdoWZVw(), i, null);
    }
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        return (((long) Float.floatToRawIntBits((f > D ? f * f * f : (f - C) * 0.12841855f) * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[1])) & 4294967295L) | (((long) Float.floatToRawIntBits(f3 * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[0])) << 32);
    }
