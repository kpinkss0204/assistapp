...
public final class SolidColor extends Brush {
    ...
    public void mo4515applyToPq9zytI(long size, Paint p, float alpha) {
        long jM4567copywmQWz5c$default;
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            long j = this.value;
            jM4567copywmQWz5c$default = Color.m4567copywmQWz5c$default(j, Color.m4570getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            jM4567copywmQWz5c$default = this.value;
        }
        p.mo4447setColor8_81llA(jM4567copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m4569equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m4576toStringimpl(this.value)) + ')';
    }
}
