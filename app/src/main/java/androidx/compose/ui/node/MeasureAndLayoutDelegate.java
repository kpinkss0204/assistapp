...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m6093updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m6968boximpl(constraints);
    ...
    private final boolean m6090doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM6053lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM6053lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m6057lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM6053lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m6053lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM6053lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (parent$ui_release.getLookaheadRoot() == null) {
                ...
                return zM6053lookaheadRemeasure_Sx5XlM$ui_release$default;
            }
    ...
    private final boolean m6091doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM6054remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM6054remeasure_Sx5XlM$ui_release$default = layoutNode.m6058remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM6054remeasure_Sx5XlM$ui_release$default = LayoutNode.m6054remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM6054remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui_release$default(parent$ui_release, false, false, false, 3, null);
                return zM6054remeasure_Sx5XlM$ui_release$default;
            }
    ...
    public final void m6092measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m6090doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6968boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m6091doRemeasuresdFAvZA(layoutNode, Constraints.m6968boximpl(constraints));
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        boolean zM6090doLookaheadRemeasuresdFAvZA;
        LayoutNode parent$ui_release;
        if (layoutNode.getIsDeactivated()) {
            return false;
        }
        ...
        if (affectsLookahead) {
            zM6090doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m6090doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            if (relayoutNeeded && ((zM6090doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true))) {
                layoutNode.lookaheadReplace$ui_release();
            }
        } else {
            boolean zM6091doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m6091doRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            zM6090doLookaheadRemeasuresdFAvZA = zM6091doRemeasuresdFAvZA;
        }
        drainPostponedMeasureRequests();
        return zM6090doLookaheadRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m6090doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m6091doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
