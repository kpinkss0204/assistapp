...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m6025requireCoordinator64DMado(node, NodeKind.m6138constructorimpl(8)));
        }
        return DelegatableNodeKt.m6025requireCoordinator64DMado(node, NodeKind.m6138constructorimpl(8)).touchBoundsInRoot();
    }
}
