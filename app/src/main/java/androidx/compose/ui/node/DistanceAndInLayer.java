...
final class DistanceAndInLayer {
    ...
    public static final /* synthetic */ DistanceAndInLayer m6036boximpl(long j) {
    ...
    public static boolean m6039equalsimpl(long j, Object obj) {
        return (obj instanceof DistanceAndInLayer) && j == ((DistanceAndInLayer) obj).m6045unboximpl();
    }
    ...
    public static final boolean m6043isInLayerimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m6039equalsimpl(this.packedValue, obj);
    }
    ...
    public String toString() {
        return m6044toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m6045unboximpl() {
    ...
    public static final int m6037compareToS_HNhKs(long j, long j2) {
        boolean zM6043isInLayerimpl = m6043isInLayerimpl(j);
        if (zM6043isInLayerimpl != m6043isInLayerimpl(j2)) {
            return zM6043isInLayerimpl ? -1 : 1;
        }
        return (int) Math.signum(m6041getDistanceimpl(j) - m6041getDistanceimpl(j2));
    }

    /* JADX INFO: renamed from: getDistance-impl, reason: not valid java name */
    public static final float m6041getDistanceimpl(long j) {
