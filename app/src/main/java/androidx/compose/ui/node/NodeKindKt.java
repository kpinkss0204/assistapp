...
public final class NodeKindKt {
    ...
    public static final boolean m6146contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m6148or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int iM6138constructorimpl = NodeKind.m6138constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(256);
        }
        if (node instanceof ApproachLayoutModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(131072);
        }
        if (node instanceof TraversableNode) {
            iM6138constructorimpl |= NodeKind.m6138constructorimpl(262144);
        }
        mutableObjectIntMap.set(objClassKeyForObject, iM6138constructorimpl);
        return iM6138constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m6138constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m6025requireCoordinator64DMado(node, NodeKind.m6138constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m6138constructorimpl(128) & i) != 0 && (node instanceof LayoutAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m6138constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m6138constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m6138constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m6138constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m6138constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode) && i2 != 2) {
                FocusTargetNodeKt.invalidateFocusTarget((FocusTargetNode) node);
            }
            if ((NodeKind.m6138constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m6138constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m6147getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m6138constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? NodeKind.m6138constructorimpl(128) | iM6138constructorimpl : iM6138constructorimpl;
    }
}
