...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m6089setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m6085getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* JADX INFO: renamed from: getConstraints-msEJaDk$ui_release, reason: not valid java name */
    public final long m6084getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m5965setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m5965setMeasuredSizeozmzZPI(IntSize.INSTANCE.m7202getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo5904placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public final void mo5904placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m6083placeSelfgyyYBs(position);
    ...
    private final void m6083placeSelfgyyYBs(long position) {
        if (!IntOffset.m7154equalsimpl0(getPosition(), position)) {
            m6089setPositiongyyYBs(position);
    ...
    public final void m6087placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m6083placeSelfgyyYBs(IntOffset.m7159plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m6086performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m6088positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long jM7165getZeronOccac = IntOffset.INSTANCE.m7165getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                jM7165getZeronOccac = IntOffset.m7159plusqkQi6aY(jM7165getZeronOccac, lookaheadDelegate.getPosition());
            }
