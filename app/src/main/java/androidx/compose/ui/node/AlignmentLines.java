...
public abstract class AlignmentLines {
    ...
    protected abstract long mo6010calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo6010calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fM4327getXimpl = Offset.m4328getYimpl(jOffset);
        } else {
            fM4327getXimpl = Offset.m4327getXimpl(jOffset);
        }
        int iRound = Math.round(fM4327getXimpl);
