...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        float fM7027constructorimpl = Dp.m7027constructorimpl(((Context) objConsume).getResources().getDimension(i) / ((Density) objConsume2).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return fM7027constructorimpl;
    }
}
