...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m7173getSizeYbymL2g$annotations() {
    }
    ...
    public final long m7181getSizeYbymL2g() {
    ...
    public final IntRect m7185translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m7155getXimpl(offset), this.top + IntOffset.m7156getYimpl(offset), this.right + IntOffset.m7155getXimpl(offset), this.bottom + IntOffset.m7156getYimpl(offset));
    }
    ...
    public final long m7178getCenternOccac() {
    ...
    public final long m7180getCenterRightnOccac() {
    ...
    public final long m7176getBottomLeftnOccac() {
    ...
    public final long m7175getBottomCenternOccac() {
    ...
    public final long m7177getBottomRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m7174containsgyyYBs(long offset) {
        return IntOffset.m7155getXimpl(offset) >= this.left && IntOffset.m7155getXimpl(offset) < this.right && IntOffset.m7156getYimpl(offset) >= this.top && IntOffset.m7156getYimpl(offset) < this.bottom;
    }
