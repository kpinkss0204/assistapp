...
public final /* data */ class DpRect {
    ...
    public static /* synthetic */ DpRect m7099copya9UjIt4$default(DpRect dpRect, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpRect.left;
        }
        if ((i & 2) != 0) {
    ...
    public final DpRect m7108copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7032equalsimpl0(this.left, dpRect.left) && Dp.m7032equalsimpl0(this.top, dpRect.top) && Dp.m7032equalsimpl0(this.right, dpRect.right) && Dp.m7032equalsimpl0(this.bottom, dpRect.bottom);
    }

    public int hashCode() {
        return (((((Dp.m7033hashCodeimpl(this.left) * 31) + Dp.m7033hashCodeimpl(this.top)) * 31) + Dp.m7033hashCodeimpl(this.right)) * 31) + Dp.m7033hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m7038toStringimpl(this.left)) + ", top=" + ((Object) Dp.m7038toStringimpl(this.top)) + ", right=" + ((Object) Dp.m7038toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m7038toStringimpl(this.bottom)) + ')';
    }
    ...
    public final float m7110getLeftD9Ej5fM() {
        return this.left;
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM, reason: not valid java name */
    public final float m7112getTopD9Ej5fM() {
        return this.top;
    }

    /* JADX INFO: renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m7111getRightD9Ej5fM() {
        return this.right;
    }

    /* JADX INFO: renamed from: getBottom-D9Ej5fM, reason: not valid java name */
    public final float m7109getBottomD9Ej5fM() {
        return this.bottom;
    }

    private DpRect(long j, long j2) {
        this(DpOffset.m7088getXD9Ej5fM(j), DpOffset.m7090getYD9Ej5fM(j), Dp.m7027constructorimpl(DpOffset.m7088getXD9Ej5fM(j) + DpSize.m7125getWidthD9Ej5fM(j2)), Dp.m7027constructorimpl(DpOffset.m7090getYD9Ej5fM(j) + DpSize.m7123getHeightD9Ej5fM(j2)), null);
    }
}
