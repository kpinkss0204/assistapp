...
public final class IntRectKt {
    ...
    public static final IntRect m7187IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m7155getXimpl(j), IntOffset.m7156getYimpl(j), IntOffset.m7155getXimpl(j) + IntSize.m7197getWidthimpl(j2), IntOffset.m7156getYimpl(j) + IntSize.m7196getHeightimpl(j2));
    }

    /* JADX INFO: renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m7186IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m7155getXimpl(j), IntOffset.m7156getYimpl(j), IntOffset.m7155getXimpl(j2), IntOffset.m7156getYimpl(j2));
    }

    /* JADX INFO: renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m7188IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m7155getXimpl(j) - i, IntOffset.m7156getYimpl(j) - i, IntOffset.m7155getXimpl(j) + i, IntOffset.m7156getYimpl(j) + i);
    }
