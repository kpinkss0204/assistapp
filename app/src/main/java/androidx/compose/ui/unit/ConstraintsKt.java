...
public final class ConstraintsKt {
    ...
    public static final long createConstraints(int i, int i2, int i3, int i4) {
        ...
        return Constraints.m6969constructorimpl((((long) i8) << 33) | ((long) i11) | (((long) i) << 2) | (((long) i3) << (i12 + 15)) | (((long) i10) << (i12 + 46)));
    }
    ...
    public static final long m6995constrainN9IONVI(long j, long j2) {
        return Constraints(RangesKt.coerceIn(Constraints.m6982getMinWidthimpl(j2), Constraints.m6982getMinWidthimpl(j), Constraints.m6980getMaxWidthimpl(j)), RangesKt.coerceIn(Constraints.m6980getMaxWidthimpl(j2), Constraints.m6982getMinWidthimpl(j), Constraints.m6980getMaxWidthimpl(j)), RangesKt.coerceIn(Constraints.m6981getMinHeightimpl(j2), Constraints.m6981getMinHeightimpl(j), Constraints.m6979getMaxHeightimpl(j)), RangesKt.coerceIn(Constraints.m6979getMaxHeightimpl(j2), Constraints.m6981getMinHeightimpl(j), Constraints.m6979getMaxHeightimpl(j)));
    }

    /* JADX INFO: renamed from: constrain-4WqzIAM, reason: not valid java name */
    public static final long m6994constrain4WqzIAM(long j, long j2) {
        return IntSizeKt.IntSize(RangesKt.coerceIn(IntSize.m7197getWidthimpl(j2), Constraints.m6982getMinWidthimpl(j), Constraints.m6980getMaxWidthimpl(j)), RangesKt.coerceIn(IntSize.m7196getHeightimpl(j2), Constraints.m6981getMinHeightimpl(j), Constraints.m6979getMaxHeightimpl(j)));
    }

    /* JADX INFO: renamed from: constrainWidth-K40F9xA, reason: not valid java name */
    public static final int m6997constrainWidthK40F9xA(long j, int i) {
        return RangesKt.coerceIn(i, Constraints.m6982getMinWidthimpl(j), Constraints.m6980getMaxWidthimpl(j));
    }

    /* JADX INFO: renamed from: constrainHeight-K40F9xA, reason: not valid java name */
    public static final int m6996constrainHeightK40F9xA(long j, int i) {
        return RangesKt.coerceIn(i, Constraints.m6981getMinHeightimpl(j), Constraints.m6979getMaxHeightimpl(j));
    }

    /* JADX INFO: renamed from: isSatisfiedBy-4WqzIAM, reason: not valid java name */
    public static final boolean m6998isSatisfiedBy4WqzIAM(long j, long j2) {
        int iM6982getMinWidthimpl = Constraints.m6982getMinWidthimpl(j);
        int iM6980getMaxWidthimpl = Constraints.m6980getMaxWidthimpl(j);
        int iM7197getWidthimpl = IntSize.m7197getWidthimpl(j2);
        if (iM6982getMinWidthimpl > iM7197getWidthimpl || iM7197getWidthimpl > iM6980getMaxWidthimpl) {
            return false;
        }
        ...
        int iM7196getHeightimpl = IntSize.m7196getHeightimpl(j2);
        return iM6981getMinHeightimpl <= iM7196getHeightimpl && iM7196getHeightimpl <= iM6979getMaxHeightimpl;
    }

    /* JADX INFO: renamed from: offset-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ long m7000offsetNN6EwU$default(long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        return m6999offsetNN6EwU(j, i, i2);
    }

    /* JADX INFO: renamed from: offset-NN6Ew-U, reason: not valid java name */
    public static final long m6999offsetNN6EwU(long j, int i, int i2) {
        return Constraints(RangesKt.coerceAtLeast(Constraints.m6982getMinWidthimpl(j) + i, 0), addMaxWithMinimum(Constraints.m6980getMaxWidthimpl(j), i), RangesKt.coerceAtLeast(Constraints.m6981getMinHeightimpl(j) + i2, 0), addMaxWithMinimum(Constraints.m6979getMaxHeightimpl(j), i2));
    }
