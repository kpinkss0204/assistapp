...
public final class FontScaleConverterFactory {
    ...
    private final void put(float scaleKey, FontScaleConverter fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            SparseArrayCompat<FontScaleConverter> sparseArrayCompatM318clone = sLookupTables.m318clone();
            fontScaleConverterFactory.putInto(sparseArrayCompatM318clone, scaleKey, fontScaleConverter);
            sLookupTables = sparseArrayCompatM318clone;
            Unit unit = Unit.INSTANCE;
        }
    }
