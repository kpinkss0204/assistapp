...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m7139toSp0xMU5do(FontScaling fontScaling, float f) {
            return FontScaling.super.mo659toSp0xMU5do(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m7138toDpGaN1DYA(FontScaling fontScaling, long j) {
            return FontScaling.super.mo652toDpGaN1DYA(j);
        }
    }
    ...
    default float mo652toDpGaN1DYA(long j) {
        ...
        FontScaleConverter fontScaleConverterForScale = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        float fM7220getValueimpl = TextUnit.m7220getValueimpl(j);
        return fontScaleConverterForScale == null ? Dp.m7027constructorimpl(fM7220getValueimpl * getFontScale()) : Dp.m7027constructorimpl(fontScaleConverterForScale.convertSpToDp(fM7220getValueimpl));
    }
}
