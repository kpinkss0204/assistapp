...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public void mo493onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m5723equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5727getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m5723equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5728getExit7fucELk())) {
                onExit();
            }
        }
    }
