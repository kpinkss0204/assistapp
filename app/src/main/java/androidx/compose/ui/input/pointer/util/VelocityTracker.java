...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m4343getZeroF1C5BW0();
    }
    ...
    public final void m5876setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m5872addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m4327getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m4328getYimpl(position));
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m5873calculateVelocity9UxMQ8M() {
        return m5874calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* JADX INFO: renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m5874calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m7264getXimpl(maximumVelocity) > 0.0f && Velocity.m7265getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m7271toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m7264getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m7265getYimpl(maximumVelocity)));
    }
