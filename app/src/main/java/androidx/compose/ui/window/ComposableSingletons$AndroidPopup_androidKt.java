...
public final class ComposableSingletons$AndroidPopup_androidKt {
    ...
    public static Function2<Composer, Integer, Unit> f79lambda1 = ComposableLambdaKt.composableLambdaInstance(-1131826196, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.ComposableSingletons$AndroidPopup_androidKt$lambda-1$1
    ...
    public final Function2<Composer, Integer, Unit> m7285getLambda1$ui_release() {
        return f79lambda1;
    }
}
