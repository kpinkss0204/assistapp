...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo1041onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m6289getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m6291toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4327getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4328getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m6291toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m6290toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo767onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m6289getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m6291toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4327getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4328getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4327getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4328getYimpl(available)), null, NestedScrollInteropConnectionKt.m6291toViewTypeGyEprt8(source), this.consumedScrollCache);
            return NestedScrollInteropConnectionKt.m6290toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
        return Offset.INSTANCE.m4343getZeroF1C5BW0();
    }
    ...
    public Object mo1040onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7264getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7265getYimpl(j)))) {
            j = Velocity.INSTANCE.m7275getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m7255boximpl(j);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo766onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7264getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7265getYimpl(j2)), true)) {
            j2 = Velocity.INSTANCE.m7275getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m7255boximpl(j2);
    }
