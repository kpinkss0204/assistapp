...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m6295toLegacyClassNameV4PA4sw(int i) {
        if (Role.m6318equalsimpl0(i, Role.INSTANCE.m6322getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m6318equalsimpl0(i, Role.INSTANCE.m6323getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m6318equalsimpl0(i, Role.INSTANCE.m6326getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m6318equalsimpl0(i, Role.INSTANCE.m6325getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m6318equalsimpl0(i, Role.INSTANCE.m6324getDropdownListo7Vup1c())) {
