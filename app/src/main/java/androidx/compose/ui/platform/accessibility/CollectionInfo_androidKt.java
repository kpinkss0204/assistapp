    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m4316boximpl(OffsetKt.Offset(Math.abs(Offset.m4327getXimpl(semanticsNode4.getBoundsInRoot().m4357getCenterF1C5BW0()) - Offset.m4327getXimpl(semanticsNode3.getBoundsInRoot().m4357getCenterF1C5BW0())), Math.abs(Offset.m4328getYimpl(semanticsNode4.getBoundsInRoot().m4357getCenterF1C5BW0()) - Offset.m4328getYimpl(semanticsNode3.getBoundsInRoot().m4357getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m4316boximpl(Offset.m4332plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m4328getYimpl(packedValue) < Offset.m4327getXimpl(packedValue);
    }
