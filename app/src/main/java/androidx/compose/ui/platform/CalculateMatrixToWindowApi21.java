...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    public void mo6242calculateMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Matrix.m4808resetimpl(matrix);
        m6245transformMatrixToWindowEL8BTi8(view, matrix);
    }

    /* JADX INFO: renamed from: transformMatrixToWindow-EL8BTi8, reason: not valid java name */
    private final void m6245transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m6245transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m6244preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m6244preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            view.getLocationInWindow(this.tmpLocation);
            m6244preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m6244preTranslate3XD1CNM(matrix, r0[0], r0[1]);
        }
        android.graphics.Matrix matrix2 = view.getMatrix();
        if (matrix2.isIdentity()) {
            return;
        }
        m6243preConcattUYjHk(matrix, matrix2);
    }

    /* JADX INFO: renamed from: preConcat-tU-YjHk, reason: not valid java name */
    private final void m6243preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m4439setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m6240preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* JADX INFO: renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m6244preTranslate3XD1CNM(float[] fArr, float f, float f2) {
        AndroidComposeView_androidKt.m6241preTranslatecG2Xzmc(fArr, f, f2, this.tmpMatrix);
    }
}
