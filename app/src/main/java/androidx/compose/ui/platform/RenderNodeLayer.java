...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m4622toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m4622toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m4954getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m4955getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo6254setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public boolean mo6186isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM4327getXimpl && fM4327getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM4328getYimpl && fM4328getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo6189resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m4954getPivotFractionXimpl(this.transformOrigin) * iM7197getWidthimpl);
        this.renderNode.setPivotY(TransformOrigin.m4955getPivotFractionYimpl(this.transformOrigin) * iM7196getHeightimpl);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM7197getWidthimpl, this.renderNode.getTop() + iM7196getHeightimpl)) {
            this.renderNode.setOutline(this.outlineResolver.getAndroidOutline());
            invalidate();
            this.matrixCache.invalidate();
        }
    ...
    public void mo6188movegyyYBs(long position) {
        ...
        if (left == iM7155getXimpl && top == iM7156getYimpl) {
            return;
        }
        if (left != iM7155getXimpl) {
            this.renderNode.offsetLeftAndRight(iM7155getXimpl - left);
        }
        if (top != iM7156getYimpl) {
            this.renderNode.offsetTopAndBottom(iM7156getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo4423concat58bKbWc(this.matrixCache.m6271calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo6187mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM6270calculateInverseMatrixbWbORWo = this.matrixCache.m6270calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m4805mapMKHz9U(this.matrixCache.m6271calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m4807mapimpl(this.matrixCache.m6271calculateMatrixGrdbGEg(this.renderNode), rect);
    }
    ...
    public void mo6190transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4816timesAssign58bKbWc(matrix, this.matrixCache.m6271calculateMatrixGrdbGEg(this.renderNode));
    }
