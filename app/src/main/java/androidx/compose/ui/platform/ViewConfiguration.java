...
public interface ViewConfiguration {
    ...
    public static final class DefaultImpls {
        ...
        public static long m6300getMinimumTouchTargetSizeMYxV2XQ(ViewConfiguration viewConfiguration) {
            return ViewConfiguration.super.mo6059getMinimumTouchTargetSizeMYxV2XQ();
        }
    ...
    default long mo6059getMinimumTouchTargetSizeMYxV2XQ() {
        float f = 48;
        return DpKt.m7049DpSizeYgX7TsA(Dp.m7027constructorimpl(f), Dp.m7027constructorimpl(f));
    }
}
