...
public final class ComposableSingletons$Wrapper_androidKt {
    ...
    public static Function2<Composer, Integer, Unit> f77lambda1 = ComposableLambdaKt.composableLambdaInstance(-1759434350, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.ComposableSingletons$Wrapper_androidKt$lambda-1$1
    ...
    public final Function2<Composer, Integer, Unit> m6246getLambda1$ui_release() {
        return f77lambda1;
    }
}
