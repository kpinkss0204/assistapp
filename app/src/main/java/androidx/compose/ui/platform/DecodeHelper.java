...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                if (bDecodeByte != 2) {
                    if (bDecodeByte != 3) {
                        if (bDecodeByte != 4) {
                            if (bDecodeByte != 5) {
                                        ...
                                        if (bDecodeByte != 8) {
                                            if (bDecodeByte != 9) {
                                                if (bDecodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m6279setBackground8_81llA(m6249decodeColor0d7_KjU());
                                                }
                                            } else {
                                                if (dataAvailable() < 8) {
                                                    break;
                                            ...
                                            mutableSpanStyle.m6280setBaselineShift_isdbwI(BaselineShift.m6800boximpl(m6247decodeBaselineShifty9eOQZs()));
                                        }
                                    } else {
                                        if (dataAvailable() < 5) {
                                            break;
                                        }
                                        mutableSpanStyle.m6285setLetterSpacingR2X_6o(m6252decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m6284setFontSynthesistDdu0R4(FontSynthesis.m6630boximpl(m6251decodeFontSynthesisGVVA2EU()));
                            }
                        } else {
                            if (dataAvailable() < 1) {
                                break;
                            }
                            mutableSpanStyle.m6283setFontStylemLjRB2g(FontStyle.m6619boximpl(m6250decodeFontStyle_LCdwA()));
                        }
                    } else {
                        if (dataAvailable() < 4) {
                            break;
                    ...
                    mutableSpanStyle.m6282setFontSizeR2X_6o(m6252decodeTextUnitXSAIIZE());
                }
            } else {
                if (dataAvailable() < 8) {
                    break;
                }
                mutableSpanStyle.m6281setColor8_81llA(m6249decodeColor0d7_KjU());
            }
        }
    ...
    public final long m6249decodeColor0d7_KjU() {
        return Color.m4564constructorimpl(m6248decodeULongsVKNKU());
    }

    /* JADX INFO: renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m6252decodeTextUnitXSAIIZE() {
        long jM7254getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM7254getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7253getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM7254getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7252getEmUIouoOA();
        } else {
            jM7254getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7254getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m7248equalsimpl0(jM7254getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m7254getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m7231getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m7232TextUnitanM5pPY(decodeFloat(), jM7254getUnspecifiedUIouoOA);
    }
    ...
    public final int m6250decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m6629getNormal_LCdwA();
        }
        if (bDecodeByte == 1) {
            return FontStyle.INSTANCE.m6628getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m6629getNormal_LCdwA();
    }

    /* JADX INFO: renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m6251decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m6640getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m6639getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m6641getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m6642getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m6640getNoneGVVA2EU();
    }

    /* JADX INFO: renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m6247decodeBaselineShifty9eOQZs() {
        return BaselineShift.m6801constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m6249decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m6248decodeULongsVKNKU() {
        return ULong.m8053constructorimpl(this.parcel.readLong());
    }
