...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m4327getXimpl(targetCoordinates.mo5912localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(coordinate, IntSize.m7196getHeightimpl(sourceCoordinates.mo5911getSizeYbymL2g()) / 2.0f)));
    }
}
