...
public final class ContentScaleKt {
    ...
    public static final float m5900computeFillMaxDimensioniLBOSCw(long j, long j2) {
        return Math.max(m5902computeFillWidthiLBOSCw(j, j2), m5899computeFillHeightiLBOSCw(j, j2));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillMinDimension-iLBOSCw, reason: not valid java name */
    public static final float m5901computeFillMinDimensioniLBOSCw(long j, long j2) {
        return Math.min(m5902computeFillWidthiLBOSCw(j, j2), m5899computeFillHeightiLBOSCw(j, j2));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillWidth-iLBOSCw, reason: not valid java name */
    public static final float m5902computeFillWidthiLBOSCw(long j, long j2) {
        return Size.m4396getWidthimpl(j2) / Size.m4396getWidthimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillHeight-iLBOSCw, reason: not valid java name */
    public static final float m5899computeFillHeightiLBOSCw(long j, long j2) {
        return Size.m4393getHeightimpl(j2) / Size.m4393getHeightimpl(j);
    }
}
