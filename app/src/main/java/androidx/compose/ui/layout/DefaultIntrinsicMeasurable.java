...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo5903measureBRTryo0(long constraints) {
        ...
        if (intrinsicWidthHeight == intrinsicWidthHeight2) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, iM6980getMaxWidthimpl);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(iM6980getMaxWidthimpl, iMinIntrinsicHeight);
    }
