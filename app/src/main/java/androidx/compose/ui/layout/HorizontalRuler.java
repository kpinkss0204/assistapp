...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m4328getYimpl(targetCoordinates.mo5912localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m7197getWidthimpl(sourceCoordinates.mo5911getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}
