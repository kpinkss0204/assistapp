...
public final class ScaleFactorKt {
    ...
    public static /* synthetic */ void m6002isSpecifiedFK8aYYs$annotations(long j) {
    }

    /* JADX INFO: renamed from: isUnspecified-FK8aYYs$annotations, reason: not valid java name */
    public static /* synthetic */ void m6004isUnspecifiedFK8aYYs$annotations(long j) {
    }
    ...
    public static final boolean m6001isSpecifiedFK8aYYs(long j) {
        return j != ScaleFactor.Companion.m5999getUnspecified_hLwfpc();
    }

    /* JADX INFO: renamed from: isUnspecified-FK8aYYs, reason: not valid java name */
    public static final boolean m6003isUnspecifiedFK8aYYs(long j) {
        return j == ScaleFactor.Companion.m5999getUnspecified_hLwfpc();
    }

    /* JADX INFO: renamed from: times-UQTWf7w, reason: not valid java name */
    public static final long m6007timesUQTWf7w(long j, long j2) {
        return SizeKt.Size(Size.m4396getWidthimpl(j) * ScaleFactor.m5992getScaleXimpl(j2), Size.m4393getHeightimpl(j) * ScaleFactor.m5993getScaleYimpl(j2));
    }

    /* JADX INFO: renamed from: times-m-w2e94, reason: not valid java name */
    public static final long m6008timesmw2e94(long j, long j2) {
        return m6007timesUQTWf7w(j2, j);
    }

    /* JADX INFO: renamed from: div-UQTWf7w, reason: not valid java name */
    public static final long m6000divUQTWf7w(long j, long j2) {
        return SizeKt.Size(Size.m4396getWidthimpl(j) / ScaleFactor.m5992getScaleXimpl(j2), Size.m4393getHeightimpl(j) / ScaleFactor.m5993getScaleYimpl(j2));
    }

    /* JADX INFO: renamed from: lerp--bDIf60, reason: not valid java name */
    public static final long m6005lerpbDIf60(long j, long j2, float f) {
        return ScaleFactor(MathHelpersKt.lerp(ScaleFactor.m5992getScaleXimpl(j), ScaleFactor.m5992getScaleXimpl(j2), f), MathHelpersKt.lerp(ScaleFactor.m5993getScaleYimpl(j), ScaleFactor.m5993getScaleYimpl(j2), f));
    }

    public static final long ScaleFactor(float f, float f2) {
        return ScaleFactor.m5986constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: takeOrElse-oyDd2qo, reason: not valid java name */
    public static final long m6006takeOrElseoyDd2qo(long j, Function0<ScaleFactor> function0) {
        return j != ScaleFactor.Companion.m5999getUnspecified_hLwfpc() ? j : function0.invoke().m5997unboximpl();
    }
}
