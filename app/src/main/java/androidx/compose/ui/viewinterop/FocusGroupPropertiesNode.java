...
final class FocusGroupPropertiesNode extends Modifier.Node implements FocusPropertiesModifierNode, ViewTreeObserver.OnGlobalFocusChangeListener, View.OnAttachStateChangeListener {
    ...
    /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<FocusDirection, FocusRequester> {
        ...
        public /* bridge */ /* synthetic */ FocusRequester invoke(FocusDirection focusDirection) {
            return m7279invoke3ESFkO8(focusDirection.getValue());
        }

        /* JADX INFO: renamed from: invoke-3ESFkO8, reason: not valid java name */
        public final FocusRequester m7279invoke3ESFkO8(int i) {
            return ((FocusGroupPropertiesNode) this.receiver).m7277onEnter3ESFkO8(i);
        }
    }
    ...
    /* synthetic */ class AnonymousClass2 extends FunctionReferenceImpl implements Function1<FocusDirection, FocusRequester> {
        ...
        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ FocusRequester invoke(FocusDirection focusDirection) {
            return m7280invoke3ESFkO8(focusDirection.getValue());
        }

        /* JADX INFO: renamed from: invoke-3ESFkO8, reason: not valid java name */
        public final FocusRequester m7280invoke3ESFkO8(int i) {
            return ((FocusGroupPropertiesNode) this.receiver).m7278onExit3ESFkO8(i);
        }
    }

    /* JADX INFO: renamed from: onEnter-3ESFkO8, reason: not valid java name */
    public final FocusRequester m7277onEnter3ESFkO8(int focusDirection) {
        ...
        return FocusInteropUtils_androidKt.requestInteropFocus(view, FocusInteropUtils_androidKt.m4253toAndroidFocusDirection3ESFkO8(focusDirection), FocusGroupNode_androidKt.getCurrentlyFocusedRect(focusOwner, (View) objRequireOwner, view)) ? FocusRequester.INSTANCE.getDefault() : FocusRequester.INSTANCE.getCancel();
    }

    /* JADX INFO: renamed from: onExit-3ESFkO8, reason: not valid java name */
    public final FocusRequester m7278onExit3ESFkO8(int focusDirection) {
        ...
        if (view instanceof ViewGroup) {
            ...
            int iIntValue = numM4253toAndroidFocusDirection3ESFkO8 != null ? numM4253toAndroidFocusDirection3ESFkO8.intValue() : 130;
        ...
        if (!z2) {
            if (z) {
                ...
                if (getFocusTargetOfEmbeddedViewWrapper().getFocusState().isFocused()) {
                    focusOwner.mo4256clearFocusI7lrPNg(false, true, false, FocusDirection.INSTANCE.m4247getExitdhqQ8s());
                    return;
                }
                return;
            }
