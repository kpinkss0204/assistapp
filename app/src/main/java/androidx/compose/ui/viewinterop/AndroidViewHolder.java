...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo322measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                if (this.$this_run.getChildCount() == 0) {
                    return MeasureScope.layout$default(measureScope, Constraints.m6982getMinWidthimpl(j), Constraints.m6981getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                ...
                if (Constraints.m6982getMinWidthimpl(j) != 0) {
                    this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m6982getMinWidthimpl(j));
                }
                if (Constraints.m6981getMinHeightimpl(j) != 0) {
                    this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m6981getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = this.$this_run;
                ...
                int iObtainMeasureSpec = androidViewHolder.obtainMeasureSpec(iM6982getMinWidthimpl, iM6980getMaxWidthimpl, layoutParams.width);
                ...
                androidViewHolder.measure(iObtainMeasureSpec, androidViewHolder2.obtainMeasureSpec(iM6981getMinHeightimpl, iM6979getMaxHeightimpl, layoutParams2.height));
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        if (isNestedScrollingEnabled()) {
            long jM5651dispatchPostScrollDzOQY0M = this.dispatcher.m5651dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4327getXimpl(jM5651dispatchPostScrollDzOQY0M));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4328getYimpl(jM5651dispatchPostScrollDzOQY0M));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m5651dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        if (isNestedScrollingEnabled()) {
            long jM5653dispatchPreScrollOzD1aCk = this.dispatcher.m5653dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dx), AndroidViewHolder_androidKt.toComposeOffset(dy)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4327getXimpl(jM5653dispatchPreScrollOzD1aCk));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m4328getYimpl(jM5653dispatchPreScrollOzD1aCk));
        }
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:13:0x0039, code lost:
            ...
            if (r10.this$0.dispatcher.m5650dispatchPostFlingRZ2iAVY(androidx.compose.ui.unit.Velocity.INSTANCE.m7275getZero9UxMQ8M(), r10.$viewVelocity, r10) == r0) goto L17;
         */
        /* JADX WARN: Code restructure failed: missing block: B:16:0x0053, code lost:
        
            if (r10.this$0.dispatcher.m5650dispatchPostFlingRZ2iAVY(r10.$viewVelocity, androidx.compose.ui.unit.Velocity.INSTANCE.m7275getZero9UxMQ8M(), r10) == r0) goto L17;
         */
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r11) {
            ...
            L1b:
                ...
                long r5 = r11.m7275getZero9UxMQ8M()
                long r7 = r10.$viewVelocity
                r9 = r10
                kotlin.coroutines.Continuation r9 = (kotlin.coroutines.Continuation) r9
                r10.label = r3
                java.lang.Object r11 = r4.m5650dispatchPostFlingRZ2iAVY(r5, r7, r9)
                if (r11 != r0) goto L56
                goto L55
            L3c:
                androidx.compose.ui.viewinterop.AndroidViewHolder r11 = r10.this$0
                ...
                androidx.compose.ui.unit.Velocity$Companion r11 = androidx.compose.ui.unit.Velocity.INSTANCE
                long r6 = r11.m7275getZero9UxMQ8M()
                r8 = r10
                kotlin.coroutines.Continuation r8 = (kotlin.coroutines.Continuation) r8
                r10.label = r2
                java.lang.Object r11 = r3.m5650dispatchPostFlingRZ2iAVY(r4, r6, r8)
                if (r11 != r0) goto L56
            L55:
                return r0
            L56:
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C06531(VelocityKt.Velocity(AndroidViewHolder_androidKt.toComposeVelocity(velocityX), AndroidViewHolder_androidKt.toComposeVelocity(velocityY)), null), 3, null);
        return false;
    }
    ...
    static final class C06531 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06531(long j, Continuation<? super C06531> continuation) {
            super(2, continuation);
            this.$toBeConsumed = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidViewHolder.this.new C06531(this.$toBeConsumed, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (AndroidViewHolder.this.dispatcher.m5652dispatchPreFlingQWom1Mo(this.$toBeConsumed, this) == coroutine_suspended) {
