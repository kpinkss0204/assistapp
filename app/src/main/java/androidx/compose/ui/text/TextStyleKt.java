...
public final class TextStyleKt {
    ...
    public static final int m6558resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6930getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m6931getContentOrLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m6932getContentOrRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
        if (!TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6935getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m6933getLtrs_7Xco();
        }
        if (i3 == 2) {
            return TextDirection.INSTANCE.m6934getRtls_7Xco();
        }
        throw new NoWhenBranchMatchedException();
    }
