...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m6771resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m6770resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* JADX INFO: renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m6770resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale platformLocale;
        if (TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6931getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6932getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6933getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6934getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6930getContents_7Xco()) ? true : TextDirection.m6926equalsimpl0(i, TextDirection.INSTANCE.m6935getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m6364boximpl(paragraphStyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m6367equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m6373getNone_3YsG6Y()));
    }
}
