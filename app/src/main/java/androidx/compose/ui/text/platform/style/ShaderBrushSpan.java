...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4384boximpl(Size.INSTANCE.m4404getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (this.this$0.m6798getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m4398isEmptyimpl(this.this$0.m6798getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo4537createShaderuvyYCjk(this.this$0.m6798getSizeNHjbRc());
        }
    });
