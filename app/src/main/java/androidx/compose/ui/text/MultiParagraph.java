...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        ...
        this.maxLines = i;
        if (Constraints.m6982getMinWidthimpl(j) != 0 || Constraints.m6981getMinHeightimpl(j) != 0) {
        ...
        while (i3 < size) {
            ...
            if (Constraints.m6975getHasBoundedHeightimpl(j)) {
                iM6979getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m6979getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), 0);
            } else {
                iM6979getMaxHeightimpl = Constraints.m6979getMaxHeightimpl(j);
            }
            Paragraph paragraphM6396Paragraph_EkL_Y = ParagraphKt.m6396Paragraph_EkL_Y(intrinsics, ConstraintsKt.Constraints$default(0, iM6980getMaxWidthimpl, 0, iM6979getMaxHeightimpl, 5, null), this.maxLines - i2, z);
            float height = f + paragraphM6396Paragraph_EkL_Y.getHeight();
            int lineCount = i2 + paragraphM6396Paragraph_EkL_Y.getLineCount();
            arrayList.add(new ParagraphInfo(paragraphM6396Paragraph_EkL_Y, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i2, lineCount, f, height));
            if (paragraphM6396Paragraph_EkL_Y.getDidExceedMaxLines() || (lineCount == this.maxLines && i3 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text_release()))) {
                z2 = true;
                i2 = lineCount;
                f = height;
                break;
        ...
        this.width = Constraints.m6980getMaxWidthimpl(j);
    ...
    public static /* synthetic */ void m6375paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.INSTANCE.m4604getUnspecified0d7_KjU();
        }
        multiParagraph.m6382paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }
    ...
    public final /* synthetic */ void m6382paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        ...
        while (i < size) {
            ...
            long j = color;
            paragraphInfo.getParagraph().mo6349paintRPmYEkk(canvas2, j, shadow, decoration);
    ...
    public final void m6381paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            paragraphInfo.getParagraph().mo6348paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
    ...
    public static /* synthetic */ void m6376painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = Float.NaN;
        }
        multiParagraph.m6383painthn5TExg(canvas, brush, f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.INSTANCE.m5126getDefaultBlendMode0nO6VwU() : i);
    }

    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public final void m6383painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m6766drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m6384findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph.getPathForRange.2
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                Path.m4838addPathUv8p0NA$default(Path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(start), paragraphInfo.toLocalIndex(end))), 0L, 2, null);
            }
        });
        return Path;
    }
    ...
    public final int m6378getOffsetForPositionk4lQ0M(long position) {
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m4328getYimpl(position)));
        if (paragraphInfo.getLength() == 0) {
            return paragraphInfo.getStartIndex();
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo6345getOffsetForPositionk4lQ0M(paragraphInfo.m6393toLocalMKHz9U(position)));
    }

    /* JADX INFO: renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m6379getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(iFindParagraphByY).getBottom() >= rect.getBottom() || iFindParagraphByY == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m6391toGlobalxdX6G0$default(paragraphInfo, paragraphInfo.getParagraph().mo6346getRangeForRect86BmAI(paragraphInfo.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int iFindParagraphByY2 = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long jM6517getZerod9O1mEE = TextRange.INSTANCE.m6517getZerod9O1mEE();
        while (TextRange.m6505equalsimpl0(jM6517getZerod9O1mEE, TextRange.INSTANCE.m6517getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo2 = this.paragraphInfoList.get(iFindParagraphByY);
            jM6517getZerod9O1mEE = ParagraphInfo.m6391toGlobalxdX6G0$default(paragraphInfo2, paragraphInfo2.getParagraph().mo6346getRangeForRect86BmAI(paragraphInfo2.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY++;
        }
        if (TextRange.m6505equalsimpl0(jM6517getZerod9O1mEE, TextRange.INSTANCE.m6517getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6517getZerod9O1mEE();
        }
        long jM6517getZerod9O1mEE2 = TextRange.INSTANCE.m6517getZerod9O1mEE();
        while (TextRange.m6505equalsimpl0(jM6517getZerod9O1mEE2, TextRange.INSTANCE.m6517getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo3 = this.paragraphInfoList.get(iFindParagraphByY2);
            jM6517getZerod9O1mEE2 = ParagraphInfo.m6391toGlobalxdX6G0$default(paragraphInfo3, paragraphInfo3.getParagraph().mo6346getRangeForRect86BmAI(paragraphInfo3.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY2--;
        }
        return TextRange.m6505equalsimpl0(jM6517getZerod9O1mEE2, TextRange.INSTANCE.m6517getZerod9O1mEE()) ? jM6517getZerod9O1mEE : TextRangeKt.TextRange(TextRange.m6512getStartimpl(jM6517getZerod9O1mEE), TextRange.m6507getEndimpl(jM6517getZerod9O1mEE2));
    }
    ...
    public final float[] m6377fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m6510getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m6509getMaximpl(range));
        final Ref.IntRef intRef = new Ref.IntRef();
        intRef.element = arrayStart;
        final Ref.FloatRef floatRef = new Ref.FloatRef();
        MultiParagraphKt.m6384findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph$fillBoundingBoxes$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                ...
                long jTextRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphInfo.getStartIndex() > TextRange.m6510getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m6510getMinimpl(j)), paragraphInfo.toLocalIndex(paragraphInfo.getEndIndex() < TextRange.m6509getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m6509getMaximpl(j)));
                paragraphInfo.getParagraph().mo6343fillBoundingBoxes8ffj60Q(jTextRange, fArr, intRef2.element);
                int iM6508getLengthimpl = intRef2.element + (TextRange.m6508getLengthimpl(jTextRange) * 4);
                for (int i = intRef2.element; i < iM6508getLengthimpl; i += 4) {
                    int i2 = i + 1;
                    fArr[i2] = fArr[i2] + floatRef2.element;
                    int i3 = i + 3;
                    fArr[i3] = fArr[i3] + floatRef2.element;
                }
                intRef2.element = iM6508getLengthimpl;
    ...
    public final long m6380getWordBoundaryjx7JFs(int offset) {
        int iFindParagraphByIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            iFindParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(iFindParagraphByIndex);
        return paragraphInfo.m6392toGlobalxdX6G0(paragraphInfo.getParagraph().mo6347getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(offset)), false);
    }
