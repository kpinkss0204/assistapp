...
public final class SpanStyleKt {
    ...
    private static final long DefaultBackgroundColor = Color.INSTANCE.m4603getTransparent0d7_KjU();
    ...
    static {
        long jM4594getBlack0d7_KjU = Color.INSTANCE.m4594getBlack0d7_KjU();
        DefaultColor = jM4594getBlack0d7_KjU;
        DefaultColorForegroundStyle = TextForegroundStyle.INSTANCE.m6937from8_81llA(jM4594getBlack0d7_KjU);
    }

    /* JADX INFO: renamed from: lerpTextUnitInheritable-C3pnCVY, reason: not valid java name */
    public static final long m6468lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m7238isUnspecifiedR2X_6o(j) || TextUnitKt.m7238isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m7210boximpl(j), TextUnit.m7210boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m7240lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle lerp(SpanStyle spanStyle, SpanStyle spanStyle2, float f) {
        ...
        long jM6468lerpTextUnitInheritableC3pnCVY = m6468lerpTextUnitInheritableC3pnCVY(spanStyle.getFontSize(), spanStyle2.getFontSize(), f);
        ...
        long jM6468lerpTextUnitInheritableC3pnCVY2 = m6468lerpTextUnitInheritableC3pnCVY(spanStyle.getLetterSpacing(), spanStyle2.getLetterSpacing(), f);
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        float fM6806unboximpl = baselineShift != null ? baselineShift.m6806unboximpl() : BaselineShift.m6801constructorimpl(0.0f);
        BaselineShift baselineShift2 = spanStyle2.getBaselineShift();
        float fM6813lerpjWV1Mfo = BaselineShiftKt.m6813lerpjWV1Mfo(fM6806unboximpl, baselineShift2 != null ? baselineShift2.m6806unboximpl() : BaselineShift.m6801constructorimpl(0.0f), f);
        ...
        long jM4619lerpjxsXWHM = ColorKt.m4619lerpjxsXWHM(spanStyle.getBackground(), spanStyle2.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM6468lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM6468lerpTextUnitInheritableC3pnCVY2, BaselineShift.m6800boximpl(fM6813lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM4619lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(spanStyle.getPlatformStyle(), spanStyle2.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(spanStyle.getDrawStyle(), spanStyle2.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle spanStyle) {
        ...
        long fontSize = TextUnitKt.m7238isUnspecifiedR2X_6o(spanStyle.getFontSize()) ? DefaultFontSize : spanStyle.getFontSize();
        FontWeight fontWeight = spanStyle.getFontWeight();
        if (fontWeight == null) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        ...
        FontSynthesis fontSynthesisM6630boximpl = FontSynthesis.m6630boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6639getAllGVVA2EU());
        ...
        if (TextUnitKt.m7238isUnspecifiedR2X_6o(spanStyle.getLetterSpacing())) {
        ...
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        BaselineShift baselineShiftM6800boximpl = BaselineShift.m6800boximpl(baselineShift != null ? baselineShift.m6806unboximpl() : BaselineShift.INSTANCE.m6810getNoney9eOQZs());
        TextGeometricTransform textGeometricTransform = spanStyle.getTextGeometricTransform();
        if (textGeometricTransform == null) {
            textGeometricTransform = TextGeometricTransform.INSTANCE.getNone$ui_text_release();
        }
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM6619boximpl, fontSynthesisM6630boximpl, fontFamily2, str, j, baselineShiftM6800boximpl, textGeometricTransform2, localeList2, j2, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
 ...
 binds: [B:35:0x0096, B:47:0x00c8, B:44:0x00bc, B:41:0x00b0, B:38:0x00a4, B:33:0x0088, B:28:0x0079, B:24:0x0067, B:21:0x005f, B:18:0x0053, B:15:0x0047, B:5:0x0028] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final androidx.compose.ui.text.SpanStyle m6467fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle r21, long r22, androidx.compose.ui.graphics.Brush r24, float r25, long r26, androidx.compose.ui.text.font.FontWeight r28, androidx.compose.ui.text.font.FontStyle r29, androidx.compose.ui.text.font.FontSynthesis r30, androidx.compose.ui.text.font.FontFamily r31, java.lang.String r32, long r33, androidx.compose.ui.text.style.BaselineShift r35, androidx.compose.ui.text.style.TextGeometricTransform r36, androidx.compose.ui.text.intl.LocaleList r37, long r38, androidx.compose.ui.text.style.TextDecoration r40, androidx.compose.ui.graphics.Shadow r41, androidx.compose.ui.text.PlatformSpanStyle r42, androidx.compose.ui.graphics.drawscope.DrawStyle r43) {
        /*
            Method dump skipped, instruction units count: 488
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.SpanStyleKt.m6467fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle, long, androidx.compose.ui.graphics.Brush, float, long, androidx.compose.ui.text.font.FontWeight, androidx.compose.ui.text.font.FontStyle, androidx.compose.ui.text.font.FontSynthesis, androidx.compose.ui.text.font.FontFamily, java.lang.String, long, androidx.compose.ui.text.style.BaselineShift, androidx.compose.ui.text.style.TextGeometricTransform, androidx.compose.ui.text.intl.LocaleList, long, androidx.compose.ui.text.style.TextDecoration, androidx.compose.ui.graphics.Shadow, androidx.compose.ui.text.PlatformSpanStyle, androidx.compose.ui.graphics.drawscope.DrawStyle):androidx.compose.ui.text.SpanStyle");
    }
}
