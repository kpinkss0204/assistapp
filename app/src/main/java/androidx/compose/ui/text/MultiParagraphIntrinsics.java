...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        return !TextDirection.m6926equalsimpl0(style.getTextDirection(), TextDirection.INSTANCE.m6935getUnspecifieds_7Xco()) ? style : ParagraphStyle.m6402copyykzQM6k$default(style, 0, defaultStyle.getTextDirection(), 0L, null, null, null, 0, 0, null, 509, null);
    }
}
