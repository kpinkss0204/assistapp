...
public final class TextPainterKt {
    ...
    public static final void m6491drawTextJFhB2K4(DrawScope drawScope, TextMeasurer textMeasurer, AnnotatedString annotatedString, long j, TextStyle textStyle, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> list, long j2, int i3) {
        TextLayoutResult textLayoutResultM6488measurexDpz5zY$default = TextMeasurer.m6488measurexDpz5zY$default(textMeasurer, annotatedString, textStyle, i, z, i2, list, m6499textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1536, null);
        DrawContext drawContext = drawScope.getDrawContext();
        long jMo5045getSizeNHjbRc = drawContext.mo5045getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            DrawTransform transform = drawContext.getTransform();
            transform.translate(Offset.m4327getXimpl(j), Offset.m4328getYimpl(j));
            clip(transform, textLayoutResultM6488measurexDpz5zY$default);
            textLayoutResultM6488measurexDpz5zY$default.getMultiParagraph().m6381paintLG529CI(drawScope.getDrawContext().getCanvas(), (32 & 2) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : 0L, (32 & 4) != 0 ? null : null, (32 & 8) != 0 ? null : null, (32 & 16) == 0 ? null : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m5126getDefaultBlendMode0nO6VwU() : i3);
        } finally {
    ...
    public static final void m6495drawTextTPWCCtM(DrawScope drawScope, TextMeasurer textMeasurer, String str, long j, TextStyle textStyle, int i, boolean z, int i2, long j2, int i3) {
        TextLayoutResult textLayoutResultM6488measurexDpz5zY$default = TextMeasurer.m6488measurexDpz5zY$default(textMeasurer, new AnnotatedString(str, null, null, 6, null), textStyle, i, z, i2, null, m6499textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1568, null);
        DrawContext drawContext = drawScope.getDrawContext();
        long jMo5045getSizeNHjbRc = drawContext.mo5045getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m6497drawTextd8rzKo(DrawScope drawScope, TextLayoutResult textLayoutResult, long j, long j2, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        float alpha;
        int i2;
        Shadow shadow2;
        ...
        try {
            DrawTransform transform = drawContext.getTransform();
            transform.translate(Offset.m4327getXimpl(j2), Offset.m4328getYimpl(j2));
            ...
            if (brush != null && j == 16) {
                ...
                multiParagraph.m6383painthn5TExg(canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, i2);
            } else {
                MultiParagraph multiParagraph3 = textLayoutResult.getMultiParagraph();
                Canvas canvas3 = drawScope.getDrawContext().getCanvas();
                if (j == 16) {
                    j = textLayoutResult.getLayoutInput().getStyle().m6542getColor0d7_KjU();
                }
                multiParagraph3.m6381paintLG529CI(canvas3, TextDrawStyleKt.m6936modulateDxMtmZc(j, f), shadow3, textDecoration3, drawStyle3, i);
            }
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo5046setSizeuvyYCjk(jMo5045getSizeNHjbRc);
    ...
    public static final void m6493drawTextLVfH_YU(DrawScope drawScope, TextLayoutResult textLayoutResult, Brush brush, long j, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        ...
        try {
            ...
            transform.translate(Offset.m4327getXimpl(j), Offset.m4328getYimpl(j));
            clip(transform, textLayoutResult);
            textLayoutResult.getMultiParagraph().m6383painthn5TExg(drawScope.getDrawContext().getCanvas(), brush, !Float.isNaN(f) ? f : textLayoutResult.getLayoutInput().getStyle().getAlpha(), shadow2, textDecoration2, drawStyle2, i);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo5046setSizeuvyYCjk(jMo5045getSizeNHjbRc);
        }
    ...
    private static final void clip(DrawTransform drawTransform, TextLayoutResult textLayoutResult) {
        if (!textLayoutResult.getHasVisualOverflow() || TextOverflow.m6958equalsimpl0(textLayoutResult.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6967getVisiblegIe3tQ8())) {
            return;
        }
        DrawTransform.m5181clipRectN_I0leg$default(drawTransform, 0.0f, 0.0f, IntSize.m7197getWidthimpl(textLayoutResult.getSize()), IntSize.m7196getHeightimpl(textLayoutResult.getSize()), 0, 16, null);
    }

    /* JADX INFO: renamed from: textLayoutConstraints-v_w8tDc, reason: not valid java name */
    private static final long m6499textLayoutConstraintsv_w8tDc(DrawScope drawScope, long j, long j2) {
        int iRound;
        int iRound2;
        int iRound3;
        int iRound4 = 0;
        if (j == InlineClassHelperKt.UnspecifiedPackedFloats || Float.isNaN(Size.m4396getWidthimpl(j))) {
            iRound = Math.round((float) Math.ceil(Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc()) - Offset.m4327getXimpl(j2)));
            iRound2 = 0;
        } else {
            iRound2 = Math.round((float) Math.ceil(Size.m4396getWidthimpl(j)));
            iRound = iRound2;
        }
        if (j == InlineClassHelperKt.UnspecifiedPackedFloats || Float.isNaN(Size.m4393getHeightimpl(j))) {
            iRound3 = Math.round((float) Math.ceil(Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) - Offset.m4328getYimpl(j2)));
        } else {
            iRound4 = Math.round((float) Math.ceil(Size.m4393getHeightimpl(j)));
            iRound3 = iRound4;
        }
