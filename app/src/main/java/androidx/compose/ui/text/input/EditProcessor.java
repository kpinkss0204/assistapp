...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m6517getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        boolean zAreEqual = Intrinsics.areEqual(value.getComposition(), this.mBuffer.m6671getCompositionMzsxiRA$ui_text_release());
        boolean z = true;
        boolean z2 = false;
        ...
        } else if (TextRange.m6505equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m6510getMinimpl(value.getSelection()), TextRange.m6509getMaximpl(value.getSelection()));
            z2 = true;
            z = false;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m6506getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m6510getMinimpl(value.getComposition().getPackedValue()), TextRange.m6509getMaximpl(value.getComposition().getPackedValue()));
        }
        if (z || (!z2 && !zAreEqual)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m6754copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder sbAppend = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m6671getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m6515toStringimpl(this.mBuffer.m6672getSelectiond9O1mEE$ui_text_release())) + "):");
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            while (i < size) {
                try {
                    EditCommand editCommand3 = editCommands.get(i);
                    try {
            ...
            long jM6672getSelectiond9O1mEE$ui_text_release = this.mBuffer.m6672getSelectiond9O1mEE$ui_text_release();
            TextRange textRangeM6500boximpl = TextRange.m6500boximpl(jM6672getSelectiond9O1mEE$ui_text_release);
            textRangeM6500boximpl.getPackedValue();
            TextRange textRange = TextRange.m6511getReversedimpl(this.mBufferState.getSelection()) ? null : textRangeM6500boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text_release, textRange != null ? textRange.getPackedValue() : TextRangeKt.TextRange(TextRange.m6509getMaximpl(jM6672getSelectiond9O1mEE$ui_text_release), TextRange.m6510getMinimpl(jM6672getSelectiond9O1mEE$ui_text_release)), this.mBuffer.m6671getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
