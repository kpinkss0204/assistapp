...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m6774getBrushSizeVsRJwc0$ui_text_release$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m5126getDefaultBlendMode0nO6VwU();
    ...
    /* JADX INFO: renamed from: getBrush$ui_text_release, reason: from getter */
    ...
    /* JADX INFO: renamed from: getBrushSize-VsRJwc0$ui_text_release, reason: not valid java name and from getter */
    public final Size getBrushSize() {
        return this.brushSize;
    }

    /* JADX INFO: renamed from: setBrushSize-iaC8Vc4$ui_text_release, reason: not valid java name */
    public final void m6780setBrushSizeiaC8Vc4$ui_text_release(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m4327getXimpl(this.shadow.getOffset()), Offset.m4328getYimpl(this.shadow.getOffset()), ColorKt.m4622toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m6781setColor8_81llA(long color) {
        if (color != 16) {
            setColor(ColorKt.m4622toArgb8_81llA(color));
            clearShader();
        }
    }

    /* JADX INFO: renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m6775setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m6779setBrush12SF9DM(brush, j, f);
    }
    ...
    */
    public final void m6779setBrush12SF9DM(final androidx.compose.ui.graphics.Brush r3, final long r4, float r6) {
        /*
            r2 = this;
            if (r3 != 0) goto L6
            r2.clearShader()
        ...
        L6:
            ...
            long r3 = r3.getValue()
            long r3 = androidx.compose.ui.text.style.TextDrawStyleKt.m6936modulateDxMtmZc(r3, r6)
            r2.m6781setColor8_81llA(r3)
            return
        L18:
        ...
        L2a:
            ...
            boolean r0 = androidx.compose.ui.geometry.Size.m4392equalsimpl0(r0, r4)
        L32:
            if (r0 != 0) goto L52
        L34:
            ...
            if (r0 == 0) goto L52
            r2.brush = r3
            androidx.compose.ui.geometry.Size r0 = androidx.compose.ui.geometry.Size.m4384boximpl(r4)
            r2.brushSize = r0
        ...
        L6b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m6779setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            getComposePaint().mo4451setStylek9PVt8s(PaintingStyle.INSTANCE.m4836getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            getComposePaint().setStrokeWidth(stroke.getWidth());
            getComposePaint().setStrokeMiterLimit(stroke.getMiter());
            getComposePaint().mo4450setStrokeJoinWw9F2mQ(stroke.getJoin());
            getComposePaint().mo4449setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m6778setBlendModes9anfk8(int i) {
        if (BlendMode.m4479equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo4446setBlendModes9anfk8(i);
