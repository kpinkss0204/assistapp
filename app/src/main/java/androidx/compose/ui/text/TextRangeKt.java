...
public final class TextRangeKt {
    ...
    public static final String m6519substringFDrldGo(CharSequence charSequence, long j) {
        return charSequence.subSequence(TextRange.m6510getMinimpl(j), TextRange.m6509getMaximpl(j)).toString();
    }

    public static final long TextRange(int i, int i2) {
        return TextRange.m6501constructorimpl(packWithCheck(i, i2));
    }
    ...
    public static final long m6518coerceIn8ffj60Q(long j, int i, int i2) {
        int iCoerceIn = RangesKt.coerceIn(TextRange.m6512getStartimpl(j), i, i2);
        int iCoerceIn2 = RangesKt.coerceIn(TextRange.m6507getEndimpl(j), i, i2);
        return (iCoerceIn == TextRange.m6512getStartimpl(j) && iCoerceIn2 == TextRange.m6507getEndimpl(j)) ? j : TextRange(iCoerceIn, iCoerceIn2);
    }
