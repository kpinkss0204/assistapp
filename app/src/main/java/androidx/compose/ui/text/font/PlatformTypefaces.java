...
public interface PlatformTypefaces {
    ...
    android.graphics.Typeface mo6649createDefaultFO1MlWM(FontWeight fontWeight, int fontStyle);

    /* JADX INFO: renamed from: createNamed-RetOiIg, reason: not valid java name */
    android.graphics.Typeface mo6650createNamedRetOiIg(GenericFontFamily name, FontWeight fontWeight, int fontStyle);

    /* JADX INFO: renamed from: optionalOnDeviceFontFamilyByName-78DK7lM, reason: not valid java name */
    android.graphics.Typeface mo6651optionalOnDeviceFontFamilyByName78DK7lM(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings, Context context);
}
