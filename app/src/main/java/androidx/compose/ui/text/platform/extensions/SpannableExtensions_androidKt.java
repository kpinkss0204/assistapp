...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM7220getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m7217equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m7217equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m7238isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m7238isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM7219getTypeUIouoOA = TextUnit.m7219getTypeUIouoOA(textIndent.getFirstLine());
            float fM7220getValueimpl2 = 0.0f;
            if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7253getSpUIouoOA())) {
                fM7220getValueimpl = density.mo656toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM7220getValueimpl = TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7252getEmUIouoOA()) ? TextUnit.m7220getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM7219getTypeUIouoOA2 = TextUnit.m7219getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA2, TextUnitType.INSTANCE.m7253getSpUIouoOA())) {
                fM7220getValueimpl2 = density.mo656toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA2, TextUnitType.INSTANCE.m7252getEmUIouoOA())) {
                fM7220getValueimpl2 = TextUnit.m7220getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM7220getValueimpl), (int) Math.ceil(fM7220getValueimpl2)), 0, spannable.length());
        }
    }

    /* JADX INFO: renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m6793setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float fM6788resolveLineHeightInPxo2QH7mI = m6788resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM6788resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(fM6788resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m6901isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m6902isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m6794setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float fM6788resolveLineHeightInPxo2QH7mI = m6788resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM6788resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM6788resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* JADX INFO: renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m6788resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM7220getValueimpl;
        long jM7219getTypeUIouoOA = TextUnit.m7219getTypeUIouoOA(j);
        if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7253getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo656toPxR2X_6o(j);
            }
            fM7220getValueimpl = TextUnit.m7220getValueimpl(j) / TextUnit.m7220getValueimpl(density.mo660toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7252getEmUIouoOA())) {
                return Float.NaN;
            }
            fM7220getValueimpl = TextUnit.m7220getValueimpl(j);
        }
        return fM7220getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM6787createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM6787createLetterSpacingSpaneAf_CNQ = m6787createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM6787createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m6790setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m6791setColorRPmYEkk(spannable, item.m6462getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m6792setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m6789setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m6787createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM7219getTypeUIouoOA = TextUnit.m7219getTypeUIouoOA(j);
        if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7253getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo656toPxR2X_6o(j));
        }
        if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7252getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m7220getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m7248equalsimpl0(TextUnit.m7219getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m7253getSpUIouoOA()) || TextUnitType.m7248equalsimpl0(TextUnit.m7219getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m7252getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m4622toArgb8_81llA(shadow.getColor()), Offset.m4327getXimpl(shadow.getOffset()), Offset.m4328getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m6789setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m4622toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m6792setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM7219getTypeUIouoOA = TextUnit.m7219getTypeUIouoOA(j);
        if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7253getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo656toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7252getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m7220getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m6791setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m4622toArgb8_81llA(j)), i, i2);
        }
    }

    /* JADX INFO: renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m6790setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m6806unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m6791setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m6545getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m6544getFontStyle4Lr2A7w(), textStyle.m6545getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                FontStyle fontStyleM6619boximpl = FontStyle.m6619boximpl(fontStyle != null ? fontStyle.m6625unboximpl() : FontStyle.INSTANCE.m6629getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM6619boximpl, FontSynthesis.m6630boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6639getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }
}
