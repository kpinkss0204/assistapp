...
public final /* data */ class ParagraphInfo {
    ...
    public final long m6393toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m4327getXimpl(j), Offset.m4328getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        return rect.m4364translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }
    ...
    public final Path toGlobal(Path path) {
        path.mo4463translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m6391toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6392toGlobalxdX6G0(j, z);
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m6392toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m6505equalsimpl0(j, TextRange.INSTANCE.m6517getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6517getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6512getStartimpl(j)), toGlobalIndex(TextRange.m6507getEndimpl(j)));
    }
}
