...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle spanStyle, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, Density density, boolean z) {
        long jM7219getTypeUIouoOA = TextUnit.m7219getTypeUIouoOA(spanStyle.getFontSize());
        if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7253getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo656toPxR2X_6o(spanStyle.getFontSize()));
        } else if (TextUnitType.m7248equalsimpl0(jM7219getTypeUIouoOA, TextUnitType.INSTANCE.m7252getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m7220getValueimpl(spanStyle.getFontSize()));
        }
        if (hasFontAttributes(spanStyle)) {
            ...
            androidTextPaint.setTypeface(function4.invoke(fontFamily, fontWeight, fontStyleM6619boximpl, FontSynthesis.m6630boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6639getAllGVVA2EU())));
        }
        ...
        androidTextPaint.m6781setColor8_81llA(spanStyle.m6462getColor0d7_KjU());
        androidTextPaint.m6779setBrush12SF9DM(spanStyle.getBrush(), Size.INSTANCE.m4404getUnspecifiedNHjbRc(), spanStyle.getAlpha());
        androidTextPaint.setShadow(spanStyle.getShadow());
        androidTextPaint.setTextDecoration(spanStyle.getTextDecoration());
        androidTextPaint.setDrawStyle(spanStyle.getDrawStyle());
        if (TextUnitType.m7248equalsimpl0(TextUnit.m7219getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m7253getSpUIouoOA()) && TextUnit.m7220getValueimpl(spanStyle.getLetterSpacing()) != 0.0f) {
            float textSize = androidTextPaint.getTextSize() * androidTextPaint.getTextScaleX();
            float fMo656toPxR2X_6o = density.mo656toPxR2X_6o(spanStyle.getLetterSpacing());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(fMo656toPxR2X_6o / textSize);
            }
        } else if (TextUnitType.m7248equalsimpl0(TextUnit.m7219getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m7252getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m7220getValueimpl(spanStyle.getLetterSpacing()));
        }
        return m6795generateFallbackSpanStyle62GTOB8(spanStyle.getLetterSpacing(), z, spanStyle.getBackground(), spanStyle.getBaselineShift());
    }
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m6795generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L22
            long r4 = androidx.compose.ui.unit.TextUnit.m7219getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m7253getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m7248equalsimpl0(r4, r6)
            if (r4 == 0) goto L22
            float r4 = androidx.compose.ui.unit.TextUnit.m7220getValueimpl(r31)
            r5 = 0
        ...
        L23:
            ...
            long r5 = r5.m4604getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m4569equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m4603getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m4569equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            r5 = r2
            goto L3e
        ...
        L3e:
            ...
            float r6 = r6.m6810getNoney9eOQZs()
            float r7 = r36.m6806unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m6803equalsimpl0(r7, r6)
            if (r6 != 0) goto L51
            goto L52
        L51:
            r2 = r3
        ...
        L5f:
            ...
            long r6 = r4.m7231getUnspecifiedXSAIIZE()
            r18 = r6
        L67:
            if (r5 == 0) goto L6a
            goto L70
        L6a:
            ...
            long r0 = r0.m4604getUnspecified0d7_KjU()
        L70:
            r23 = r0
            if (r2 == 0) goto L77
            r20 = r36
        ...
        L79:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m6795generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint androidTextPaint, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m6948equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6953getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m6948equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6952getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (TextMotion.Linearity.m6948equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6954getNone4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
        } else {
            androidTextPaint.getFlags();
