...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6576getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m6622equalsimpl0(i, FontStyle.INSTANCE.m6628getItalic_LCdwA()));
    }
}
