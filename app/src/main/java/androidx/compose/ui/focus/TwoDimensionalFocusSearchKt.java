...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m4292twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m4288findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 == 4) {
                ...
                return Boolean.valueOf(m4291searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
            }
        ...
        if (i3 == 1) {
            Boolean boolM4292twoDimensionalFocusSearchsMXa3k8 = m4292twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual((Object) boolM4292twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                return boolM4292twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m4289generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m4289generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m4291searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m4235searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m4291searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
    ...
    private static final FocusTargetNode m4287findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4248getLeftdhqQ8s())) {
            rectTranslate = rect.translate(rect.getWidth() + 1, 0.0f);
        } else if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4251getRightdhqQ8s())) {
            rectTranslate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4252getUpdhqQ8s())) {
            rectTranslate = rect.translate(0.0f, rect.getHeight() + 1);
        } else {
            if (!FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4245getDowndhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m4290isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    private static final boolean isBetterCandidate_I7lrPNg$isCandidate(Rect rect, int i, Rect rect2) {
        ...
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4251getRightdhqQ8s())) {
            return (rect2.getLeft() < rect.getLeft() || rect2.getRight() <= rect.getLeft()) && rect2.getRight() < rect.getRight();
        }
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4252getUpdhqQ8s())) {
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4248getLeftdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4251getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4252getUpdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4245getDowndhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m4290isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) && !m4286beamBeatsI7lrPNg(rect3, rect, rect2, i)) {
            return !m4286beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2);
        }
        return true;
    }
    ...
    private static final boolean m4286beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4248getLeftdhqQ8s()) || FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4251getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m4288findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4246getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m4251getRightdhqQ8s();
        }
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4251getRightdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4245getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!(FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4248getLeftdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4252getUpdhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        }
        FocusTargetNode focusTargetNodeM4287findBestCandidate4WY_MpI = m4287findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM4287findBestCandidate4WY_MpI != null) {
            return function1.invoke(focusTargetNodeM4287findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m4291searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM4287findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        FocusTargetNode focusTargetNode2 = focusTargetNode;
        int iM6138constructorimpl = NodeKind.m6138constructorimpl(1024);
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((nodePop.getAggregateChildKindSet() & iM6138constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((nodePop.getKindSet() & iM6138constructorimpl) != 0) {
        ...
        while (mutableVector.isNotEmpty() && (focusTargetNodeM4287findBestCandidate4WY_MpI = m4287findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (focusTargetNodeM4287findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetNodeM4287findBestCandidate4WY_MpI).booleanValue();
            }
            if (m4289generateAndSearchChildren4C6V_qg(focusTargetNodeM4287findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM4287findBestCandidate4WY_MpI);
        }
        return false;
    }
