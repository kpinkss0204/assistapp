...
public final class FocusInteropUtils_androidKt {
    public static final FocusDirection toFocusDirection(int i) {
        if (i == 1) {
            return FocusDirection.m4236boximpl(FocusDirection.INSTANCE.m4250getPreviousdhqQ8s());
        }
        if (i == 2) {
            return FocusDirection.m4236boximpl(FocusDirection.INSTANCE.m4249getNextdhqQ8s());
        }
        if (i == 17) {
    ...
    public static final Integer m4253toAndroidFocusDirection3ESFkO8(int i) {
        ...
        return FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4250getPreviousdhqQ8s()) ? 1 : null;
    }
