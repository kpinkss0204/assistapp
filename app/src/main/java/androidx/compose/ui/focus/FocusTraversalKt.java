...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m4279customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4250getPreviousdhqQ8s())) {
        ...
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4246getEnterdhqQ8s())) {
            return focusPropertiesFetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m4236boximpl(i));
        }
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4247getExitdhqQ8s())) {
            return focusPropertiesFetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m4236boximpl(i));
        }
        throw new IllegalStateException("invalid FocusDirection".toString());
    }

    /* JADX INFO: renamed from: focusSearch-0X8WOeE, reason: not valid java name */
    public static final Boolean m4280focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int iM4251getRightdhqQ8s;
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4249getNextdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4250getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m4283oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4248getLeftdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4251getRightdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4252getUpdhqQ8s()) ? true : FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4245getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m4292twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4246getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                iM4251getRightdhqQ8s = FocusDirection.INSTANCE.m4251getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                iM4251getRightdhqQ8s = FocusDirection.INSTANCE.m4248getLeftdhqQ8s();
            }
            FocusTargetNode focusTargetNodeFindActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (focusTargetNodeFindActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m4292twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode, iM4251getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m4239equalsimpl0(i, FocusDirection.INSTANCE.m4247getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m4241toStringimpl(i))).toString());
    }
