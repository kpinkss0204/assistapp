...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM4316boximpl = currentBounds != null ? Offset.m4316boximpl(currentBounds.m4362getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM4316boximpl);
            long packedValue = offsetM4316boximpl.getPackedValue();
            float fM4327getXimpl = Offset.m4327getXimpl(packedValue);
            float fM4328getYimpl = Offset.m4328getYimpl(packedValue);
            ...
            if (path != null) {
                ...
                try {
                    drawContext.getTransform().mo5047clipPathmtrdDE(path, iM4557getIntersectrtfAjoo);
                    drawScope.getDrawContext().getTransform().translate(fM4327getXimpl, fM4328getYimpl);
                    try {
    ...
    public final long m391getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m7209toSizeozmzZPI(layoutCoordinatesInvoke.mo5911getSizeYbymL2g());
    }
    ...
    public final long m390calculateLookaheadOffsetF1C5BW0() {
        LayoutCoordinates layoutCoordinatesInvoke = this.lookaheadCoords.invoke();
        if (layoutCoordinatesInvoke == null) {
            throw new IllegalArgumentException("Error: lookahead coordinates is null.".toString());
        }
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5912localPositionOfR5De75A(layoutCoordinatesInvoke, Offset.INSTANCE.m4343getZeroF1C5BW0());
    }
