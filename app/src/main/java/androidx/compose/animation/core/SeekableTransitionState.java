...
public final class SeekableTransitionState<S> extends TransitionState<S> {
    ...
    static final class C02401 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02401(SeekableTransitionState<S> seekableTransitionState, Continuation<? super C02401> continuation) {
            super(continuation);
            this.this$0 = seekableTransitionState;
        }
    ...
    static final class C02411 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02411(SeekableTransitionState<S> seekableTransitionState, Continuation<? super C02411> continuation) {
            super(continuation);
            this.this$0 = seekableTransitionState;
        }
    ...
    */
    ...
    public final Object snapTo(S s, Continuation<? super Unit> continuation) {
        ...
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C02392(this, s, transition, null), continuation, 1, null);
    ...
    static final class C02392 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02392(SeekableTransitionState<S> seekableTransitionState, S s, Transition<S> transition, Continuation<? super C02392> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C02392(this.this$0, this.$targetState, this.$transition, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C02392) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: Transition.kt */
    @Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002H\u008a@"}, d2 = {"<anonymous>", "", ExifInterface.LATITUDE_SOUTH}, k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(c = "androidx.compose.animation.core.SeekableTransitionState$seekTo$3", f = "Transition.kt", i = {}, l = {TypedValues.PositionType.TYPE_PERCENT_Y}, m = "invokeSuspend", n = {}, s = {})
    ...
    */
    public final java.lang.Object waitForComposition(kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof androidx.compose.animation.core.SeekableTransitionState.C02401
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.animation.core.SeekableTransitionState$waitForComposition$1 r0 = (androidx.compose.animation.core.SeekableTransitionState.C02401) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
