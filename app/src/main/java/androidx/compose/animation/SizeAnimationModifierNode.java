...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m399setLookaheadConstraintsBRTryo0(long j) {
        this.lookaheadConstraints = j;
        this.lookaheadConstraintsAvailable = true;
    }

    /* JADX INFO: renamed from: targetConstraints-ZezNO4M, reason: not valid java name */
    private final long m400targetConstraintsZezNO4M(long j) {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m402copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m404copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m404copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m7195equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m7198hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m7200toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m405getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* JADX INFO: renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m406setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo375measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        long jM6994constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m399setLookaheadConstraintsBRTryo0(j);
            placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(j);
        } else {
            placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(m400targetConstraintsZezNO4M(j));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            jM6994constrain4WqzIAM = jIntSize;
        } else {
            jM6994constrain4WqzIAM = ConstraintsKt.m6994constrain4WqzIAM(j, m401animateTomzRDjE0(AnimationModifierKt.m352isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize));
        }
        final int iM7197getWidthimpl = IntSize.m7197getWidthimpl(jM6994constrain4WqzIAM);
        final int iM7196getHeightimpl = IntSize.m7196getHeightimpl(jM6994constrain4WqzIAM);
        return MeasureScope.layout$default(measureScope, iM7197getWidthimpl, iM7196getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5968placeRelative70tqf50$default(placementScope, placeable, this.this$0.getAlignment().mo4173alignKFBX0sM(jIntSize, IntSizeKt.IntSize(iM7197getWidthimpl, iM7196getHeightimpl), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* JADX INFO: renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m401animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m7195equalsimpl0(targetSize, animData.getAnim().getValue().getPackedValue()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m7195equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue()) || z) {
                animData.m406setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m7189boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m7189boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
