...
final class SizeTransformImpl implements SizeTransform {
    ...
    public FiniteAnimationSpec<IntSize> mo407createAnimationSpecTemP2vQ(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(IntSize.m7189boximpl(initialSize), IntSize.m7189boximpl(targetSize));
    }
}
