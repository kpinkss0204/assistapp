...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m374setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m376sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m7189boximpl(fullSize)).getPackedValue();
                }
            } else {
                if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m7189boximpl(fullSize)).getPackedValue();
                }
            }
        }
        return fullSize;
    ...
    public final long m378targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            ...
            if (changeSize != null) {
                long packedValue = changeSize.getSize().invoke(IntSize.m7189boximpl(fullSize)).getPackedValue();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo4173alignKFBX0sM = alignment.mo4173alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m7158minusqkQi6aY(jMo4173alignKFBX0sM, alignment2.mo4173alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m7165getZeronOccac();
        }
        return IntOffset.INSTANCE.m7165getZeronOccac();
    ...
    public MeasureResult mo375measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jIntSize = IntSizeKt.IntSize(placeableMo5903measureBRTryo0.getWidth(), placeableMo5903measureBRTryo0.getHeight());
            this.lookaheadSize = jIntSize;
            m374setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, IntSize.m7197getWidthimpl(jIntSize), IntSize.m7196getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable placeableMo5903measureBRTryo02 = measurable.mo5903measureBRTryo0(j);
            long jIntSize2 = IntSizeKt.IntSize(placeableMo5903measureBRTryo02.getWidth(), placeableMo5903measureBRTryo02.getHeight());
            final long j2 = AnimationModifierKt.m352isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize2;
            ...
            State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m7189boximpl(m379invokeYEO4UFw(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m379invokeYEO4UFw(EnterExitState enterExitState) {
                    return this.this$0.m376sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (stateAnimate3 != null) {
                jIntSize2 = stateAnimate3.getValue().getPackedValue();
            }
            long jM6994constrain4WqzIAM = ConstraintsKt.m6994constrain4WqzIAM(j, jIntSize2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            final long jM7165getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                }
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7146boximpl(m380invokeBjo55l4(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m380invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m378targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7165getZeronOccac() : stateAnimate2.getValue().getPackedValue();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long jM7165getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7146boximpl(m381invokeBjo55l4(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m381invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m377slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7165getZeronOccac() : stateAnimate.getValue().getPackedValue();
            Alignment alignment2 = this.currentAlignment;
            final long jM7159plusqkQi6aY = IntOffset.m7159plusqkQi6aY(alignment2 != null ? alignment2.mo4173alignKFBX0sM(j2, jM6994constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m7165getZeronOccac(), jM7165getZeronOccac2);
            return MeasureScope.layout$default(measureScope, IntSize.m7197getWidthimpl(jM6994constrain4WqzIAM), IntSize.m7196getHeightimpl(jM6994constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(placeableMo5903measureBRTryo02, IntOffset.m7155getXimpl(jM7165getZeronOccac) + IntOffset.m7155getXimpl(jM7159plusqkQi6aY), IntOffset.m7156getYimpl(jM7165getZeronOccac) + IntOffset.m7156getYimpl(jM7159plusqkQi6aY), 0.0f, function1Init);
                }
            }, 4, null);
        }
        final Placeable placeableMo5903measureBRTryo03 = measurable.mo5903measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo5903measureBRTryo03.getWidth(), placeableMo5903measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5903measureBRTryo03, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m377slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM7165getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7165getZeronOccac() : slideOffset2.invoke(IntSize.m7189boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long jM7165getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7165getZeronOccac() : slideOffset.invoke(IntSize.m7189boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m7165getZeronOccac();
        }
        if (i == 2) {
            return jM7165getZeronOccac;
        }
        if (i == 3) {
            return jM7165getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }
}
