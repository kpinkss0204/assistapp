...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m7202getZeroYbymL2g();
    ...
    public final void m506setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m7195equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m7202getZeroYbymL2g())) {
            width = IntSize.m7197getWidthimpl(this.surfaceSize);
            height = IntSize.m7196getHeightimpl(this.surfaceSize);
