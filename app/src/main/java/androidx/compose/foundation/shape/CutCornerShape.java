...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo1231createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m4396getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m4396getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m4396getWidthimpl(size), Size.m4393getHeightimpl(size) - f2);
        Path.lineTo(Size.m4396getWidthimpl(size) - f2, Size.m4393getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m4393getHeightimpl(size));
        Path.lineTo(0.0f, Size.m4393getHeightimpl(size) - bottomEnd);
        Path.close();
