...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float f, Brush brush, Shape shape) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                if (cacheDrawScope.mo657toPx0680j_4(this.this$0.getWidth()) < 0.0f || Size.m4395getMinDimensionimpl(cacheDrawScope.m4217getSizeNHjbRc()) <= 0.0f) {
                    return BorderKt.drawContentWithoutBorder(cacheDrawScope);
                }
                float f2 = 2;
                float fMin = Math.min(Dp.m7032equalsimpl0(this.this$0.getWidth(), Dp.INSTANCE.m7045getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil(cacheDrawScope.mo657toPx0680j_4(this.this$0.getWidth())), (float) Math.ceil(Size.m4395getMinDimensionimpl(cacheDrawScope.m4217getSizeNHjbRc()) / f2));
                float f3 = fMin / f2;
                long jOffset = OffsetKt.Offset(f3, f3);
                long jSize = SizeKt.Size(Size.m4396getWidthimpl(cacheDrawScope.m4217getSizeNHjbRc()) - fMin, Size.m4393getHeightimpl(cacheDrawScope.m4217getSizeNHjbRc()) - fMin);
                boolean z = f2 * fMin > Size.m4395getMinDimensionimpl(cacheDrawScope.m4217getSizeNHjbRc());
                Outline outlineMo568createOutlinePq9zytI = this.this$0.getShape().mo568createOutlinePq9zytI(cacheDrawScope.m4217getSizeNHjbRc(), cacheDrawScope.getLayoutDirection(), cacheDrawScope);
                if (outlineMo568createOutlinePq9zytI instanceof Outline.Generic) {
                    BorderModifierNode borderModifierNode = this.this$0;
                    return borderModifierNode.drawGenericBorder(cacheDrawScope, borderModifierNode.getBrush(), (Outline.Generic) outlineMo568createOutlinePq9zytI, z, fMin);
                }
                if (outlineMo568createOutlinePq9zytI instanceof Outline.Rounded) {
                    BorderModifierNode borderModifierNode2 = this.this$0;
                    return borderModifierNode2.m537drawRoundRectBorderJqoCqck(cacheDrawScope, borderModifierNode2.getBrush(), (Outline.Rounded) outlineMo568createOutlinePq9zytI, jOffset, jSize, z, fMin);
                }
                if (outlineMo568createOutlinePq9zytI instanceof Outline.Rectangle) {
                    return BorderKt.m534drawRectBorderNsqcLGU(cacheDrawScope, this.this$0.getBrush(), jOffset, jSize, z, fMin);
                }
    ...
    public final void m539setWidth0680j_4(float f) {
        if (Dp.m7032equalsimpl0(this.width, f)) {
            return;
        }
        this.width = f;
    ...
    */
    public final androidx.compose.ui.draw.DrawResult drawGenericBorder(androidx.compose.ui.draw.CacheDrawScope r37, final androidx.compose.ui.graphics.Brush r38, final androidx.compose.ui.graphics.Outline.Generic r39, boolean r40, float r41) throws java.lang.Throwable {
        /*
    ...
    public final DrawResult m537drawRoundRectBorderJqoCqck(CacheDrawScope cacheDrawScope, final Brush brush, Outline.Rounded rounded, final long j, final long j2, final boolean z, final float f) {
        if (RoundRectKt.isSimple(rounded.getRoundRect())) {
            final long jM4377getTopLeftCornerRadiuskKHJgLs = rounded.getRoundRect().m4377getTopLeftCornerRadiuskKHJgLs();
            final float f2 = f / 2;
            ...
            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
                ...
                public final void invoke2(ContentDrawScope contentDrawScope) throws Throwable {
                    ...
                    if (z) {
                        DrawScope.m5119drawRoundRectZuiqVtQ$default(contentDrawScope, brush, 0L, 0L, jM4377getTopLeftCornerRadiuskKHJgLs, 0.0f, null, null, 0, 246, null);
                        return;
                    }
                    float fM4302getXimpl = CornerRadius.m4302getXimpl(jM4377getTopLeftCornerRadiuskKHJgLs);
                    float f3 = f2;
                    if (fM4302getXimpl < f3) {
                        ContentDrawScope contentDrawScope2 = contentDrawScope;
                        float f4 = f;
                        float fM4396getWidthimpl = Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()) - f;
                        float fM4393getHeightimpl = Size.m4393getHeightimpl(contentDrawScope.mo5124getSizeNHjbRc()) - f;
                        int iM4556getDifferencertfAjoo = ClipOp.INSTANCE.m4556getDifferencertfAjoo();
                        Brush brush2 = brush;
                        long j4 = jM4377getTopLeftCornerRadiuskKHJgLs;
                        DrawContext drawContext = contentDrawScope2.getDrawContext();
                        long jMo5045getSizeNHjbRc = drawContext.mo5045getSizeNHjbRc();
                        drawContext.getCanvas().save();
                        try {
                            drawContext.getTransform().mo5048clipRectN_I0leg(f4, f4, fM4396getWidthimpl, fM4393getHeightimpl, iM4556getDifferencertfAjoo);
                            try {
                                DrawScope.m5119drawRoundRectZuiqVtQ$default(contentDrawScope2, brush2, 0L, 0L, j4, 0.0f, null, null, 0, 246, null);
                                drawContext.getCanvas().restore();
                                drawContext.mo5046setSizeuvyYCjk(jMo5045getSizeNHjbRc);
                            } catch (Throwable th) {
                                th = th;
                                j3 = jMo5045getSizeNHjbRc;
                                drawContext.getCanvas().restore();
                                drawContext.mo5046setSizeuvyYCjk(j3);
                                throw th;
                            }
                        } catch (Throwable th2) {
                            th = th2;
                        ...
                        DrawScope.m5119drawRoundRectZuiqVtQ$default(contentDrawScope, brush, j, j2, BorderKt.m535shrinkKibmq7A(jM4377getTopLeftCornerRadiuskKHJgLs, f3), 0.0f, stroke, null, 0, 208, null);
                    }
                }
            });
        }
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                contentDrawScope.drawContent();
                DrawScope.m5113drawPathGBMwjPU$default(contentDrawScope, pathCreateRoundRectPath, brush, 0.0f, null, null, 0, 60, null);
            }
        });
    }
}
