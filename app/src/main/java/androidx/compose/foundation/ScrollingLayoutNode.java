...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo375measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        CheckScrollableContainerConstraintsKt.m548checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(Constraints.m6971copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m6980getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m6979getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo5903measureBRTryo0.getWidth(), Constraints.m6980getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo5903measureBRTryo0.getHeight(), Constraints.m6979getMaxHeightimpl(j));
        final int height = placeableMo5903measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo5903measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
