...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m7027constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m4139rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int iM7197getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m7197getWidthimpl(pagerLayoutInfo.mo1204getViewportSizeYbymL2g()) : IntSize.m7196getHeightimpl(pagerLayoutInfo.mo1204getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - ((long) (iM7197getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(iM7197getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, iM7197getWidthimpl))), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int iM7197getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m7197getWidthimpl(pagerMeasureResult.mo1204getViewportSizeYbymL2g()) : IntSize.m7196getHeightimpl(pagerMeasureResult.mo1204getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(iM7197getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, iM7197getWidthimpl);
    }
