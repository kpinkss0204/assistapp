...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i < size) {
            ...
            long jM1200getOffsetBjo55l4 = m1200getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                if (this.isVertical) {
                    iM7155getXimpl = IntOffset.m7155getXimpl(jM1200getOffsetBjo55l4);
                } else {
                    iM7155getXimpl = (this.mainAxisLayoutSize - IntOffset.m7155getXimpl(jM1200getOffsetBjo55l4)) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    iM7156getYimpl = (this.mainAxisLayoutSize - IntOffset.m7156getYimpl(jM1200getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM7156getYimpl = IntOffset.m7156getYimpl(jM1200getOffsetBjo55l4);
                }
                jM1200getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl);
            }
            long jM7159plusqkQi6aY = IntOffset.m7159plusqkQi6aY(jM1200getOffsetBjo55l4, this.visualOffset);
            if (this.isVertical) {
                placementScope = scope;
                Placeable.PlacementScope.m5971placeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            } else {
                placementScope = scope;
                Placeable.PlacementScope.m5969placeRelativeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            }
            i++;
    ...
    private final long m1200getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
    ...
    private final long m1199copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int iM7155getXimpl = this.isVertical ? IntOffset.m7155getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m7155getXimpl(j))).intValue();
        boolean z = this.isVertical;
