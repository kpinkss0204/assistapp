...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m548checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        ...
        } else if (Constraints.m6980getMaxWidthimpl(j) == Integer.MAX_VALUE) {
