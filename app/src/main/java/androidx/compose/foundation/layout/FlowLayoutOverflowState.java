...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final IntIntPair m893ellipsisSizeF35zmw$foundation_layout_release(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
    ...
    public final void m895setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        long jM934constructorimpl = OrientationIndependentConstraints.m934constructorimpl(constraints, isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (seeMoreMeasurable != null) {
            int iMainAxisMin = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m6979getMaxHeightimpl(jM934constructorimpl));
            this.seeMoreSize = IntIntPair.m305boximpl(IntIntPair.m308constructorimpl(iMainAxisMin, FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, iMainAxisMin)));
        ...
        if (collapseMeasurable != null) {
            int iMainAxisMin2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m6979getMaxHeightimpl(jM934constructorimpl));
            this.collapseSize = IntIntPair.m305boximpl(IntIntPair.m308constructorimpl(iMainAxisMin2, FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, iMainAxisMin2)));
    ...
    /* JADX INFO: renamed from: setOverflowMeasurables--hBUhpc$foundation_layout_release, reason: not valid java name */
    public final void m894setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        LayoutOrientation layoutOrientation = measurePolicy.isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical;
        long jM947toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m947toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m936copyyUG9Ft0$default(OrientationIndependentConstraints.m934constructorimpl(constraints, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m891measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, jM947toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.seeMoreSize = IntIntPair.m305boximpl(IntIntPair.m308constructorimpl(iMainAxisSize, iCrossAxisSize));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m891measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, jM947toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    this.this$0.collapseSize = IntIntPair.m305boximpl(IntIntPair.m308constructorimpl(iMainAxisSize, iCrossAxisSize));
    ...
    public final void m896setOverflowMeasurablesVKLhPVY$foundation_layout_release(FlowLineMeasurePolicy measurePolicy, long constraints, Function2<? super Boolean, ? super Integer, ? extends Measurable> getOverflowMeasurable) {
        this.itemShown = 0;
        this.getOverflowMeasurable = getOverflowMeasurable;
        m894setOverflowMeasurableshBUhpc$foundation_layout_release(measurePolicy, getOverflowMeasurable.invoke(true, 0), getOverflowMeasurable.invoke(false, 0), constraints);
    }
}
