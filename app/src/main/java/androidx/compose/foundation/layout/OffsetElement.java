...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        node.m929setX0680j_4(this.x);
        node.m930setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return offsetElement != null && Dp.m7032equalsimpl0(this.x, offsetElement.x) && Dp.m7032equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m7033hashCodeimpl(this.x) * 31) + Dp.m7033hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m7038toStringimpl(this.x)) + ", y=" + ((Object) Dp.m7038toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
