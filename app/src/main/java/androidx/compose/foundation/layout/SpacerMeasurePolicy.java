...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo322measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6978getHasFixedWidthimpl(j) ? Constraints.m6980getMaxWidthimpl(j) : 0, Constraints.m6977getHasFixedHeightimpl(j) ? Constraints.m6979getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
