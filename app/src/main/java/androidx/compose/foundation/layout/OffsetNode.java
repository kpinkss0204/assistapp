...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m929setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m930setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo375measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo5903measureBRTryo0.getWidth(), placeableMo5903measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5903measureBRTryo0, measureScope.mo651roundToPx0680j_4(this.this$0.getX()), measureScope.mo651roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo5903measureBRTryo0, measureScope.mo651roundToPx0680j_4(this.this$0.getX()), measureScope.mo651roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
