...
final class AndroidFlingSpline {
    ...
    public final long m835flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m837constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m836boximpl(long j) {
        ...
        public static int m842hashCodeimpl(long j) {
            return Long.hashCode(j);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m843toStringimpl(long j) {
        ...
        public int hashCode() {
            return m842hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m843toStringimpl(this.packedValue);
        }
        ...
        public static final float m840getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* JADX INFO: renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m841getVelocityCoefficientimpl(long j) {
