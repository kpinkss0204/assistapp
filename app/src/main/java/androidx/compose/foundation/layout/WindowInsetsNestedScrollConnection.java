...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo1041onPreScrollOzD1aCk(long available, int source) {
        return m1039scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m4327getXimpl(available), Offset.m4328getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo767onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m1039scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m4327getXimpl(available), Offset.m4328getYimpl(available)));
    }

    /* JADX INFO: renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m1039scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo991consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo1040onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m1038flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m7264getXimpl(j), Velocity.m7265getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo766onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m1038flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m7264getXimpl(j2), Velocity.m7265getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m1038flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instruction units count: 409
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m1038flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
