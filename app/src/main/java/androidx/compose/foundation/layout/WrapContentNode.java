...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo375measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m6982getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m6980getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m6981getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m6979getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo5903measureBRTryo0.getWidth(), Constraints.m6982getMinWidthimpl(j), Constraints.m6980getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo5903measureBRTryo0.getHeight(), Constraints.m6981getMinHeightimpl(j), Constraints.m6979getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5967place70tqf50$default(placementScope, placeableMo5903measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m7189boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo5903measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo5903measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
