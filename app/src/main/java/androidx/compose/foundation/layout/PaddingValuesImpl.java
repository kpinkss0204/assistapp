...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m982getBottomD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m983getEndD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m984getStartD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m985getTopD9Ej5fM$annotations() {
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7032equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m7032equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m7032equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m7032equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m7033hashCodeimpl(this.start) * 31) + Dp.m7033hashCodeimpl(this.top)) * 31) + Dp.m7033hashCodeimpl(this.end)) * 31) + Dp.m7033hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m7038toStringimpl(this.start)) + ", top=" + ((Object) Dp.m7038toStringimpl(this.top)) + ", end=" + ((Object) Dp.m7038toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m7038toStringimpl(this.bottom)) + ')';
    }
