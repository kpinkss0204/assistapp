...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m1032setMinWidth0680j_4(this.minWidth);
        node.m1031setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m7025boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m7025boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7032equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m7032equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m7033hashCodeimpl(this.minWidth) * 31) + Dp.m7033hashCodeimpl(this.minHeight);
    }
}
