...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m877copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m879copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m879copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m6973equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m6983hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m6985toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo876getMinWidthD9Ej5fM() {
        return this.density.mo654toDpu2uoSUM(Constraints.m6982getMinWidthimpl(mo872getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo874getMaxWidthD9Ej5fM() {
        return Constraints.m6976getHasBoundedWidthimpl(mo872getConstraintsmsEJaDk()) ? this.density.mo654toDpu2uoSUM(Constraints.m6980getMaxWidthimpl(mo872getConstraintsmsEJaDk())) : Dp.INSTANCE.m7046getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo875getMinHeightD9Ej5fM() {
        return this.density.mo654toDpu2uoSUM(Constraints.m6981getMinHeightimpl(mo872getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxHeight-D9Ej5fM */
    public float mo873getMaxHeightD9Ej5fM() {
        return Constraints.m6975getHasBoundedHeightimpl(mo872getConstraintsmsEJaDk()) ? this.density.mo654toDpu2uoSUM(Constraints.m6979getMaxHeightimpl(mo872getConstraintsmsEJaDk())) : Dp.INSTANCE.m7046getInfinityD9Ej5fM();
    }
}
