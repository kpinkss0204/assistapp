...
interface SideCalculator {
    ...
    long mo991consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo992consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo991consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m4327getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo992consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m7264getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedOffsets-MK-Hz9U */
            public long mo991consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m4328getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo992consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m7265getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m993chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m1045equalsimpl0(side, WindowInsetsSides.INSTANCE.m1059getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m1045equalsimpl0(side, WindowInsetsSides.INSTANCE.m1062getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m1045equalsimpl0(side, WindowInsetsSides.INSTANCE.m1060getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1045equalsimpl0(side, WindowInsetsSides.INSTANCE.m1056getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m1045equalsimpl0(side, WindowInsetsSides.INSTANCE.m1061getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (!WindowInsetsSides.m1045equalsimpl0(side, WindowInsetsSides.INSTANCE.m1057getEndJoeWqyM())) {
