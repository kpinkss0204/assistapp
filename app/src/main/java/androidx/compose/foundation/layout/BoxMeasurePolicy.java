...
final /* data */ class BoxMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo322measure3p2s80s(final MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        long j2;
        int iM6982getMinWidthimpl;
        int iM6981getMinHeightimpl;
        Placeable placeableMo5903measureBRTryo0;
        if (list.isEmpty()) {
            return MeasureScope.layout$default(measureScope, Constraints.m6982getMinWidthimpl(j), Constraints.m6981getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$1
        ...
        if (this.propagateMinConstraints) {
            ...
            j2 = j;
            j = Constraints.m6971copyZbe2FdA$default(j2, 0, 0, 0, 0, 10, null);
        }
        if (list.size() == 1) {
            ...
            if (!BoxKt.getMatchesParentSize(measurable)) {
                ...
                iM6982getMinWidthimpl = Math.max(Constraints.m6982getMinWidthimpl(j2), placeableMo5903measureBRTryo0.getWidth());
                iM6981getMinHeightimpl = Math.max(Constraints.m6981getMinHeightimpl(j2), placeableMo5903measureBRTryo0.getHeight());
            } else {
                iM6982getMinWidthimpl = Constraints.m6982getMinWidthimpl(j2);
                iM6981getMinHeightimpl = Constraints.m6981getMinHeightimpl(j2);
                placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(Constraints.INSTANCE.m6990fixedJhjzzOo(Constraints.m6982getMinWidthimpl(j2), Constraints.m6981getMinHeightimpl(j2)));
            }
            final Placeable placeable = placeableMo5903measureBRTryo0;
            final int i = iM6982getMinWidthimpl;
            final int i2 = iM6981getMinHeightimpl;
        ...
        intRef.element = Constraints.m6982getMinWidthimpl(j2);
        final Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.element = Constraints.m6981getMinHeightimpl(j2);
        int size = list.size();
        boolean z = false;
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (BoxKt.getMatchesParentSize(measurable2)) {
                ...
                Placeable placeableMo5903measureBRTryo02 = measurable2.mo5903measureBRTryo0(j);
                placeableArr[i3] = placeableMo5903measureBRTryo02;
                intRef.element = Math.max(intRef.element, placeableMo5903measureBRTryo02.getWidth());
                intRef2.element = Math.max(intRef2.element, placeableMo5903measureBRTryo02.getHeight());
            }
        }
        if (z) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ...
                if (BoxKt.getMatchesParentSize(measurable3)) {
                    placeableArr[i4] = measurable3.mo5903measureBRTryo0(jConstraints);
                }
            }
        }
