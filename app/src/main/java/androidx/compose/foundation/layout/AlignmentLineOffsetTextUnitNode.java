...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m834setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m833setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo375measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m814alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m7238isUnspecifiedR2X_6o(this.before) ? measureScope.mo652toDpGaN1DYA(this.before) : Dp.INSTANCE.m7047getUnspecifiedD9Ej5fM(), !TextUnitKt.m7238isUnspecifiedR2X_6o(this.after) ? measureScope.mo652toDpGaN1DYA(this.after) : Dp.INSTANCE.m7047getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
