...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m591boximpl(i2), null, 2, null);
    ...
    public final int m605getAnimationModeZbEOnfQ() {
    ...
    public final void m606setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m591boximpl(i));
    }
    ...
    public final void m607updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m606setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m7032equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo375measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m6997constrainWidthK40F9xA(j, placeableMo5903measureBRTryo0.getWidth()));
        setContentWidth(placeableMo5903measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), placeableMo5903measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo5903measureBRTryo0, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, (Function1) null, 12, (Object) null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float fM4393getHeightimpl = Size.m4393getHeightimpl(contentDrawScope2.mo5124getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo5048clipRectN_I0leg(fFloatValue, 0.0f, containerWidth, fM4393getHeightimpl, iM4557getIntersectrtfAjoo);
            if (z) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            if (i == 0) {
                ...
                if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                    ...
                    public final Float invoke() {
                        ...
                        if (!MarqueeAnimationMode.m594equalsimpl0(marqueeModifierNode.m605getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m599getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
        ...
        static final class C00152 extends SuspendLambda implements Function2<Float, Continuation<? super Unit>, Object> {
            ...
            public final Object invoke(Float f, Continuation<? super Unit> continuation) {
                return ((C00152) create(f, continuation)).invokeSuspend(Unit.INSTANCE);
            }
