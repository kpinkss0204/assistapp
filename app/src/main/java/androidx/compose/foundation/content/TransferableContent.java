...
public final class TransferableContent {
    ...
    public static final class Source {
        ...
        private static final int Keyboard = m614constructorimpl(0);
        private static final int DragAndDrop = m614constructorimpl(1);
        private static final int Clipboard = m614constructorimpl(2);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Source m613boximpl(int i) {
            return new Source(i);
        }
        ...
        public static boolean m615equalsimpl(int i, Object obj) {
        ...
        public static String m618toStringimpl(int i) {
            return m616equalsimpl0(i, Keyboard) ? "Source.Keyboard" : m616equalsimpl0(i, DragAndDrop) ? "Source.DragAndDrop" : m616equalsimpl0(i, Clipboard) ? "Source.Clipboard" : "Invalid (" + i + ')';
        }
    }
}
