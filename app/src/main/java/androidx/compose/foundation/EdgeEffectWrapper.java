...
final class EdgeEffectWrapper {
    ...
    private final EdgeEffect createEdgeEffect() {
        ...
        if (!IntSize.m7195equalsimpl0(this.size, IntSize.INSTANCE.m7202getZeroYbymL2g())) {
            edgeEffectCreate.setSize(IntSize.m7197getWidthimpl(this.size), IntSize.m7196getHeightimpl(this.size));
        }
        return edgeEffectCreate;
    }

    /* JADX INFO: renamed from: setSize-ozmzZPI, reason: not valid java name */
    public final void m575setSizeozmzZPI(long size) {
        this.size = size;
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
            edgeEffect.setSize(IntSize.m7197getWidthimpl(size), IntSize.m7196getHeightimpl(size));
        }
        EdgeEffect edgeEffect2 = this.bottomEffect;
        if (edgeEffect2 != null) {
            edgeEffect2.setSize(IntSize.m7197getWidthimpl(size), IntSize.m7196getHeightimpl(size));
        }
        EdgeEffect edgeEffect3 = this.leftEffect;
        if (edgeEffect3 != null) {
            edgeEffect3.setSize(IntSize.m7196getHeightimpl(size), IntSize.m7197getWidthimpl(size));
        }
        EdgeEffect edgeEffect4 = this.rightEffect;
        if (edgeEffect4 != null) {
            edgeEffect4.setSize(IntSize.m7196getHeightimpl(size), IntSize.m7197getWidthimpl(size));
        }
        EdgeEffect edgeEffect5 = this.topEffectNegation;
        if (edgeEffect5 != null) {
            edgeEffect5.setSize(IntSize.m7197getWidthimpl(size), IntSize.m7196getHeightimpl(size));
        }
        EdgeEffect edgeEffect6 = this.bottomEffectNegation;
        if (edgeEffect6 != null) {
            edgeEffect6.setSize(IntSize.m7197getWidthimpl(size), IntSize.m7196getHeightimpl(size));
        }
        EdgeEffect edgeEffect7 = this.leftEffectNegation;
        if (edgeEffect7 != null) {
            edgeEffect7.setSize(IntSize.m7196getHeightimpl(size), IntSize.m7197getWidthimpl(size));
        }
        EdgeEffect edgeEffect8 = this.rightEffectNegation;
        if (edgeEffect8 != null) {
            edgeEffect8.setSize(IntSize.m7196getHeightimpl(size), IntSize.m7197getWidthimpl(size));
        }
    }
}
