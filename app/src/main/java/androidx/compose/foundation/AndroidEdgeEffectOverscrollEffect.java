...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfiguration) {
        ...
        EdgeEffectWrapper edgeEffectWrapper = new EdgeEffectWrapper(context, ColorKt.m4622toArgb8_81llA(overscrollConfiguration.getGlowColor()));
        this.edgeEffectWrapper = edgeEffectWrapper;
        this.redrawSignal = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.INSTANCE.m4405getZeroNHjbRc();
    ...
    */
    public long mo502applyToScrollRhakbz0(long r11, int r13, kotlin.jvm.functions.Function1<? super androidx.compose.ui.geometry.Offset, androidx.compose.ui.geometry.Offset> r14) {
        /*
            Method dump skipped, instruction units count: 304
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.mo502applyToScrollRhakbz0(long, int, kotlin.jvm.functions.Function1):long");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.lang.Object mo501applyToFlingBMRW4eQ(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.unit.Velocity, ? super kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super kotlin.Unit> r14) {
        /*
            Method dump skipped, instruction units count: 444
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.mo501applyToFlingBMRW4eQ(long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final boolean stopOverscrollAnimation() {
        ...
        if (this.edgeEffectWrapper.isLeftStretched()) {
            m497pullLeftk4lQ0M(Offset.INSTANCE.m4343getZeroF1C5BW0());
            z = true;
        } else {
            z = false;
        }
        if (this.edgeEffectWrapper.isRightStretched()) {
            m498pullRightk4lQ0M(Offset.INSTANCE.m4343getZeroF1C5BW0());
            z = true;
        }
        if (this.edgeEffectWrapper.isTopStretched()) {
            m499pullTopk4lQ0M(Offset.INSTANCE.m4343getZeroF1C5BW0());
            z = true;
        }
        if (!this.edgeEffectWrapper.isBottomStretched()) {
            return z;
        }
        m496pullBottomk4lQ0M(Offset.INSTANCE.m4343getZeroF1C5BW0());
        return true;
    }

    /* JADX INFO: renamed from: updateSize-uvyYCjk$foundation_release, reason: not valid java name */
    public final void m504updateSizeuvyYCjk$foundation_release(long size) {
        boolean zM4392equalsimpl0 = Size.m4392equalsimpl0(this.containerSize, Size.INSTANCE.m4405getZeroNHjbRc());
        boolean zM4392equalsimpl02 = Size.m4392equalsimpl0(size, this.containerSize);
        this.containerSize = size;
        if (!zM4392equalsimpl02) {
            this.edgeEffectWrapper.m575setSizeozmzZPI(IntSizeKt.IntSize(MathKt.roundToInt(Size.m4396getWidthimpl(size)), MathKt.roundToInt(Size.m4393getHeightimpl(size))));
        }
        if (zM4392equalsimpl0 || zM4392equalsimpl02) {
            return;
        }
    ...
    public final long m503displacementF1C5BW0$foundation_release() {
        Offset offset = this.pointerPosition;
        long packedValue = offset != null ? offset.getPackedValue() : SizeKt.m4406getCenteruvyYCjk(this.containerSize);
        return OffsetKt.Offset(Offset.m4327getXimpl(packedValue) / Size.m4396getWidthimpl(this.containerSize), Offset.m4328getYimpl(packedValue) / Size.m4393getHeightimpl(this.containerSize));
    }
    ...
    private final boolean m500releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean z;
        if (!this.edgeEffectWrapper.isLeftAnimating() || Offset.m4327getXimpl(delta) >= 0.0f) {
            z = false;
        } else {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateLeftEffect(), Offset.m4327getXimpl(delta));
            z = !this.edgeEffectWrapper.isLeftAnimating();
        }
        if (this.edgeEffectWrapper.isRightAnimating() && Offset.m4327getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateRightEffect(), Offset.m4327getXimpl(delta));
            z = z || !this.edgeEffectWrapper.isRightAnimating();
        }
        if (this.edgeEffectWrapper.isTopAnimating() && Offset.m4328getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateTopEffect(), Offset.m4328getYimpl(delta));
            z = z || !this.edgeEffectWrapper.isTopAnimating();
        }
        if (!this.edgeEffectWrapper.isBottomAnimating() || Offset.m4328getYimpl(delta) <= 0.0f) {
            return z;
        }
        EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateBottomEffect(), Offset.m4328getYimpl(delta));
        return z || !this.edgeEffectWrapper.isBottomAnimating();
    }

    /* JADX INFO: renamed from: pullTop-k-4lQ0M, reason: not valid java name */
    private final float m499pullTopk4lQ0M(long scroll) {
        float fM4327getXimpl = Offset.m4327getXimpl(m503displacementF1C5BW0$foundation_release());
        float fM4328getYimpl = Offset.m4328getYimpl(scroll) / Size.m4393getHeightimpl(this.containerSize);
        EdgeEffect orCreateTopEffect = this.edgeEffectWrapper.getOrCreateTopEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect) == 0.0f ? EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateTopEffect, fM4328getYimpl, fM4327getXimpl) * Size.m4393getHeightimpl(this.containerSize) : Offset.m4328getYimpl(scroll);
    }

    /* JADX INFO: renamed from: pullBottom-k-4lQ0M, reason: not valid java name */
    private final float m496pullBottomk4lQ0M(long scroll) {
        float fM4327getXimpl = Offset.m4327getXimpl(m503displacementF1C5BW0$foundation_release());
        float fM4328getYimpl = Offset.m4328getYimpl(scroll) / Size.m4393getHeightimpl(this.containerSize);
        EdgeEffect orCreateBottomEffect = this.edgeEffectWrapper.getOrCreateBottomEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect) == 0.0f ? (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateBottomEffect, -fM4328getYimpl, 1 - fM4327getXimpl)) * Size.m4393getHeightimpl(this.containerSize) : Offset.m4328getYimpl(scroll);
    }

    /* JADX INFO: renamed from: pullLeft-k-4lQ0M, reason: not valid java name */
    private final float m497pullLeftk4lQ0M(long scroll) {
        float fM4328getYimpl = Offset.m4328getYimpl(m503displacementF1C5BW0$foundation_release());
        float fM4327getXimpl = Offset.m4327getXimpl(scroll) / Size.m4396getWidthimpl(this.containerSize);
        EdgeEffect orCreateLeftEffect = this.edgeEffectWrapper.getOrCreateLeftEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect) == 0.0f ? EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateLeftEffect, fM4327getXimpl, 1 - fM4328getYimpl) * Size.m4396getWidthimpl(this.containerSize) : Offset.m4327getXimpl(scroll);
    }

    /* JADX INFO: renamed from: pullRight-k-4lQ0M, reason: not valid java name */
    private final float m498pullRightk4lQ0M(long scroll) {
        float fM4328getYimpl = Offset.m4328getYimpl(m503displacementF1C5BW0$foundation_release());
        float fM4327getXimpl = Offset.m4327getXimpl(scroll) / Size.m4396getWidthimpl(this.containerSize);
        EdgeEffect orCreateRightEffect = this.edgeEffectWrapper.getOrCreateRightEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect) == 0.0f ? (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateRightEffect, -fM4327getXimpl, fM4328getYimpl)) * Size.m4396getWidthimpl(this.containerSize) : Offset.m4327getXimpl(scroll);
    }
}
