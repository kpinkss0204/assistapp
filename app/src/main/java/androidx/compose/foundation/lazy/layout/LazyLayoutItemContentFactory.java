                ...
                public final void invoke(Composer composer, int i) {
                    ...
                    if ((i & 3) != 2 || !composer.getSkipping()) {
                        ...
                        if (z) {
                            ...
                            composer2 = composer;
                            LazyLayoutItemContentFactoryKt.m1133SkippableItemJVlU9Rs(lazyLayoutItemProviderInvoke, StableValue.m1153constructorimpl(lazyLayoutItemContentFactory2.saveableStateHolder), i2, StableValue.m1153constructorimpl(cachedItemContent.getKey()), composer2, 0);
                        ...
                        ComposerKt.sourceInformationMarkerStart(composer2, -714032874, "CC(remember):LazyLayoutItemContentFactory.kt#9igjgp");
