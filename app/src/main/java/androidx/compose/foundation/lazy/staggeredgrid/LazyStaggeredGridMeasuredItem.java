...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m7155getXimpl(getOffset()) : IntOffset.m7156getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        while (i < size) {
            ...
            if (animation != null) {
                ...
                if ((m1182getMainAxisgyyYBs(offset) <= height && m1182getMainAxisgyyYBs(jM7159plusqkQi6aY) <= height) || (m1182getMainAxisgyyYBs(offset) >= i2 && m1182getMainAxisgyyYBs(jM7159plusqkQi6aY) >= i2)) {
            ...
            if (context.getReverseLayout()) {
                if (getIsVertical()) {
                    ...
                    iM7155getXimpl = (this.mainAxisLayoutSize - IntOffset.m7155getXimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (!getIsVertical()) {
                    iM7156getYimpl = IntOffset.m7156getYimpl(offset);
                } else {
                    iM7156getYimpl = (this.mainAxisLayoutSize - IntOffset.m7156getYimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                offset = IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl);
            }
            long jM7159plusqkQi6aY2 = IntOffset.m7159plusqkQi6aY(offset, context.getContentOffset());
            if (animation != null) {
                animation.m1126setFinalOffsetgyyYBs(jM7159plusqkQi6aY2);
            }
            if (layer != null) {
                placementScope = scope;
                Placeable.PlacementScope.m5970placeRelativeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY2, layer, 0.0f, 4, (Object) null);
            } else {
                placementScope = scope;
