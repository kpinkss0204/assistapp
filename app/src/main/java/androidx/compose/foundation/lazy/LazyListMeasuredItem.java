...
public final class LazyListMeasuredItem implements LazyListItemInfo, LazyLayoutMeasuredItem {
    ...
    public long mo1077getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
        ...
        if (updateAnimations) {
            ...
            for (int i2 = 0; i2 < placeablesCount; i2++) {
                ...
                if (animation != null) {
                    ...
                    int iM7155getXimpl = getIsVertical() ? IntOffset.m7155getXimpl(rawOffset) : Integer.valueOf(IntOffset.m7155getXimpl(rawOffset) + delta).intValue();
                    boolean isVertical = getIsVertical();
                    int iM7156getYimpl = IntOffset.m7156getYimpl(rawOffset);
                    if (isVertical) {
                        iM7156getYimpl += delta;
                    }
                    animation.m1128setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl));
                }
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        ...
        while (i < placeablesCount) {
            ...
            long jMo1077getOffsetBjo55l4 = mo1077getOffsetBjo55l4(i);
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), i);
            if (animation != null) {
                if (isLookingAhead) {
                    animation.m1127setLookaheadOffsetgyyYBs(jMo1077getOffsetBjo55l4);
                } else {
                    if (!IntOffset.m7154equalsimpl0(animation.getLookaheadOffset(), LazyLayoutItemAnimation.INSTANCE.m1129getNotInitializednOccac())) {
                        jMo1077getOffsetBjo55l4 = animation.getLookaheadOffset();
                    }
                    long jM7159plusqkQi6aY = IntOffset.m7159plusqkQi6aY(jMo1077getOffsetBjo55l4, animation.m1124getPlacementDeltanOccac());
                    if ((m1075getMainAxisgyyYBs(jMo1077getOffsetBjo55l4) <= mainAxisSize && m1075getMainAxisgyyYBs(jM7159plusqkQi6aY) <= mainAxisSize) || (m1075getMainAxisgyyYBs(jMo1077getOffsetBjo55l4) >= i2 && m1075getMainAxisgyyYBs(jM7159plusqkQi6aY) >= i2)) {
                        animation.cancelPlacementAnimation();
                    }
                    jMo1077getOffsetBjo55l4 = jM7159plusqkQi6aY;
                }
            ...
            if (this.reverseLayout) {
                if (getIsVertical()) {
                    iM7155getXimpl = IntOffset.m7155getXimpl(jMo1077getOffsetBjo55l4);
                } else {
                    iM7155getXimpl = (this.mainAxisLayoutSize - IntOffset.m7155getXimpl(jMo1077getOffsetBjo55l4)) - getMainAxisSize(placeable);
                }
                if (getIsVertical()) {
                    iM7156getYimpl = (this.mainAxisLayoutSize - IntOffset.m7156getYimpl(jMo1077getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM7156getYimpl = IntOffset.m7156getYimpl(jMo1077getOffsetBjo55l4);
                }
                jMo1077getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl);
            }
            long jM7159plusqkQi6aY2 = IntOffset.m7159plusqkQi6aY(jMo1077getOffsetBjo55l4, this.visualOffset);
            if (!isLookingAhead && animation != null) {
                animation.m1126setFinalOffsetgyyYBs(jM7159plusqkQi6aY2);
            }
            if (!getIsVertical()) {
                placementScope = scope;
                GraphicsLayer graphicsLayer = layer;
                if (graphicsLayer != null) {
                    Placeable.PlacementScope.m5970placeRelativeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY2, graphicsLayer, 0.0f, 4, (Object) null);
                } else {
                    Placeable.PlacementScope.m5969placeRelativeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY2, 0.0f, (Function1) null, 6, (Object) null);
                }
            } else if (layer != null) {
                placementScope = scope;
                Placeable.PlacementScope.m5972placeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY2, layer, 0.0f, 4, (Object) null);
            } else {
                placementScope = scope;
                Placeable.PlacementScope.m5971placeWithLayeraW9wM$default(placementScope, placeable, jM7159plusqkQi6aY2, 0.0f, (Function1) null, 6, (Object) null);
            }
            i++;
    ...
    private final int m1075getMainAxisgyyYBs(long j) {
        return getIsVertical() ? IntOffset.m7156getYimpl(j) : IntOffset.m7155getXimpl(j);
    }
    ...
    private final long m1074copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int iM7155getXimpl = getIsVertical() ? IntOffset.m7155getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m7155getXimpl(j))).intValue();
        boolean isVertical = getIsVertical();
        int iM7156getYimpl = IntOffset.m7156getYimpl(j);
        if (isVertical) {
            iM7156getYimpl = function1.invoke(Integer.valueOf(iM7156getYimpl)).intValue();
        }
        return IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl);
    }
}
