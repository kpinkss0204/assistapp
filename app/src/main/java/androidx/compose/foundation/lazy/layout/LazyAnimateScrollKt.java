...
public final class LazyAnimateScrollKt {
    ...
    private static final float TargetDistance = Dp.m7027constructorimpl(2500);
    private static final float BoundDistance = Dp.m7027constructorimpl(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    private static final float MinimumDistance = Dp.m7027constructorimpl(50);
