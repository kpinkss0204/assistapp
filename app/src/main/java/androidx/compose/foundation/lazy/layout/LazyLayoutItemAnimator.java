...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
    ...
    /* JADX WARN: Type inference failed for: r2v27, types: [androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator$ItemInfo] */
    /* JADX WARN: Type inference failed for: r2v36 */
    /* JADX WARN: Type inference failed for: r2v38 */
    /* JADX WARN: Type inference failed for: r2v64 */
    /* JADX WARN: Type inference failed for: r34v1, types: [androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator$ItemInfo] */
    public final void onMeasured(int consumedScroll, int layoutWidth, int layoutHeight, List<T> positionedItems, final LazyLayoutKeyIndexMap keyIndexMap, LazyLayoutMeasuredItemProvider<T> itemProvider, boolean isVertical, boolean isLookingAhead, int laneCount, boolean hasLookaheadOccurred, int layoutMinOffset, int layoutMaxOffset, CoroutineScope coroutineScope, GraphicsContext graphicsContext) {
            ...
            if (getHasAnimations(t)) {
                ...
                if (itemInfo == null) {
                    ...
                    if (t.getIndex() == index || index == -1) {
                        long jMo1077getOffsetBjo55l4 = t.mo1077getOffsetBjo55l4(0);
                        initializeAnimation(t, t.getIsVertical() ? IntOffset.m7156getYimpl(jMo1077getOffsetBjo55l4) : IntOffset.m7155getXimpl(jMo1077getOffsetBjo55l4), itemInfo2);
                        if (z2) {
                    ...
                    if (z) {
                        ...
                        while (i19 < length2) {
                            ...
                            if (lazyLayoutItemAnimation2 != null) {
                                i9 = i18;
                                i10 = length2;
                                if (!IntOffset.m7154equalsimpl0(lazyLayoutItemAnimation2.getRawOffset(), LazyLayoutItemAnimation.INSTANCE.m1129getNotInitializednOccac())) {
                                    lazyLayoutItemAnimation2.m1128setRawOffsetgyyYBs(IntOffset.m7159plusqkQi6aY(lazyLayoutItemAnimation2.getRawOffset(), jIntOffset));
                                }
                            } else {
                                i9 = i18;
                                i10 = length2;
                    ...
                    while (i28 < i27) {
                        if ((j2 & 255) < 128) {
                            ...
                            if (index2 == -1) {
                                ...
                                LazyLayoutMeasuredItem lazyLayoutMeasuredItemMo1079getAndMeasurehBUhpc = itemProvider.mo1079getAndMeasurehBUhpc(index2, itemInfo4.getLane(), itemInfo4.getSpan(), constraints.getValue());
                                lazyLayoutMeasuredItemMo1079getAndMeasurehBUhpc.setNonScrollableItem(true);
                                ...
                                itemInfo4.updateAnimation(lazyLayoutMeasuredItemMo1079getAndMeasurehBUhpc, coroutineScope, graphicsContext, layoutMinOffset, layoutMaxOffset, itemInfo4.getCrossAxisOffset());
                                if (index2 < this.firstVisibleIndex) {
                                    this.movingAwayToStartBound.add((T) lazyLayoutMeasuredItemMo1079getAndMeasurehBUhpc);
                                } else {
                                    this.movingAwayToEndBound.add((T) lazyLayoutMeasuredItemMo1079getAndMeasurehBUhpc);
                                }
                            }
                        } else {
                            i4 = i28;
        ...
        if (!this.movingAwayToEndBound.isEmpty()) {
            ...
            for (int i35 = 0; i35 < size6; i35++) {
                ...
                t5.position(layoutMaxOffset2 + iUpdateAndReturnOffsetFor2, itemInfo8.getCrossAxisOffset(), i2, i3);
                if (z) {
    ...
    */
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        long jM7151copyiSbpLlY$default;
        int i = 0;
        long jMo1077getOffsetBjo55l4 = item.mo1077getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            jM7151copyiSbpLlY$default = IntOffset.m7151copyiSbpLlY$default(jMo1077getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            jM7151copyiSbpLlY$default = IntOffset.m7151copyiSbpLlY$default(jMo1077getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                lazyLayoutItemAnimation.m1128setRawOffsetgyyYBs(IntOffset.m7159plusqkQi6aY(jM7151copyiSbpLlY$default, IntOffset.m7158minusqkQi6aY(item.mo1077getOffsetBjo55l4(i2), jMo1077getOffsetBjo55l4)));
            }
            i++;
            i2 = i3;
        }
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                long jMo1077getOffsetBjo55l4 = item.mo1077getOffsetBjo55l4(i2);
                long rawOffset = lazyLayoutItemAnimation.getRawOffset();
                if (!IntOffset.m7154equalsimpl0(rawOffset, LazyLayoutItemAnimation.INSTANCE.m1129getNotInitializednOccac()) && !IntOffset.m7154equalsimpl0(rawOffset, jMo1077getOffsetBjo55l4)) {
                    lazyLayoutItemAnimation.m1121animatePlacementDeltaar5cAso(IntOffset.m7158minusqkQi6aY(jMo1077getOffsetBjo55l4, rawOffset), isMovingAway);
                }
                lazyLayoutItemAnimation.m1128setRawOffsetgyyYBs(jMo1077getOffsetBjo55l4);
            }
            i++;
            i2 = i3;
        }
    ...
    public final long m1130getMinSizeToFitDisappearingItemsYbymL2g() {
        long jM7202getZeroYbymL2g = IntSize.INSTANCE.m7202getZeroYbymL2g();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layer != null) {
                jM7202getZeroYbymL2g = IntSizeKt.IntSize(Math.max(IntSize.m7197getWidthimpl(jM7202getZeroYbymL2g), IntOffset.m7155getXimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m7197getWidthimpl(layer.getSize())), Math.max(IntSize.m7196getHeightimpl(jM7202getZeroYbymL2g), IntOffset.m7156getYimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m7196getHeightimpl(layer.getSize())));
            }
        }
        return jM7202getZeroYbymL2g;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem lazyLayoutMeasuredItem) {
        long jMo1077getOffsetBjo55l4 = lazyLayoutMeasuredItem.mo1077getOffsetBjo55l4(0);
        return lazyLayoutMeasuredItem.getIsVertical() ? IntOffset.m7156getYimpl(jMo1077getOffsetBjo55l4) : IntOffset.m7155getXimpl(jMo1077getOffsetBjo55l4);
    }
    ...
    private final class ItemInfo {
        ...
        public final void m1132setConstraints_Sx5XlM(Constraints constraints) {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m6968boximpl(positionedItem.getConstraints());
    ...
    private static final /* data */ class DisplayingDisappearingItemsNode extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                GraphicsLayer layer = lazyLayoutItemAnimation.getLayer();
                if (layer != null) {
                    float fM7155getXimpl = IntOffset.m7155getXimpl(lazyLayoutItemAnimation.getFinalOffset());
                    ContentDrawScope contentDrawScope2 = contentDrawScope;
                    float fM7155getXimpl2 = fM7155getXimpl - IntOffset.m7155getXimpl(layer.getTopLeft());
                    float fM7156getYimpl = IntOffset.m7156getYimpl(lazyLayoutItemAnimation.getFinalOffset()) - IntOffset.m7156getYimpl(layer.getTopLeft());
                    contentDrawScope2.getDrawContext().getTransform().translate(fM7155getXimpl2, fM7156getYimpl);
                    try {
