...
public final class LazyGridMeasuredItem implements LazyGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyGridMeasuredItem(int i, Object obj, boolean z, int i2, int i3, boolean z2, LayoutDirection layoutDirection, int i4, int i5, List<? extends Placeable> list, long j, Object obj2, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, long j2, int i6, int i7) {
        ...
        this.size = jIntSize;
        this.offset = IntOffset.INSTANCE.m7165getZeronOccac();
        this.row = -1;
        this.column = -1;
    }
    ...
    public final void applyScrollDelta(int delta) {
        ...
        int iM7155getXimpl = getIsVertical() ? IntOffset.m7155getXimpl(offset) : IntOffset.m7155getXimpl(offset) + delta;
        boolean isVertical = getIsVertical();
        int iM7156getYimpl = IntOffset.m7156getYimpl(offset);
        if (isVertical) {
            iM7156getYimpl += delta;
        }
        this.offset = IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl);
        int placeablesCount = getPlaceablesCount();
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), i);
            if (animation != null) {
                long rawOffset = animation.getRawOffset();
                int iM7155getXimpl2 = getIsVertical() ? IntOffset.m7155getXimpl(rawOffset) : Integer.valueOf(IntOffset.m7155getXimpl(rawOffset) + delta).intValue();
                boolean isVertical2 = getIsVertical();
                int iM7156getYimpl2 = IntOffset.m7156getYimpl(rawOffset);
                if (isVertical2) {
                    iM7156getYimpl2 += delta;
                }
                animation.m1128setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iM7155getXimpl2, iM7156getYimpl2));
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i < placeablesCount) {
            ...
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), i);
            if (animation != null) {
                long jM7159plusqkQi6aY = IntOffset.m7159plusqkQi6aY(offset, animation.m1124getPlacementDeltanOccac());
                if ((m1108getMainAxisgyyYBs(offset) <= mainAxisSize && m1108getMainAxisgyyYBs(jM7159plusqkQi6aY) <= mainAxisSize) || (m1108getMainAxisgyyYBs(offset) >= i2 && m1108getMainAxisgyyYBs(jM7159plusqkQi6aY) >= i2)) {
                    animation.cancelPlacementAnimation();
                }
                layer = animation.getLayer();
                offset = jM7159plusqkQi6aY;
            } else {
                layer = null;
            }
            if (this.reverseLayout) {
                if (getIsVertical()) {
                    iM7155getXimpl = IntOffset.m7155getXimpl(offset);
                } else {
                    iM7155getXimpl = (this.mainAxisLayoutSize - IntOffset.m7155getXimpl(offset)) - getMainAxisSize(placeable);
                }
                if (getIsVertical()) {
                    iM7156getYimpl = (this.mainAxisLayoutSize - IntOffset.m7156getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    iM7156getYimpl = IntOffset.m7156getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(iM7155getXimpl, iM7156getYimpl);
            }
            long jM7159plusqkQi6aY2 = IntOffset.m7159plusqkQi6aY(offset, this.visualOffset);
            if (animation != null) {
    ...
    private final int m1108getMainAxisgyyYBs(long j) {
    ...
    private final long m1107copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
