...
public abstract class LazyGridMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyGridMeasuredItem> {
    ...
    public abstract LazyGridMeasuredItem mo1104createItemO3s9Psw(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends Placeable> placeables, long constraints, int lane, int span);
    ...
    public LazyGridMeasuredItem mo1079getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1109getAndMeasurem8Kt_7k(index, constraints, lane, span, this.defaultMainAxisSpacing);
    }

    /* JADX INFO: renamed from: getAndMeasure-m8Kt_7k, reason: not valid java name */
    public final LazyGridMeasuredItem m1109getAndMeasurem8Kt_7k(int index, long constraints, int lane, int span, int mainAxisSpacing) {
        ...
        List<Placeable> listMo1136measure0kLqBqw = this.measureScope.mo1136measure0kLqBqw(index, constraints);
        if (Constraints.m6978getHasFixedWidthimpl(constraints)) {
            iM6981getMinHeightimpl = Constraints.m6982getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m6977getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("does not have fixed height".toString());
            }
            iM6981getMinHeightimpl = Constraints.m6981getMinHeightimpl(constraints);
        }
        return mo1104createItemO3s9Psw(index, key, contentType, iM6981getMinHeightimpl, mainAxisSpacing, listMo1136measure0kLqBqw, constraints, lane, span);
    }
