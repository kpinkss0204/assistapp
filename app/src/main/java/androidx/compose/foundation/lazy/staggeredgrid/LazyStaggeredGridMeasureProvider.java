...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1173createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1179childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6992fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m6991fixedHeightOenEA2s(i);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1180getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM1179childConstraintsJhjzzOo = m1179childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo1173createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, this.measureScope.mo1136measure0kLqBqw(index, jM1179childConstraintsJhjzzOo), jM1179childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* JADX INFO: renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo1079getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1173createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo1136measure0kLqBqw(index, constraints), constraints);
    }
