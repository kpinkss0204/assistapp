...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo1118layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        int firstPlacedIndex;
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        if (m1116isForward4vf7U8o(direction)) {
        ...
        T tInvoke = null;
        while (tInvoke == null && m1115hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t = (T) m1114addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m1115hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1116isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5889getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5888getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5887getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5890getBelowhoxUOeE())) {
            return !this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5891getLefthoxUOeE())) {
        ...
        if (!BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5892getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1114addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m1115hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m1117isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        return m1116isForward4vf7U8o(i) ? interval.getEnd() < this.state.getItemCount() - 1 : interval.getStart() > 0;
    }

    /* JADX INFO: renamed from: isOppositeToOrientation-4vf7U8o, reason: not valid java name */
    private final boolean m1117isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5887getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5890getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5891getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5892getRighthoxUOeE())) {
            return this.orientation == Orientation.Vertical;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5889getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m5883equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5888getAfterhoxUOeE())) {
            return false;
        }
        LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
        throw new KotlinNothingValueException();
