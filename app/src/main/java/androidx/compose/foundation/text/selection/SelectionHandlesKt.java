...
public final class SelectionHandlesKt {
    ...
    public static final long m1627getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m4327getXimpl(j), Offset.m4328getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m7027constructorimpl(f);
