...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl.sort.1
                ...
                public final Integer invoke(Selectable selectable, Selectable selectable2) {
                    ...
                    if (layoutCoordinates != null) {
                        jM4343getZeroF1C5BW0 = containerLayoutCoordinates.mo5912localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4343getZeroF1C5BW0());
                    } else {
                        jM4343getZeroF1C5BW0 = Offset.INSTANCE.m4343getZeroF1C5BW0();
                    }
                    if (layoutCoordinates2 != null) {
                        jM4343getZeroF1C5BW02 = containerLayoutCoordinates.mo5912localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m4343getZeroF1C5BW0());
                    } else {
                        jM4343getZeroF1C5BW02 = Offset.INSTANCE.m4343getZeroF1C5BW0();
                    }
                    if (Offset.m4328getYimpl(jM4343getZeroF1C5BW0) == Offset.m4328getYimpl(jM4343getZeroF1C5BW02)) {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m4327getXimpl(jM4343getZeroF1C5BW0)), Float.valueOf(Offset.m4327getXimpl(jM4343getZeroF1C5BW02)));
                    } else {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m4328getYimpl(jM4343getZeroF1C5BW0)), Float.valueOf(Offset.m4328getYimpl(jM4343getZeroF1C5BW02)));
                    }
    ...
    public void mo1674notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4316boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1673notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4316boximpl(newPosition), Offset.m4316boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
