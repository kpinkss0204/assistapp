...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m6510getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m6509getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int iM622getKeyboardkB6V9T0 = TransferableContent.Source.INSTANCE.m622getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, iM622getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
}
