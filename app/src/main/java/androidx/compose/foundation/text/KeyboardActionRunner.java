...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1283runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> onSend;
        Unit unit = null;
        if (ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6691getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6690getDefaulteUduSuo()) ? true : ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6694getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo1282defaultKeyboardActionKlQnJC8(imeAction);
        }
    }
    ...
    public void mo1282defaultKeyboardActionKlQnJC8(int imeAction) {
        ...
        if (ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6695getPreviouseUduSuo())) {
            getFocusManager().mo4254moveFocus3ESFkO8(FocusDirection.INSTANCE.m4250getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6691getDoneeUduSuo())) {
            if (ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6692getGoeUduSuo()) ? true : ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6696getSearcheUduSuo()) ? true : ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6697getSendeUduSuo()) ? true : ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6690getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6694getNoneeUduSuo());
        } else {
