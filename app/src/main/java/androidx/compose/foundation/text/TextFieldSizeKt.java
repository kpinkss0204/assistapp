        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt.textFieldMinSize.1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM6544getFontStyle4Lr2A7w = textStyle3.m6544getFontStyle4Lr2A7w();
                    int iM6625unboximpl = fontStyleM6544getFontStyle4Lr2A7w != null ? fontStyleM6544getFontStyle4Lr2A7w.m6625unboximpl() : FontStyle.INSTANCE.m6629getNormal_LCdwA();
                    FontSynthesis fontSynthesisM6545getFontSynthesisZQGJjVo = textStyle3.m6545getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo6597resolveDPcqOEQ(fontFamily, fontWeight, iM6625unboximpl, fontSynthesisM6545getFontSynthesisZQGJjVo != null ? fontSynthesisM6545getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m6639getAllGVVA2EU());
                ...
                if (zChangedInstance || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt$textFieldMinSize$1$1$1
                        ...
                        public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                            return m1371invoke3p2s80s(measureScope, measurable, constraints.getValue());
                        }

                        /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
                        public final MeasureResult m1371invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                            long minSize = textFieldSize.getMinSize();
                            final Placeable placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(Constraints.m6971copyZbe2FdA$default(j, RangesKt.coerceIn(IntSize.m7197getWidthimpl(minSize), Constraints.m6982getMinWidthimpl(j), Constraints.m6980getMaxWidthimpl(j)), 0, RangesKt.coerceIn(IntSize.m7196getHeightimpl(minSize), Constraints.m6981getMinHeightimpl(j), Constraints.m6979getMaxHeightimpl(j)), 0, 10, null));
                            return MeasureScope.layout$default(measureScope, placeableMo5903measureBRTryo0.getWidth(), placeableMo5903measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldSizeKt$textFieldMinSize$1$1$1.1
                                {
                                    super(1);
                                }
