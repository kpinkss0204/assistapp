...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m1605updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        ...
        if (TextOverflow.m6958equalsimpl0(this.overflow, overflow)) {
            return z;
        }
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1593updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1593updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final java.lang.Boolean invoke(java.util.List<androidx.compose.ui.text.TextLayoutResult> r38) {
                    ...
                    L31:
                        ...
                        r33 = 0
                        r34 = 0
                        androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m6532mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
                        androidx.compose.ui.text.TextLayoutInput r1 = r2.getLayoutInput()
                        ...
                        r7 = 0
                        r4 = 0
                        androidx.compose.ui.text.TextLayoutResult r1 = androidx.compose.ui.text.TextLayoutResult.m6482copyO0kMr_c$default(r2, r3, r4, r6, r7)
                        if (r1 == 0) goto Lb7
                        r2 = r38
                        r2.add(r1)
                        goto Lb8
    ...
    public final MeasureResult m1604measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo375measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo375measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean zM1592layoutWithConstraintsK40F9xA = layoutCache.m1592layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (zM1592layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(Constraints.INSTANCE.m6989fitPrioritizingWidthZbe2FdA(IntSize.m7197getWidthimpl(textLayoutResult.getSize()), IntSize.m7197getWidthimpl(textLayoutResult.getSize()), IntSize.m7196getHeightimpl(textLayoutResult.getSize()), IntSize.m7196getHeightimpl(textLayoutResult.getSize())));
        int iM7197getWidthimpl = IntSize.m7197getWidthimpl(textLayoutResult.getSize());
        int iM7196getHeightimpl = IntSize.m7196getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM7197getWidthimpl, iM7196getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        boolean z = true;
        boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m6958equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6967getVisiblegIe3tQ8());
        if (z2) {
            Rect rectM4367Recttz77jQw = RectKt.m4367Recttz77jQw(Offset.INSTANCE.m4343getZeroF1C5BW0(), SizeKt.Size(IntSize.m7197getWidthimpl(textLayoutResult.getSize()), IntSize.m7196getHeightimpl(textLayoutResult.getSize())));
            canvas.save();
            Canvas.m4541clipRectmtrdDE$default(canvas, rectM4367Recttz77jQw, 0, 2, null);
        }
        try {
            ...
            if (brush != null) {
                MultiParagraph.m6376painthn5TExg$default(multiParagraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
            } else {
                ColorProducer colorProducer = this.overrideColor;
                long jMo1820invoke0d7_KjU = colorProducer != null ? colorProducer.mo1820invoke0d7_KjU() : Color.INSTANCE.m4604getUnspecified0d7_KjU();
                if (jMo1820invoke0d7_KjU == 16) {
                    if (this.style.m6542getColor0d7_KjU() != 16) {
                        jMo1820invoke0d7_KjU = this.style.m6542getColor0d7_KjU();
                    } else {
                        jMo1820invoke0d7_KjU = Color.INSTANCE.m4594getBlack0d7_KjU();
                    }
                }
                multiParagraph.m6381paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : jMo1820invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m5126getDefaultBlendMode0nO6VwU() : 0);
            }
            if (z2) {
                canvas.restore();
            }
