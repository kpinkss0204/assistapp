...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4569equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m4569equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m4575hashCodeimpl(this.handleColor) * 31) + Color.m4575hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m4576toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m4576toStringimpl(this.backgroundColor)) + ')';
    }
}
