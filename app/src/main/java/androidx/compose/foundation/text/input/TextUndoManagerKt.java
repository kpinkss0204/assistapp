...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1389getOriginalRangejx7JFs = changeList.mo1389getOriginalRangejx7JFs(0);
            long jMo1390getRangejx7JFs = changeList.mo1390getRangejx7JFs(0);
            if (TextRange.m6506getCollapsedimpl(jMo1389getOriginalRangejx7JFs) && TextRange.m6506getCollapsedimpl(jMo1390getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m6510getMinimpl(jMo1389getOriginalRangejx7JFs), TextRangeKt.m6519substringFDrldGo(textFieldCharSequence, jMo1389getOriginalRangejx7JFs), TextRangeKt.m6519substringFDrldGo(textFieldCharSequence2, jMo1390getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
