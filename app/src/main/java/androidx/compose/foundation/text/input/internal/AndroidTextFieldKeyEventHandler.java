...
public final class AndroidTextFieldKeyEventHandler extends TextFieldKeyEventHandler {
    ...
    public boolean mo1418onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (super.mo1418onPreKeyEventMyFupTE(event, textFieldState, textFieldSelectionState, focusManager, keyboardController)) {
            return true;
        }
        InputDevice device = event.getDevice();
        if (device == null || !device.supportsSource(InputDeviceCompat.SOURCE_DPAD) || device.isVirtual() || !KeyEventType.m5625equalsimpl0(KeyEvent_androidKt.m5633getTypeZmokQxo(event), KeyEventType.INSTANCE.m5629getKeyDownCS__XNY()) || event.getSource() == 257) {
            return false;
        }
        if (TextFieldKeyEventHandler_androidKt.m1490isKeyCodeYhN2O0w(event, 19)) {
            return focusManager.mo4254moveFocus3ESFkO8(FocusDirection.INSTANCE.m4252getUpdhqQ8s());
        }
        if (TextFieldKeyEventHandler_androidKt.m1490isKeyCodeYhN2O0w(event, 20)) {
            return focusManager.mo4254moveFocus3ESFkO8(FocusDirection.INSTANCE.m4245getDowndhqQ8s());
        }
        if (TextFieldKeyEventHandler_androidKt.m1490isKeyCodeYhN2O0w(event, 21)) {
            return focusManager.mo4254moveFocus3ESFkO8(FocusDirection.INSTANCE.m4248getLeftdhqQ8s());
        }
        if (TextFieldKeyEventHandler_androidKt.m1490isKeyCodeYhN2O0w(event, 22)) {
            return focusManager.mo4254moveFocus3ESFkO8(FocusDirection.INSTANCE.m4251getRightdhqQ8s());
        }
        if (!TextFieldKeyEventHandler_androidKt.m1490isKeyCodeYhN2O0w(event, 23)) {
            return false;
        }
    ...
    public boolean mo1417onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        if (KeyEventType.m5625equalsimpl0(KeyEvent_androidKt.m5633getTypeZmokQxo(event), KeyEventType.INSTANCE.m5629getKeyDownCS__XNY()) && event.isFromSource(257) && !TextFieldKeyEventHandler_androidKt.m1489isFromSoftKeyboardZmokQxo(event)) {
            textFieldSelectionState.setInTouchMode(false);
        }
        return super.mo1417onKeyEvent6ptp14s(event, textFieldState, textLayoutState, textFieldSelectionState, editable, singleLine, onSubmit);
    }
}
