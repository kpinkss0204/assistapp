...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM6510getMinimpl = composition != null ? TextRange.m6510getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m6510getMinimpl(state.getSelection()), TextRange.m6509getMaximpl(state.getSelection()), iM6510getMinimpl, composition2 != null ? TextRange.m6509getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m6506getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m6510getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM6690getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6690getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6692getGoeUduSuo();
                    break;
                case 3:
                    iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6696getSearcheUduSuo();
                    break;
                case 4:
                    iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6697getSendeUduSuo();
                    break;
                case 5:
                    iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6693getNexteUduSuo();
                    break;
                case 6:
                    iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6691getDoneeUduSuo();
                    break;
                case 7:
                    iM6690getDefaulteUduSuo = ImeAction.INSTANCE.m6695getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo1457onImeActionKlQnJC8(iM6690getDefaulteUduSuo);
        return true;
    }
