...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m6518coerceIn8ffj60Q(j, 0, str.length()), (DefaultConstructorMarker) null);
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m6515toStringimpl(m1394getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM6505equalsimpl0 = true ^ TextRange.m6505equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1426getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1395syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, zM6505equalsimpl0);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super EditingBuffer, Unit> block) {
        getMainBuffer().getChangeTracker().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(getMainBuffer().toString(), getMainBuffer().m1426getSelectiond9O1mEE(), getMainBuffer().m1425getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m6505equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1426getSelectiond9O1mEE())) {
            if (Intrinsics.areEqual(value$foundation_release.getComposition(), this.mainBuffer.m1425getCompositionMzsxiRA()) && Intrinsics.areEqual(value$foundation_release.getHighlight(), this.mainBuffer.getHighlight())) {
                return;
            }
            updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1426getSelectiond9O1mEE(), this.mainBuffer.m1425getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
            return;
        }
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1426getSelectiond9O1mEE(), this.mainBuffer.m1425getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null);
        ...
        boolean zM6505equalsimpl0 = TextRange.m6505equalsimpl0(textFieldBuffer.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z2 = !zM6505equalsimpl0;
        if (!zContentEquals || !zM6505equalsimpl0) {
            m1395syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, z, z2);
        } else {
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1384toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer, 0L, textFieldCharSequence.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1395syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        String string = this.mainBuffer.toString();
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(string, this.mainBuffer.m1426getSelectiond9O1mEE(), this.mainBuffer.m1425getCompositionMzsxiRA(), null, 8, null);
        boolean zAreEqual = Intrinsics.areEqual(newComposition, this.mainBuffer.m1425getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m6512getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m6507getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m6506getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m6510getMinimpl(newComposition.getPackedValue()), TextRange.m6509getMaximpl(newComposition.getPackedValue()));
        }
        ...
        updateValueAndNotifyListeners(textFieldCharSequence, new TextFieldCharSequence(string, this.mainBuffer.m1426getSelectiond9O1mEE(), this.mainBuffer.m1425getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m6512getStartimpl(textFieldState.m1394getSelectiond9O1mEE())), Integer.valueOf(TextRange.m6507getEndimpl(textFieldState.m1394getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
