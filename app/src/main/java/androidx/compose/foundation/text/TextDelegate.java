...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m6965getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1337layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        int iM6982getMinWidthimpl = Constraints.m6982getMinWidthimpl(constraints);
        int iM6980getMaxWidthimpl = ((this.softWrap || TextOverflow.m6958equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6966getEllipsisgIe3tQ8())) && Constraints.m6976getHasBoundedWidthimpl(constraints)) ? Constraints.m6980getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m6958equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6966getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM6982getMinWidthimpl != iM6980getMaxWidthimpl) {
            iM6980getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM6982getMinWidthimpl, iM6980getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m6989fitPrioritizingWidthZbe2FdA(0, iM6980getMaxWidthimpl, 0, Constraints.m6979getMaxHeightimpl(constraints)), i, TextOverflow.m6958equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6966getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m1339layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m1372canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m6483copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m6994constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph multiParagraphM1337layoutTextK40F9xA = m1337layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM1337layoutTextK40F9xA, ConstraintsKt.m6994constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraphM1337layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraphM1337layoutTextK40F9xA.getHeight()))), null);
    }
