...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    private final DragAndDropModifierNode dragAndDropNode = (DragAndDropModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode$default(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
        ...
        public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
            ...
            if (receiveContentConfiguration != null) {
                TransferableContent transferableContentOnReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m621getDragAndDropkB6V9T0(), null, 8, null));
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m1486invokek4lQ0M(offset.getPackedValue());
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1486invokek4lQ0M(long j) {
            long jM1507fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1507fromWindowToDecorationUv8p0NA(this.this$0.getTextLayoutState(), j);
            this.this$0.getTextFieldState().m1517selectCharsIn5zctL8(TextRangeKt.TextRange(TextLayoutState.m1497getOffsetForPosition3MmeM6k$default(this.this$0.getTextLayoutState(), jM1507fromWindowToDecorationUv8p0NA, false, 2, null)));
            this.this$0.getTextFieldSelectionState().m1554updateHandleDraggingUv8p0NA(Handle.Cursor, jM1507fromWindowToDecorationUv8p0NA);
        }
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m6730equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6749getPasswordPjHm6EE()) && !KeyboardType.m6730equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6748getNumberPasswordPjHm6EE()) && (stylusHandwritingTrigger = this.this$0.getStylusHandwritingTrigger()) != null) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m6342setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.4
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                if (i == TextRange.m6512getStartimpl(selection2) && i2 == TextRange.m6507getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (z) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1518selectUntransformedCharsIn5zctL8(jTextRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1517selectCharsIn5zctL8(jTextRange);
                }
                return true;
            }
        }, 1, null);
        final int iM1296getImeActionOrDefaulteUduSuo$foundation_release = this.keyboardOptions.m1296getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m6337onImeAction9UiTYpY$default(semanticsPropertyReceiver, iM1296getImeActionOrDefaulteUduSuo$foundation_release, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1485onImeActionPerformedKlQnJC8(iM1296getImeActionOrDefaulteUduSuo$foundation_release);
                return true;
            }
        }, 2, null);
        ...
        if (!TextRange.m6506getCollapsedimpl(selection)) {
    ...
    public final void onFocusChange() {
        ...
        if (isFocused() && this.observeChangesJob == null) {
            this.observeChangesJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03811(null), 3, null);
        } else {
            if (isFocused()) {
                return;
            }
    ...
    static final class C03811 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03811(continuation);
        }
    ...
    public void mo493onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.stylusHandwritingNode.mo493onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputNode.mo493onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo494onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1418onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* JADX INFO: renamed from: onKeyEvent-ZmokQxo */
    public boolean mo492onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1417onKeyEvent6ptp14s(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = this.this$0;
                textFieldDecoratorModifierNode.m1485onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.getKeyboardOptions().m1296getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation_release()) {
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C03831(ReceiveContentConfigurationKt.getReceiveContentConfiguration(this), null), 3, null);
        }
    }
    ...
    static final class C03831 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03831(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C03831> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C03831(this.$receiveContentConfiguration, continuation);
        }
        ...
        static final class C00551 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            ...
            /* synthetic */ class C00561 extends FunctionReferenceImpl implements Function1<ImeAction, Unit> {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                    m1487invokeKlQnJC8(imeAction.getValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
                public final void m1487invokeKlQnJC8(int i) {
                    ((TextFieldDecoratorModifierNode) this.receiver).m1485onImeActionPerformedKlQnJC8(i);
                }
            }
        }
    }
    ...
    public final void m1485onImeActionPerformedKlQnJC8(final int imeAction) {
        KeyboardActionHandler keyboardActionHandler;
        if (ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6694getNoneeUduSuo()) || ImeAction.m6677equalsimpl0(imeAction, ImeAction.INSTANCE.m6690getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            this.keyboardActionScope.mo1282defaultKeyboardActionKlQnJC8(imeAction);
            ...
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.keyboardActionScope.mo1282defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
