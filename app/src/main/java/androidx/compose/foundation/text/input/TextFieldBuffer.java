...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1389getOriginalRangejx7JFs(int changeIndex);

        /* JADX INFO: renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1390getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1385getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m6506getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1387setSelection5zctL8(long j) {
        m1383requireValidRange5zctL8(j);
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        int iM6510getMinimpl = TextRange.m6510getMinimpl(getSelectionInChars());
        int iM6509getMaximpl = TextRange.m6509getMaximpl(getSelectionInChars());
        if (iM6509getMaximpl < iMin) {
            return;
        }
        if (iM6510getMinimpl <= iMin && iMax <= iM6509getMaximpl) {
            i = newLength - (iMax - iMin);
            if (iM6510getMinimpl == iM6509getMaximpl) {
                iM6510getMinimpl += i;
            }
            iMin = iM6509getMaximpl + i;
        } else if (iM6510getMinimpl > iMin && iM6509getMaximpl < iMax) {
            iMin += newLength;
            iM6510getMinimpl = iMin;
        } else if (iM6510getMinimpl >= iMax) {
            i = newLength - (iMax - iMin);
            iM6510getMinimpl += i;
            iMin = iM6509getMaximpl + i;
        } else if (iMin < iM6510getMinimpl) {
            iM6510getMinimpl = iMin + newLength;
            i = newLength - (iMax - iMin);
            iMin = iM6509getMaximpl + i;
        }
        this.selectionInChars = TextRangeKt.TextRange(iM6510getMinimpl, iMin);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1387setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1384toTextFieldCharSequenceudt6zUU$foundation_release$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldBuffer.m1388toTextFieldCharSequenceudt6zUU$foundation_release(j, textRange);
    }

    /* JADX INFO: renamed from: toTextFieldCharSequence-udt6zUU$foundation_release, reason: not valid java name */
    public final TextFieldCharSequence m1388toTextFieldCharSequenceudt6zUU$foundation_release(long selection, TextRange composition) {
    ...
    private final void m1383requireValidRange5zctL8(long range) {
        long jTextRange = TextRangeKt.TextRange(0, getLength());
        if (!TextRange.m6502contains5zctL8(jTextRange, range)) {
            throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m6515toStringimpl(range)) + " to be in " + ((Object) TextRange.m6515toStringimpl(jTextRange))).toString());
        }
    }
}
