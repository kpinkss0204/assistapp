...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4316boximpl(Offset.INSTANCE.m4343getZeroF1C5BW0()), null, 2, null);

    /* JADX INFO: renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4316boximpl(Offset.INSTANCE.m4343getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1659invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1659invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                long jMo5911getSizeYbymL2g = layoutCoordinates.mo5911getSizeYbymL2g();
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m7197getWidthimpl(jMo5911getSizeYbymL2g), IntSize.m7196getHeightimpl(jMo5911getSizeYbymL2g));
                if (!SelectionManagerKt.m1664containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1504coerceIn3MmeM6k(j, rect);
                }
                long jM1643convertToContainerCoordinatesR5De75A = SelectionManager.this.m1643convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m4346isSpecifiedk4lQ0M(jM1643convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1650startSelection9KIMszo(jM1643convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1660invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* JADX INFO: renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1660invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long jM1643convertToContainerCoordinatesR5De75A = SelectionManager.this.m1643convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long jM1643convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1643convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1658updateSelectionqNKwrvQ$foundation_release(Offset.m4316boximpl(jM1643convertToContainerCoordinatesR5De75A), jM1643convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
        selectionRegistrarImpl.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1645setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrarImpl.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                if (selection != null && (start = selection.getStart()) != null && j == start.getSelectableId()) {
                    SelectionManager.this.m1649setStartHandlePosition_kEHs6E(null);
                }
                ...
                if (selection2 != null && (end = selection2.getEnd()) != null && j == end.getSelectableId()) {
                    SelectionManager.this.m1648setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().contains(j)) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1661invokeZmokQxo(keyEvent.m5621unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1661invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m1666isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM4316boximpl = layoutCoordinates != null ? Offset.m4316boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM4316boximpl)) {
            return;
        }
        this.previousPosition = offsetM4316boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1646setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m4316boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1653getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1647setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m4316boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1654getDragTotalDistanceF1C5BW0$foundation_release() {
    ...
    public final Offset m1652getCurrentDragPosition_m7T9E() {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L42:
            ...
            if (r5 == 0) goto L6f
            r8 = 1
            long r8 = r3.mo1612getHandlePositiondBAh8RU(r0, r8)
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m4348isUnspecifiedk4lQ0M(r8)
            if (r3 == 0) goto L54
            goto L6f
        L54:
            long r8 = r1.mo5912localPositionOfR5De75A(r5, r8)
            androidx.compose.ui.geometry.Offset r3 = androidx.compose.ui.geometry.Offset.m4316boximpl(r8)
            ...
            if (r5 == r10) goto L70
            boolean r5 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1664containsInclusiveUv8p0NA(r7, r8)
            if (r5 == 0) goto L6f
            goto L70
        L6f:
            r3 = r2
        L70:
            r11.m1649setStartHandlePosition_kEHs6E(r3)
            if (r6 == 0) goto L9c
            r3 = 0
            long r3 = r4.mo1612getHandlePositiondBAh8RU(r0, r3)
            boolean r0 = androidx.compose.ui.geometry.OffsetKt.m4348isUnspecifiedk4lQ0M(r3)
            if (r0 == 0) goto L81
            goto L9c
        L81:
            long r0 = r1.mo5912localPositionOfR5De75A(r6, r3)
            androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m4316boximpl(r0)
            long r3 = r0.getPackedValue()
            androidx.compose.foundation.text.Handle r1 = r11.getDraggingHandle()
            androidx.compose.foundation.text.Handle r5 = androidx.compose.foundation.text.Handle.SelectionEnd
            if (r1 == r5) goto L9b
            boolean r1 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1664containsInclusiveUv8p0NA(r7, r3)
            if (r1 == 0) goto L9c
        L9b:
            r2 = r0
        L9c:
            r11.m1648setEndHandlePosition_kEHs6E(r2)
            return
        La0:
            r11.m1649setStartHandlePosition_kEHs6E(r2)
            r11.m1648setEndHandlePosition_kEHs6E(r2)
            return
        */
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode()) {
                ...
                TextToolbar.showMenu$default(textToolbar, contentRect, isNonEmptySelection$foundation_release() ? new C04151(this) : null, null, null, isEntireContainerSelected$foundation_release() ? null : new C04162(this), 12, null);
                return;
            }
    ...
    /* synthetic */ class C04151 extends FunctionReferenceImpl implements Function0<Unit> {
        C04151(Object obj) {
    ...
    /* JADX INFO: compiled from: SelectionManager.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* synthetic */ class C04162 extends FunctionReferenceImpl implements Function0<Unit> {
        C04162(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        Rect rectM4364translatek4lQ0M = rectIntersect.m4364translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates));
        return Rect.copy$default(rectM4364translatek4lQ0M, 0.0f, 0.0f, 0.0f, rectM4364translatek4lQ0M.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1342onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM1656getStartHandlePosition_m7T9E = isStartHandle ? this.m1656getStartHandlePosition_m7T9E() : this.m1655getEndHandlePosition_m7T9E();
                if (offsetM1656getStartHandlePosition_m7T9E != null) {
                    offsetM1656getStartHandlePosition_m7T9E.getPackedValue();
                    ...
                    long jMo1612getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1612getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m4348isUnspecifiedk4lQ0M(jMo1612getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long jM1627getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1627getAdjustedCoordinatesk4lQ0M(jMo1612getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1645setCurrentDragPosition_kEHs6E(Offset.m4316boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo5912localPositionOfR5De75A(layoutCoordinates, jM1627getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo1344onStartk4lQ0M(long startPoint) {
                ...
                long jMo1612getHandlePositiondBAh8RU = selectable2.mo1612getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m4348isUnspecifiedk4lQ0M(jMo1612getHandlePositiondBAh8RU)) {
                    return;
                }
                long jM1627getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1627getAdjustedCoordinatesk4lQ0M(jMo1612getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1646setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo5912localPositionOfR5De75A(layoutCoordinates, jM1627getAdjustedCoordinatesk4lQ0M));
                this.m1647setDragTotalDistancek4lQ0M(Offset.INSTANCE.m4343getZeroF1C5BW0());
            }
            ...
            public void mo1343onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1647setDragTotalDistancek4lQ0M(Offset.m4332plusMKHz9U(selectionManager.m1654getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM4332plusMKHz9U = Offset.m4332plusMKHz9U(this.m1653getDragBeginPositionF1C5BW0$foundation_release(), this.m1654getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1658updateSelectionqNKwrvQ$foundation_release(Offset.m4316boximpl(jM4332plusMKHz9U), this.m1653getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1646setDragBeginPositionk4lQ0M(jM4332plusMKHz9U);
                    this.m1647setDragTotalDistancek4lQ0M(Offset.INSTANCE.m4343getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1645setCurrentDragPosition_kEHs6E(null);
            }
    ...
    static final class C04122 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04122 c04122 = new C04122(this.$onTap, continuation);
            c04122.L$0 = obj;
            return c04122;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C04122) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m4316boximpl(pointerInputChange.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    static final class C04141 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04141(Function0<Unit> function0, Continuation<? super C04141> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04141 c04141 = SelectionManager.this.new C04141(this.$block, continuation);
            c04141.L$0 = obj;
            return c04141;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C04141) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                if (selectionManager.detectNonConsumingTap(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1662invokek4lQ0M(offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1662invokek4lQ0M(long j) {
                        function0.invoke();
                    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C04141(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: convertToContainerCoordinates-R5De75A, reason: not valid java name */
    public final long m1643convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo5912localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1650startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1657updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m4342getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1658updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1657updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* JADX INFO: renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1657updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1645setCurrentDragPosition_kEHs6E(Offset.m4316boximpl(position));
        SelectionLayout selectionLayoutM1644getSelectionLayoutWko1d7g = m1644getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!selectionLayoutM1644getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1644getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM1644getSelectionLayoutWko1d7g, selectionAdjust);
        }
        this.previousSelectionLayout = selectionLayoutM1644getSelectionLayoutWko1d7g;
        return true;
    }

    /* JADX INFO: renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m1644getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
        ...
        SelectionLayoutBuilder selectionLayoutBuilder = new SelectionLayoutBuilder(position, previousHandlePosition, layoutCoordinatesRequireContainerCoordinates$foundation_release, isStartHandle, OffsetKt.m4348isUnspecifiedk4lQ0M(previousHandlePosition) ? null : getSelection(), new Comparator() { // from class: androidx.compose.foundation.text.selection.SelectionManager$getSelectionLayout-Wko1d7g$$inlined$compareBy$1
            /* JADX WARN: Multi-variable type inference failed */
    ...
    public final void m1651contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m6506getCollapsedimpl(selection.m1618toTextRanged9O1mEE()) : true) {
            m1650startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
