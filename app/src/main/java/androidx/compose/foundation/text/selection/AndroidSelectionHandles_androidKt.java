...
public final class AndroidSelectionHandles_androidKt {
    ...
    */
    public static final void m1607SelectionHandlepzduO1o(final androidx.compose.foundation.text.selection.OffsetProvider r18, final boolean r19, androidx.compose.ui.text.style.ResolvedTextDirection r20, boolean r21, long r22, final androidx.compose.ui.Modifier r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instruction units count: 437
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.m1607SelectionHandlepzduO1o(androidx.compose.foundation.text.selection.OffsetProvider, boolean, androidx.compose.ui.text.style.ResolvedTextDirection, boolean, long, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m1012sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, z), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, Size.m4396getWidthimpl(cacheDrawScope.m4217getSizeNHjbRc()) / 2.0f);
                            final ColorFilter colorFilterM4609tintxETnrds$default = ColorFilter.Companion.m4609tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    if (function03.invoke().booleanValue()) {
                                        if (z3) {
                                            ...
                                            ColorFilter colorFilter = colorFilterM4609tintxETnrds$default;
                                            long jMo5123getCenterF1C5BW0 = contentDrawScope2.mo5123getCenterF1C5BW0();
                                            ...
                                            try {
                                                ...
                                                DrawScope.m5108drawImagegbVJVH8$default(contentDrawScope2, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                                return;
                                            } finally {
                                        ...
                                        DrawScope.m5108drawImagegbVJVH8$default(contentDrawScope, imageBitmapCreateHandleImage, 0L, 0.0f, null, colorFilterM4609tintxETnrds$default, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m4794ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m4788getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m5044setSizeuvyYCjk(jSize);
        canvas2.save();
        CanvasDrawScope canvasDrawScope3 = canvasDrawScope2;
        DrawScope.m5118drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m4594getBlack0d7_KjU(), 0L, canvasDrawScope3.mo5124getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m4483getClear0nO6VwU(), 58, null);
        DrawScope.m5118drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m4343getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, 120, null);
        DrawScope.m5105drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, 120, null);
        canvas2.restore();
