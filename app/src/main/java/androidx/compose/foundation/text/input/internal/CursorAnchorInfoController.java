...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4799constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4808resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo5919transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m4438setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1423buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m4364translatek4lQ0M(textLayoutNodeCoordinates.mo5912localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m4343getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m4364translatek4lQ0M(textLayoutNodeCoordinates.mo5912localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m4343getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
