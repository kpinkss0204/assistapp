...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6517getZerod9O1mEE();
    ...
    public final void m1368setPreviousSelection5zctL8(long j) {
    ...
    public final int m1366getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6512getStartimpl(selection) != TextRange.m6512getStartimpl(this.previousSelection) ? TextRange.m6512getStartimpl(selection) : TextRange.m6507getEndimpl(selection) != TextRange.m6507getEndimpl(this.previousSelection) ? TextRange.m6507getEndimpl(selection) : TextRange.m6510getMinimpl(selection);
    }
