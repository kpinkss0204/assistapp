...
public final class TransformedTextFieldState {
    ...
    private static final long m1508mapFromTransformedxdX6G0(long j, OffsetMappingCalculator offsetMappingCalculator) {
        return Companion.m1521mapFromTransformedxdX6G0(j, offsetMappingCalculator);
    }

    @JvmStatic
    /* JADX INFO: renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
    private static final long m1509mapToTransformedXGyztTk(long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity) {
        return Companion.m1522mapToTransformedXGyztTk(j, offsetMappingCalculator, selectionWedgeAffinity);
    }
    ...
    public final void placeCursorBeforeCharAt(int transformedOffset) {
        m1517selectCharsIn5zctL8(TextRangeKt.TextRange(transformedOffset));
    }

    /* JADX INFO: renamed from: selectCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1517selectCharsIn5zctL8(long transformedRange) {
        m1518selectUntransformedCharsIn5zctL8(m1513mapFromTransformedGEjPoXI(transformedRange));
    }

    /* JADX INFO: renamed from: selectUntransformedCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1518selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        textFieldState.getMainBuffer().setSelection(TextRange.m6512getStartimpl(untransformedRange), TextRange.m6507getEndimpl(untransformedRange));
    ...
    public final void m1511highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long jM1513mapFromTransformedGEjPoXI = m1513mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        TextFieldEditUndoBehavior textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        textFieldState.getMainBuffer().m1427setHighlightK7f2yys(type, TextRange.m6512getStartimpl(jM1513mapFromTransformedGEjPoXI), TextRange.m6507getEndimpl(jM1513mapFromTransformedGEjPoXI));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void deleteSelectedText() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.delete(TextRange.m6510getMinimpl(mainBuffer.m1426getSelectiond9O1mEE()), TextRange.m6509getMaximpl(mainBuffer.m1426getSelectiond9O1mEE()));
        mainBuffer.setSelection(TextRange.m6510getMinimpl(mainBuffer.m1426getSelectiond9O1mEE()), TextRange.m6510getMinimpl(mainBuffer.m1426getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }

    /* JADX INFO: renamed from: replaceText-M8tDOmk$default, reason: not valid java name */
    public static /* synthetic */ void m1510replaceTextM8tDOmk$default(TransformedTextFieldState transformedTextFieldState, CharSequence charSequence, long j, TextFieldEditUndoBehavior textFieldEditUndoBehavior, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        transformedTextFieldState.m1516replaceTextM8tDOmk(charSequence, j, textFieldEditUndoBehavior2, z);
    }

    /* JADX INFO: renamed from: replaceText-M8tDOmk, reason: not valid java name */
    public final void m1516replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        long jM1513mapFromTransformedGEjPoXI = m1513mapFromTransformedGEjPoXI(range);
        mainBuffer.replace(TextRange.m6510getMinimpl(jM1513mapFromTransformedGEjPoXI), TextRange.m6509getMaximpl(jM1513mapFromTransformedGEjPoXI), newText);
        int iM6510getMinimpl = TextRange.m6510getMinimpl(jM1513mapFromTransformedGEjPoXI) + newText.length();
        mainBuffer.setSelection(iM6510getMinimpl, iM6510getMinimpl);
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior) {
        ...
        long jM1426getSelectiond9O1mEE = mainBuffer.m1426getSelectiond9O1mEE();
        mainBuffer.replace(TextRange.m6510getMinimpl(jM1426getSelectiond9O1mEE), TextRange.m6509getMaximpl(jM1426getSelectiond9O1mEE), newText);
        int iM6510getMinimpl = TextRange.m6510getMinimpl(jM1426getSelectiond9O1mEE) + newText.length();
        mainBuffer.setSelection(iM6510getMinimpl, iM6510getMinimpl);
    ...
    public final void collapseSelectionToMax() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m6509getMaximpl(mainBuffer.m1426getSelectiond9O1mEE()), TextRange.m6509getMaximpl(mainBuffer.m1426getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m6507getEndimpl(mainBuffer.m1426getSelectiond9O1mEE()), TextRange.m6507getEndimpl(mainBuffer.m1426getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final long m1514mapToTransformedjx7JFs(int offset) {
        long jTextRange;
        TransformedText value;
        ...
        if (offsetMapping2 != null) {
            jTextRange = offsetMapping2.m1464mapFromSourcejx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping != null ? Companion.m1522mapToTransformedXGyztTk(jTextRange, offsetMapping, getSelectionWedgeAffinity()) : jTextRange;
    }

    /* JADX INFO: renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public final long m1515mapToTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMapping = null;
        ...
        if (offsetMapping2 != null) {
            range = Companion.m1523mapToTransformedXGyztTk$default(Companion, range, offsetMapping2, null, 4, null);
        }
        return offsetMapping != null ? Companion.m1522mapToTransformedXGyztTk(range, offsetMapping, getSelectionWedgeAffinity()) : range;
    }

    /* JADX INFO: renamed from: mapFromTransformed--jx7JFs, reason: not valid java name */
    public final long m1512mapFromTransformedjx7JFs(int offset) {
        long jTextRange;
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        ...
        if (offsetMapping != null) {
            jTextRange = offsetMapping.m1463mapFromDestjx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping2 != null ? Companion.m1521mapFromTransformedxdX6G0(jTextRange, offsetMapping2) : jTextRange;
    }

    /* JADX INFO: renamed from: mapFromTransformed-GEjPoXI, reason: not valid java name */
    public final long m1513mapFromTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMapping = null;
        ...
        if (offsetMapping != null) {
            range = Companion.m1521mapFromTransformedxdX6G0(range, offsetMapping);
        }
        return offsetMapping2 != null ? Companion.m1521mapFromTransformedxdX6G0(range, offsetMapping2) : range;
    }
    ...
    */
    ...
    static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            TextRange textRangeM6500boximpl = null;
            if (textFieldBuffer.getChanges().getChangeCount() == 0) {
                return null;
            }
            long jM1522mapToTransformedXGyztTk = m1522mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange composition = untransformedValue.getComposition();
            if (composition != null) {
                textRangeM6500boximpl = TextRange.m6500boximpl(TransformedTextFieldState.Companion.m1522mapToTransformedXGyztTk(composition.getPackedValue(), offsetMappingCalculator, wedgeAffinity));
            }
            return new TransformedText(textFieldBuffer.m1388toTextFieldCharSequenceudt6zUU$foundation_release(jM1522mapToTransformedXGyztTk, textRangeM6500boximpl), offsetMappingCalculator);
        }
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            return new TransformedText(new TextFieldCharSequence(visualText, jM1522mapToTransformedXGyztTk, textRangeM6500boximpl, null, 8, null), offsetMappingCalculator);
        }

        /* JADX INFO: renamed from: mapToTransformed-XGyztTk$default, reason: not valid java name */
        static /* synthetic */ long m1523mapToTransformedXGyztTk$default(Companion companion, long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity, int i, Object obj) {
            if ((i & 4) != 0) {
        ...
        @JvmStatic
        /* JADX INFO: renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
        public final long m1522mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity wedgeAffinity) {
            long jTextRange;
            long jM1464mapFromSourcejx7JFs = mapping.m1464mapFromSourcejx7JFs(TextRange.m6512getStartimpl(range));
            long jM1464mapFromSourcejx7JFs2 = TextRange.m6506getCollapsedimpl(range) ? jM1464mapFromSourcejx7JFs : mapping.m1464mapFromSourcejx7JFs(TextRange.m6507getEndimpl(range));
            int iMin = Math.min(TextRange.m6510getMinimpl(jM1464mapFromSourcejx7JFs), TextRange.m6510getMinimpl(jM1464mapFromSourcejx7JFs2));
            int iMax = Math.max(TextRange.m6509getMaximpl(jM1464mapFromSourcejx7JFs), TextRange.m6509getMaximpl(jM1464mapFromSourcejx7JFs2));
            if (TextRange.m6511getReversedimpl(range)) {
                jTextRange = TextRangeKt.TextRange(iMax, iMin);
            } else {
                jTextRange = TextRangeKt.TextRange(iMin, iMax);
            }
            if (TextRange.m6506getCollapsedimpl(range) && !TextRange.m6506getCollapsedimpl(jTextRange)) {
                ...
                if (i != -1) {
                    if (i == 1) {
                        return TextRangeKt.TextRange(TextRange.m6512getStartimpl(jTextRange));
                    }
                    if (i == 2) {
                        return TextRangeKt.TextRange(TextRange.m6507getEndimpl(jTextRange));
                    }
        ...
        @JvmStatic
        /* JADX INFO: renamed from: mapFromTransformed-xdX6-G0, reason: not valid java name */
        public final long m1521mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long jM1463mapFromDestjx7JFs = mapping.m1463mapFromDestjx7JFs(TextRange.m6512getStartimpl(range));
            long jM1463mapFromDestjx7JFs2 = TextRange.m6506getCollapsedimpl(range) ? jM1463mapFromDestjx7JFs : mapping.m1463mapFromDestjx7JFs(TextRange.m6507getEndimpl(range));
            int iMin = Math.min(TextRange.m6510getMinimpl(jM1463mapFromDestjx7JFs), TextRange.m6510getMinimpl(jM1463mapFromDestjx7JFs2));
            int iMax = Math.max(TextRange.m6509getMaximpl(jM1463mapFromDestjx7JFs), TextRange.m6509getMaximpl(jM1463mapFromDestjx7JFs2));
            if (TextRange.m6511getReversedimpl(range)) {
