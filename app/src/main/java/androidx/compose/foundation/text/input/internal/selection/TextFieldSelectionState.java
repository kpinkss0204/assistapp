...
public final class TextFieldSelectionState {
    ...
    private final MutableState startTextLayoutPositionInWindow = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4316boximpl(Offset.INSTANCE.m4342getUnspecifiedF1C5BW0()), null, 2, null);

    /* JADX INFO: renamed from: rawHandleDragPosition$delegate, reason: from kotlin metadata */
    private final MutableState rawHandleDragPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4316boximpl(Offset.INSTANCE.m4342getUnspecifiedF1C5BW0()), null, 2, null);
    ...
    private final long m1546getStartTextLayoutPositionInWindowF1C5BW0() {
    ...
    private final void m1550setStartTextLayoutPositionInWindowk4lQ0M(long j) {
        this.startTextLayoutPositionInWindow.setValue(Offset.m4316boximpl(j));
    }

    /* JADX INFO: renamed from: getCurrentTextLayoutPositionInWindow-F1C5BW0, reason: not valid java name */
    private final long m1543getCurrentTextLayoutPositionInWindowF1C5BW0() {
        LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
        return textLayoutCoordinates != null ? LayoutCoordinatesKt.positionInWindow(textLayoutCoordinates) : Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getRawHandleDragPosition-F1C5BW0, reason: not valid java name */
    private final long m1545getRawHandleDragPositionF1C5BW0() {
    ...
    private final void m1549setRawHandleDragPositionk4lQ0M(long j) {
        this.rawHandleDragPosition.setValue(Offset.m4316boximpl(j));
    }

    /* JADX INFO: renamed from: getHandleDragPosition-F1C5BW0, reason: not valid java name */
    public final long m1553getHandleDragPositionF1C5BW0() {
        if (OffsetKt.m4348isUnspecifiedk4lQ0M(m1545getRawHandleDragPositionF1C5BW0())) {
            return Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
        }
        if (OffsetKt.m4348isUnspecifiedk4lQ0M(m1546getStartTextLayoutPositionInWindowF1C5BW0())) {
            return TextLayoutStateKt.m1505fromDecorationToTextLayoutUv8p0NA(this.textLayoutState, m1545getRawHandleDragPositionF1C5BW0());
        }
        return Offset.m4332plusMKHz9U(m1545getRawHandleDragPositionF1C5BW0(), Offset.m4331minusMKHz9U(m1546getStartTextLayoutPositionInWindowF1C5BW0(), m1543getCurrentTextLayoutPositionInWindowF1C5BW0()));
    }
    ...
    public final TextFieldHandleState getCursorHandleState$foundation_release(boolean includePosition) {
        ...
        if (!showCursorHandle || !z || !TextRange.m6506getCollapsedimpl(visualText.getSelection()) || !visualText.shouldShowSelection() || visualText.length() <= 0 || (draggingHandle != Handle.Cursor && !isCursorHandleInVisibleBounds())) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        return new TextFieldHandleState(true, includePosition ? getCursorRect().m4354getBottomCenterF1C5BW0() : Offset.INSTANCE.m4342getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    }
    ...
    private final boolean isCursorHandleInVisibleBounds() {
        ...
        try {
            long jM4354getBottomCenterF1C5BW0 = getCursorRect().m4354getBottomCenterF1C5BW0();
            ...
            return SelectionManagerKt.m1664containsInclusiveUv8p0NA(rectVisibleBounds, jM4354getBottomCenterF1C5BW0);
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public final Rect getCursorRect() {
        ...
        TextFieldCharSequence visualText = this.textFieldState.getVisualText();
        if (!TextRange.m6506getCollapsedimpl(visualText.getSelection())) {
            return Rect.INSTANCE.getZero();
        }
        Rect cursorRect = layoutResult.getCursorRect(TextRange.m6512getStartimpl(visualText.getSelection()));
        float fMo657toPx0680j_4 = this.density.mo657toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (layoutResult.getLayoutInput().getLayoutDirection() == LayoutDirection.Ltr) {
            right = cursorRect.getLeft() + (fMo657toPx0680j_4 / 2);
        } else {
            right = cursorRect.getRight() - (fMo657toPx0680j_4 / 2);
        }
        float f = fMo657toPx0680j_4 / 2;
        float fCoerceAtLeast = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(right, IntSize.m7197getWidthimpl(layoutResult.getSize()) - f), f);
                ...
                if (i == 0) {
                    ...
                    if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.cursorHandleGestures.2.3.1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m1560invokek4lQ0M(offset.getPackedValue());
                            return Unit.INSTANCE;
                        }

                        /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                        public final void m1560invokek4lQ0M(long j) {
    ...
    static final class C04012 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04012(PointerInputScope pointerInputScope, boolean z, Continuation<? super C04012> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04012 c04012 = TextFieldSelectionState.this.new C04012(this.$this_selectionHandleGestures, this.$isStartHandle, continuation);
            c04012.L$0 = obj;
            return c04012;
        }
        ...
        static final class C00612 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00612(PointerInputScope pointerInputScope, TextFieldSelectionState textFieldSelectionState, boolean z, Continuation<? super C00612> continuation) {
                super(2, continuation);
                this.$this_selectionHandleGestures = pointerInputScope;
                this.this$0 = textFieldSelectionState;
                this.$isStartHandle = z;
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                        ...
                        public final void mo1524onEventk4lQ0M(long j) {
                            Handle handle;
                            ...
                            textFieldSelectionState2.m1554updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1627getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.m1544getHandlePositiontuRUvjQ(z)));
                        }
                    };
    ...
    public final Object selectionHandleGestures(PointerInputScope pointerInputScope, boolean z, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04012(pointerInputScope, z, null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    */
    public final java.lang.Object observeChanges(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03941
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$observeChanges$1 r0 = (androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03941) r0
            int r1 = r0.label
    ...
    static final class C03952 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03952 c03952 = TextFieldSelectionState.this.new C03952(continuation);
            c03952.L$0 = obj;
            return c03952;
        }
    ...
    static final class C03922 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03922 c03922 = TextFieldSelectionState.this.new C03922(continuation);
            c03922.L$0 = obj;
            return c03922;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C03922) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L33:
                ...
                goto L23
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C03922.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    public final Object detectTouchMode(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object objAwaitPointerEventScope = pointerInputScope.awaitPointerEventScope(new C03922(null), continuation);
    ...
    public final Object detectTextFieldTapGestures(PointerInputScope pointerInputScope, MutableInteractionSource mutableInteractionSource, final Function0<Unit> function0, final Function0<Unit> function02, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, new C03902(mutableInteractionSource, this, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectTextFieldTapGestures.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1566invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1566invokek4lQ0M(long j) {
                ...
                if (this.enabled && this.getIsFocused()) {
                    ...
                    long jM1498coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release = this.textLayoutState.m1498coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(j);
                    TextFieldSelectionState textFieldSelectionState = this;
                    textFieldSelectionState.m1548placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1505fromDecorationToTextLayoutUv8p0NA(textFieldSelectionState.textLayoutState, jM1498coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release));
                }
            }
        }, continuation);
    ...
    static final class C03902 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03902(MutableInteractionSource mutableInteractionSource, TextFieldSelectionState textFieldSelectionState, Continuation<? super C03902> continuation) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1565invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }

        /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m1565invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            C03902 c03902 = new C03902(this.$interactionSource, this.this$0, continuation);
            c03902.L$0 = pressGestureScope;
            c03902.J$0 = j;
            return c03902.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final boolean m1548placeCursorAtNearestOffsetk4lQ0M(long offset) {
        int iM6484getOffsetForPositionk4lQ0M;
        IndexTransformationType indexTransformationType;
        int iM6512getStartimpl;
        SelectionWedgeAffinity selectionWedgeAffinity;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null || (iM6484getOffsetForPositionk4lQ0M = layoutResult.m6484getOffsetForPositionk4lQ0M(offset)) == -1) {
            return false;
        }
        TransformedTextFieldState transformedTextFieldState = this.textFieldState;
        long jM1512mapFromTransformedjx7JFs = transformedTextFieldState.m1512mapFromTransformedjx7JFs(iM6484getOffsetForPositionk4lQ0M);
        ...
        if (i == 1 || i == 2) {
            iM6512getStartimpl = TextRange.m6512getStartimpl(jM1512mapFromTransformedjx7JFs);
        } else if (i == 3) {
            if (MathUtilsKt.m1460findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m6512getStartimpl(jM1515mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m6507getEndimpl(jM1515mapToTransformedGEjPoXI))) < 0) {
            ...
            if (MathUtilsKt.m1460findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m6512getStartimpl(jM1515mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m6507getEndimpl(jM1515mapToTransformedGEjPoXI))) < 0) {
                ...
                iM6512getStartimpl = TextRange.m6507getEndimpl(jM1512mapFromTransformedjx7JFs);
            }
        }
        long jTextRange = TextRangeKt.TextRange(iM6512getStartimpl);
        if (TextRange.m6505equalsimpl0(jTextRange, this.textFieldState.getUntransformedText().getSelection()) && (selectionWedgeAffinity2 == null || Intrinsics.areEqual(selectionWedgeAffinity2, this.textFieldState.getSelectionWedgeAffinity()))) {
            return false;
        }
        this.textFieldState.m1518selectUntransformedCharsIn5zctL8(jTextRange);
    ...
    */
    public final java.lang.Object detectCursorHandleDragGestures(androidx.compose.ui.input.pointer.PointerInputScope r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        ...
        L44:
            ...
            long r3 = r1.m4342getUnspecifiedF1C5BW0()
            r10.element = r3
    ...
    public static final void detectCursorHandleDragGestures$onDragStop(Ref.LongRef longRef, Ref.LongRef longRef2, TextFieldSelectionState textFieldSelectionState) {
        if (OffsetKt.m4346isSpecifiedk4lQ0M(longRef.element)) {
            longRef.element = Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
    ...
    private final class TextFieldMouseSelectionObserver implements MouseSelectionObserver {
        ...
        private long dragBeginPosition = Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
        ...
        public boolean mo1559onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
            ...
            this.dragBeginOffsetInText = TextRange.m6512getStartimpl(m1555updateSelectionr1Wruf4(downPosition, adjustment, true));
            return true;
        }

        @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
        /* JADX INFO: renamed from: onDrag-3MmeM6k, reason: not valid java name */
        public boolean mo1556onDrag3MmeM6k(final long dragPosition, SelectionAdjustment adjustment) {
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return false;
            }
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldMouseSelectionObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Mouse.onDrag " + ((Object) Offset.m4335toStringimpl(dragPosition));
                }
            });
            m1555updateSelectionr1Wruf4(dragPosition, adjustment, false);
            return true;
        }

        /* JADX INFO: renamed from: updateSelection-r1Wruf4, reason: not valid java name */
        private final long m1555updateSelectionr1Wruf4(long dragPosition, SelectionAdjustment adjustment, boolean isStartOfSelection) {
            Integer numValueOf = Integer.valueOf(this.dragBeginOffsetInText);
            if (numValueOf.intValue() < 0) {
                numValueOf = null;
            }
            int iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1500getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
            int iM1500getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1500getOffsetForPosition3MmeM6k(dragPosition, false);
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1551updateSelectionSsLRf8 = textFieldSelectionState.m1551updateSelectionSsLRf8(textFieldSelectionState.textFieldState.getVisualText(), iIntValue, iM1500getOffsetForPosition3MmeM6k, false, adjustment, false, isStartOfSelection);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m6506getCollapsedimpl(jM1551updateSelectionSsLRf8)) {
                this.dragBeginOffsetInText = TextRange.m6512getStartimpl(jM1551updateSelectionSsLRf8);
            }
            if (TextRange.m6511getReversedimpl(jM1551updateSelectionSsLRf8)) {
                jM1551updateSelectionSsLRf8 = TextFieldSelectionStateKt.m1568reverse5zctL8(jM1551updateSelectionSsLRf8);
            }
            TextFieldSelectionState.this.textFieldState.m1517selectCharsIn5zctL8(jM1551updateSelectionSsLRf8);
            TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            return jM1551updateSelectionSsLRf8;
        }
        ...
        public boolean mo1557onExtendk4lQ0M(long downPosition) {
        ...
        public boolean mo1558onExtendDragk4lQ0M(long dragPosition) {
    ...
    private final class TextFieldTextDragObserver implements TextDragObserver {
        ...
        private int dragBeginOffsetInText = -1;
        private long dragBeginPosition = Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
        private long dragTotalDistance = Offset.INSTANCE.m4343getZeroF1C5BW0();
        ...
        private final void onDragStop() {
            if (OffsetKt.m4346isSpecifiedk4lQ0M(this.dragBeginPosition)) {
                ...
                this.dragBeginOffsetInText = -1;
                this.dragBeginPosition = Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
                this.dragTotalDistance = Offset.INSTANCE.m4343getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                TextFieldSelectionState.this.setDirectDragGestureInitiator(InputType.None);
                this.requestFocus.invoke();
            }
        ...
        public void mo1344onStartk4lQ0M(final long startPoint) {
            if (TextFieldSelectionState.this.enabled) {
                TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onStart$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Touch.onDragStart after longPress at " + ((Object) Offset.m4335toStringimpl(startPoint));
                    }
                });
                TextFieldSelectionState.this.m1554updateHandleDraggingUv8p0NA(this.actingHandle, startPoint);
                ...
                this.dragTotalDistance = Offset.INSTANCE.m4343getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                if (!TextFieldSelectionState.this.textLayoutState.m1501isPositionOnTextk4lQ0M(startPoint)) {
                    int iM1497getOffsetForPosition3MmeM6k$default = TextLayoutState.m1497getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                    HapticFeedback hapticFeedback = TextFieldSelectionState.this.hapticFeedBack;
                    if (hapticFeedback != null) {
                        hapticFeedback.mo5295performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m5304getTextHandleMove5zf0vsI());
                    }
                    TextFieldSelectionState.this.textFieldState.placeCursorBeforeCharAt(iM1497getOffsetForPosition3MmeM6k$default);
                ...
                int iM1497getOffsetForPosition3MmeM6k$default2 = TextLayoutState.m1497getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                long jM1552updateSelectionSsLRf8$default = TextFieldSelectionState.m1552updateSelectionSsLRf8$default(TextFieldSelectionState.this, new TextFieldCharSequence(TextFieldSelectionState.this.textFieldState.getVisualText(), TextRange.INSTANCE.m6517getZerod9O1mEE(), null, null, 12, null), iM1497getOffsetForPosition3MmeM6k$default2, iM1497getOffsetForPosition3MmeM6k$default2, false, SelectionAdjustment.INSTANCE.getWord(), false, false, 96, null);
                TextFieldSelectionState.this.textFieldState.m1517selectCharsIn5zctL8(jM1552updateSelectionSsLRf8$default);
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                this.dragBeginOffsetInText = TextRange.m6512getStartimpl(jM1552updateSelectionSsLRf8$default);
            }
        }
        ...
        public void mo1343onDragk4lQ0M(long delta) {
            int iIntValue;
            int iM1500getOffsetForPosition3MmeM6k;
            SelectionAdjustment word;
            Handle handle;
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return;
            }
            long jM4332plusMKHz9U = Offset.m4332plusMKHz9U(this.dragTotalDistance, delta);
            this.dragTotalDistance = jM4332plusMKHz9U;
            final long jM4332plusMKHz9U2 = Offset.m4332plusMKHz9U(this.dragBeginPosition, jM4332plusMKHz9U);
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Touch.onDrag at " + ((Object) Offset.m4335toStringimpl(jM4332plusMKHz9U2));
                }
            });
            if (this.dragBeginOffsetInText < 0 && !TextFieldSelectionState.this.textLayoutState.m1501isPositionOnTextk4lQ0M(jM4332plusMKHz9U2)) {
                iIntValue = TextLayoutState.m1497getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, this.dragBeginPosition, false, 2, null);
                iM1500getOffsetForPosition3MmeM6k = TextLayoutState.m1497getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, jM4332plusMKHz9U2, false, 2, null);
                if (iIntValue == iM1500getOffsetForPosition3MmeM6k) {
                ...
                iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1500getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                iM1500getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1500getOffsetForPosition3MmeM6k(jM4332plusMKHz9U2, false);
                if (this.dragBeginOffsetInText < 0 && iIntValue == iM1500getOffsetForPosition3MmeM6k) {
                    return;
                }
                word = SelectionAdjustment.INSTANCE.getWord();
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            ...
            int i = iIntValue;
            int i2 = iM1500getOffsetForPosition3MmeM6k;
            ...
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1552updateSelectionSsLRf8$default = TextFieldSelectionState.m1552updateSelectionSsLRf8$default(textFieldSelectionState, textFieldSelectionState.textFieldState.getVisualText(), i, i2, false, selectionAdjustment, false, false, 64, null);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m6506getCollapsedimpl(jM1552updateSelectionSsLRf8$default)) {
                this.dragBeginOffsetInText = TextRange.m6512getStartimpl(jM1552updateSelectionSsLRf8$default);
            }
            if (TextRange.m6511getReversedimpl(jM1552updateSelectionSsLRf8$default)) {
                jM1552updateSelectionSsLRf8$default = TextFieldSelectionStateKt.m1568reverse5zctL8(jM1552updateSelectionSsLRf8$default);
            }
            if (!TextRange.m6505equalsimpl0(jM1552updateSelectionSsLRf8$default, selection)) {
                if (TextRange.m6512getStartimpl(jM1552updateSelectionSsLRf8$default) != TextRange.m6512getStartimpl(selection) && TextRange.m6507getEndimpl(jM1552updateSelectionSsLRf8$default) == TextRange.m6507getEndimpl(selection)) {
                    handle = Handle.SelectionStart;
                } else if ((TextRange.m6512getStartimpl(jM1552updateSelectionSsLRf8$default) == TextRange.m6512getStartimpl(selection) && TextRange.m6507getEndimpl(jM1552updateSelectionSsLRf8$default) != TextRange.m6507getEndimpl(selection)) || (TextRange.m6512getStartimpl(jM1552updateSelectionSsLRf8$default) + TextRange.m6507getEndimpl(jM1552updateSelectionSsLRf8$default)) / 2.0f > (TextRange.m6512getStartimpl(selection) + TextRange.m6507getEndimpl(selection)) / 2.0f) {
                    handle = Handle.SelectionEnd;
                } else {
                    handle = Handle.SelectionStart;
                }
            ...
            if (TextRange.m6506getCollapsedimpl(selection) || !TextRange.m6506getCollapsedimpl(jM1552updateSelectionSsLRf8$default)) {
                TextFieldSelectionState.this.textFieldState.m1517selectCharsIn5zctL8(jM1552updateSelectionSsLRf8$default);
            }
            TextFieldSelectionState.this.m1554updateHandleDraggingUv8p0NA(this.actingHandle, jM4332plusMKHz9U2);
        }
    }
    ...
    */
    ...
    public static final void detectSelectionHandleDragGestures$onDragStop$5(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Ref.LongRef longRef2) {
        if (OffsetKt.m4346isSpecifiedk4lQ0M(longRef.element)) {
            textFieldSelectionState.clearHandleDragging();
            longRef.element = Offset.INSTANCE.m4342getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m4343getZeroF1C5BW0();
    ...
    /* JADX INFO: compiled from: TextFieldSelectionState.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* synthetic */ class C03973 extends FunctionReferenceImpl implements Function2<TextFieldCharSequence, CharSequence, Boolean> {
        public static final C03973 INSTANCE = new C03973();
    ...
    public final Object observeTextChanges(Continuation<? super Unit> continuation) {
        ...
        }), C03973.INSTANCE), 1).collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextChanges.4
    ...
    public final Object observeTextToolbarVisibility(Continuation<? super Unit> continuation) {
        Object objCollect = SnapshotStateKt.snapshotFlow(new Function0<Rect>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextToolbarVisibility.2
            ...
            public final Rect invoke() {
                Rect rectIntersect;
                boolean zM6506getCollapsedimpl = TextRange.m6506getCollapsedimpl(TextFieldSelectionState.this.textFieldState.getVisualText().getSelection());
                if (((zM6506getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Cursor) || (!zM6506getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Selection)) && TextFieldSelectionState.this.getDraggingHandle() == null && TextFieldSelectionState.this.isInTouchMode()) {
                    ...
                    if (rectVisibleBounds != null) {
                        ...
                        Offset offsetM4316boximpl = textLayoutCoordinates2 != null ? Offset.m4316boximpl(textLayoutCoordinates2.mo5914localToRootMKHz9U(rectVisibleBounds.m4362getTopLeftF1C5BW0())) : null;
                        Intrinsics.checkNotNull(offsetM4316boximpl);
                        Rect rectM4367Recttz77jQw = RectKt.m4367Recttz77jQw(offsetM4316boximpl.getPackedValue(), rectVisibleBounds.m4360getSizeNHjbRc());
                        Rect contentRect = TextFieldSelectionState.this.getContentRect();
                        Rect rect = rectM4367Recttz77jQw.overlaps(contentRect) ? contentRect : null;
                        return (rect == null || (rectIntersect = rect.intersect(rectM4367Recttz77jQw)) == null) ? Rect.INSTANCE.getZero() : rectIntersect;
                    }
                    return Rect.INSTANCE.getZero();
                }
                return Rect.INSTANCE.getZero();
    ...
    public final Rect getContentRect() {
        ...
        if (TextRange.m6506getCollapsedimpl(visualText.getSelection())) {
            ...
            LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
            return RectKt.m4367Recttz77jQw(textLayoutCoordinates != null ? textLayoutCoordinates.mo5914localToRootMKHz9U(cursorRect3.m4362getTopLeftF1C5BW0()) : Offset.INSTANCE.m4343getZeroF1C5BW0(), cursorRect3.m4360getSizeNHjbRc());
        }
        LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
        long jMo5914localToRootMKHz9U = textLayoutCoordinates2 != null ? textLayoutCoordinates2.mo5914localToRootMKHz9U(m1544getHandlePositiontuRUvjQ(true)) : Offset.INSTANCE.m4343getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates3 = getTextLayoutCoordinates();
        long jMo5914localToRootMKHz9U2 = textLayoutCoordinates3 != null ? textLayoutCoordinates3.mo5914localToRootMKHz9U(m1544getHandlePositiontuRUvjQ(false)) : Offset.INSTANCE.m4343getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates4 = getTextLayoutCoordinates();
        float fM4328getYimpl2 = 0.0f;
        if (textLayoutCoordinates4 != null) {
            TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
            fM4328getYimpl = Offset.m4328getYimpl(textLayoutCoordinates4.mo5914localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (cursorRect2 = layoutResult.getCursorRect(TextRange.m6512getStartimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect2.getTop())));
        } else {
            fM4328getYimpl = 0.0f;
        }
        ...
        if (textLayoutCoordinates5 != null) {
            ...
            fM4328getYimpl2 = Offset.m4328getYimpl(textLayoutCoordinates5.mo5914localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (cursorRect = layoutResult2.getCursorRect(TextRange.m6507getEndimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect.getTop())));
        }
        return new Rect(Math.min(Offset.m4327getXimpl(jMo5914localToRootMKHz9U), Offset.m4327getXimpl(jMo5914localToRootMKHz9U2)), Math.min(fM4328getYimpl, fM4328getYimpl2), Math.max(Offset.m4327getXimpl(jMo5914localToRootMKHz9U), Offset.m4327getXimpl(jMo5914localToRootMKHz9U2)), Math.max(Offset.m4328getYimpl(jMo5914localToRootMKHz9U), Offset.m4328getYimpl(jMo5914localToRootMKHz9U2)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:23:0x0052, code lost:
    
        if (((r0 == null || (r0 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r0)) == null) ? false : androidx.compose.foundation.text.selection.SelectionManagerKt.m1664containsInclusiveUv8p0NA(r0, r4)) != false) goto L24;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState getSelectionHandleState$foundation_release(boolean r14, boolean r15) {
        ...
        L16:
            ...
            boolean r4 = androidx.compose.ui.text.TextRange.m6506getCollapsedimpl(r2)
            if (r4 == 0) goto L2d
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState$Companion r14 = androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState.INSTANCE
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState r14 = r14.getHidden()
            return r14
        L2d:
            long r4 = r13.m1544getHandlePositiontuRUvjQ(r14)
            ...
            if (r0 == 0) goto L51
            boolean r0 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1664containsInclusiveUv8p0NA(r0, r4)
            goto L52
        L51:
            r0 = r7
        L52:
        ...
        L67:
            if (r14 == 0) goto L6e
            int r14 = androidx.compose.ui.text.TextRange.m6512getStartimpl(r2)
            goto L78
        L6e:
            int r14 = androidx.compose.ui.text.TextRange.m6507getEndimpl(r2)
            int r14 = r14 + (-1)
            int r14 = java.lang.Math.max(r14, r7)
        L78:
            androidx.compose.ui.text.style.ResolvedTextDirection r10 = r1.getBidiRunDirection(r14)
            boolean r11 = androidx.compose.ui.text.TextRange.m6511getReversedimpl(r2)
            if (r15 == 0) goto L93
            ...
            if (r14 == 0) goto L99
            long r4 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1504coerceIn3MmeM6k(r4, r14)
            goto L99
        L93:
            androidx.compose.ui.geometry.Offset$Companion r14 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r4 = r14.m4342getUnspecifiedF1C5BW0()
        L99:
            r8 = r4
    ...
    public final long m1544getHandlePositiontuRUvjQ(boolean isStartHandle) {
        int iM6507getEndimpl;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
        ...
        if (isStartHandle) {
            iM6507getEndimpl = TextRange.m6512getStartimpl(selection);
        } else {
            iM6507getEndimpl = TextRange.m6507getEndimpl(selection);
        }
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult, iM6507getEndimpl, isStartHandle, TextRange.m6511getReversedimpl(selection));
    }

    /* JADX INFO: renamed from: updateHandleDragging-Uv8p0NA, reason: not valid java name */
    public final void m1554updateHandleDraggingUv8p0NA(Handle handle, long position) {
        setDraggingHandle(handle);
        m1549setRawHandleDragPositionk4lQ0M(position);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void markStartContentVisibleOffset() {
        m1550setStartTextLayoutPositionInWindowk4lQ0M(m1543getCurrentTextLayoutPositionInWindowF1C5BW0());
    }

    public final void clearHandleDragging() {
        setDraggingHandle(null);
        m1549setRawHandleDragPositionk4lQ0M(Offset.INSTANCE.m4342getUnspecifiedF1C5BW0());
        m1550setStartTextLayoutPositionInWindowk4lQ0M(Offset.INSTANCE.m4342getUnspecifiedF1C5BW0());
    }

    public final boolean canCut() {
        return (TextRange.m6506getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || !getEditable() || this.isPassword) ? false : true;
    }
    ...
    public final boolean canCopy() {
        return (TextRange.m6506getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || this.isPassword) ? false : true;
    }
    ...
    public final void paste() {
        ...
        TransferableContent transferableContentOnReceive = receiveContentConfigurationInvoke.getReceiveContentListener().onReceive(new TransferableContent(clip, clip.getClipMetadata(), TransferableContent.Source.INSTANCE.m620getClipboardkB6V9T0(), null, 8, null));
    ...
    public final boolean canSelectAll() {
        return TextRange.m6508getLengthimpl(this.textFieldState.getVisualText().getSelection()) != this.textFieldState.getVisualText().length();
    }
    ...
    public final void deselect() {
        if (!TextRange.m6506getCollapsedimpl(this.textFieldState.getVisualText().getSelection())) {
    ...
    static /* synthetic */ long m1552updateSelectionSsLRf8$default(TextFieldSelectionState textFieldSelectionState, TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, int i3, Object obj) {
        if ((i3 & 32) != 0) {
            z2 = false;
        }
        if ((i3 & 64) != 0) {
        ...
        return textFieldSelectionState.m1551updateSelectionSsLRf8(textFieldCharSequence, i, i2, z, selectionAdjustment, z2, z3);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: updateSelection-SsL-Rf8, reason: not valid java name */
    public final long m1551updateSelectionSsLRf8(TextFieldCharSequence textFieldCharSequence, int startOffset, int endOffset, boolean isStartHandle, SelectionAdjustment adjustment, boolean allowPreviousSelectionCollapsed, boolean isStartOfSelection) {
        HapticFeedback hapticFeedback;
        TextRange textRangeM6500boximpl = TextRange.m6500boximpl(textFieldCharSequence.getSelection());
        long packedValue = textRangeM6500boximpl.getPackedValue();
        if (isStartOfSelection || (!allowPreviousSelectionCollapsed && TextRange.m6506getCollapsedimpl(packedValue))) {
            textRangeM6500boximpl = null;
        }
        long jM1547getTextFieldSelectionqeG_v_k = m1547getTextFieldSelectionqeG_v_k(startOffset, endOffset, textRangeM6500boximpl, isStartHandle, adjustment);
        if (!TextRange.m6505equalsimpl0(jM1547getTextFieldSelectionqeG_v_k, textFieldCharSequence.getSelection())) {
            boolean z = TextRange.m6511getReversedimpl(jM1547getTextFieldSelectionqeG_v_k) != TextRange.m6511getReversedimpl(textFieldCharSequence.getSelection()) && TextRange.m6505equalsimpl0(TextRangeKt.TextRange(TextRange.m6507getEndimpl(jM1547getTextFieldSelectionqeG_v_k), TextRange.m6512getStartimpl(jM1547getTextFieldSelectionqeG_v_k)), textFieldCharSequence.getSelection());
            if (isInTouchMode() && !z && (hapticFeedback = this.hapticFeedBack) != null) {
                hapticFeedback.mo5295performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m5304getTextHandleMove5zf0vsI());
            }
        }
        return jM1547getTextFieldSelectionqeG_v_k;
    }

    /* JADX INFO: renamed from: getTextFieldSelection-qeG_v_k, reason: not valid java name */
    private final long m1547getTextFieldSelectionqeG_v_k(int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return TextRange.INSTANCE.m6517getZerod9O1mEE();
        }
        ...
        SelectionLayout selectionLayoutM1630getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1630getTextFieldSelectionLayoutRcvTLA(layoutResult, rawStartOffset, rawEndOffset, this.previousRawDragOffset, previousSelection != null ? previousSelection.getPackedValue() : TextRange.INSTANCE.m6517getZerod9O1mEE(), previousSelection == null, isStartHandle);
        if (previousSelection != null && !selectionLayoutM1630getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return previousSelection.getPackedValue();
        }
        long jM1618toTextRanged9O1mEE = adjustment.adjust(selectionLayoutM1630getTextFieldSelectionLayoutRcvTLA).m1618toTextRanged9O1mEE();
        this.previousSelectionLayout = selectionLayoutM1630getTextFieldSelectionLayoutRcvTLA;
        this.previousRawDragOffset = isStartHandle ? rawStartOffset : rawEndOffset;
        return jM1618toTextRanged9O1mEE;
    }
}
