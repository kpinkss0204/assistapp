...
final class TouchSlopDetector {
    ...
    public TouchSlopDetector(Orientation orientation) {
        ...
        this.totalPositionChange = Offset.INSTANCE.m4343getZeroF1C5BW0();
    }
    ...
    public final float m790mainAxisk4lQ0M(long j) {
    ...
    public final float m789crossAxisk4lQ0M(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m4328getYimpl(j) : Offset.m4327getXimpl(j);
    }

    /* JADX INFO: renamed from: addPointerInputChange-GcwITfU, reason: not valid java name */
    public final Offset m788addPointerInputChangeGcwITfU(PointerInputChange dragEvent, float touchSlop) {
        float fAbs;
        long jM4332plusMKHz9U = Offset.m4332plusMKHz9U(this.totalPositionChange, Offset.m4331minusMKHz9U(dragEvent.getPosition(), dragEvent.getPreviousPosition()));
        this.totalPositionChange = jM4332plusMKHz9U;
        if (this.orientation == null) {
            fAbs = Offset.m4325getDistanceimpl(jM4332plusMKHz9U);
        } else {
            fAbs = Math.abs(m790mainAxisk4lQ0M(jM4332plusMKHz9U));
        }
        if (fAbs >= touchSlop) {
            return Offset.m4316boximpl(m787calculatePostSlopOffsettuRUvjQ(touchSlop));
        }
        return null;
    }
    ...
    private final long m787calculatePostSlopOffsettuRUvjQ(float touchSlop) {
        if (this.orientation == null) {
            long j = this.totalPositionChange;
            return Offset.m4331minusMKHz9U(this.totalPositionChange, Offset.m4334timestuRUvjQ(Offset.m4322divtuRUvjQ(j, Offset.m4325getDistanceimpl(j)), touchSlop));
        }
        float fM790mainAxisk4lQ0M = m790mainAxisk4lQ0M(this.totalPositionChange) - (Math.signum(m790mainAxisk4lQ0M(this.totalPositionChange)) * touchSlop);
        float fM789crossAxisk4lQ0M = m789crossAxisk4lQ0M(this.totalPositionChange);
        if (this.orientation == Orientation.Horizontal) {
            return OffsetKt.Offset(fM790mainAxisk4lQ0M, fM789crossAxisk4lQ0M);
        }
        return OffsetKt.Offset(fM789crossAxisk4lQ0M, fM790mainAxisk4lQ0M);
    }
}
