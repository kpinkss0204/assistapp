...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo678calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM4316boximpl = Offset.m4316boximpl(Offset.INSTANCE.m4343getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM4316boximpl = Offset.m4316boximpl(Offset.m4332plusMKHz9U(offsetM4316boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m4334timestuRUvjQ(offsetM4316boximpl.getPackedValue(), -density.mo657toPx0680j_4(Dp.m7027constructorimpl(64)));
    }
}
