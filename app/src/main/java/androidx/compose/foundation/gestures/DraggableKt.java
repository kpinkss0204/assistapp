...
public final class DraggableKt {
    ...
    public static final float m730toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m4328getYimpl(j) : Offset.m4327getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m731toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m7265getYimpl(j) : Velocity.m7264getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m732toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m7264getXimpl(j)) ? 0.0f : Velocity.m7264getXimpl(j), Float.isNaN(Velocity.m7265getYimpl(j)) ? 0.0f : Velocity.m7265getYimpl(j));
    }
}
