...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    public void mo674onDragStartedk4lQ0M(long startedPosition) {
    }
    ...
    public void mo675onDragStoppedTH1AsA0(long velocity) {
    ...
    public boolean mo492onKeyEventZmokQxo(KeyEvent event) {
        ...
        if ((!Key.m5324equalsimpl0(KeyEvent_androidKt.m5632getKeyZmokQxo(event), Key.INSTANCE.m5512getPageDownEK5gGoQ()) && !Key.m5324equalsimpl0(KeyEvent_androidKt.m5632getKeyZmokQxo(event), Key.INSTANCE.m5513getPageUpEK5gGoQ())) || !KeyEventType.m5625equalsimpl0(KeyEvent_androidKt.m5633getTypeZmokQxo(event), KeyEventType.INSTANCE.m5629getKeyDownCS__XNY()) || KeyEvent_androidKt.m5636isCtrlPressedZmokQxo(event)) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int iM7196getHeightimpl = IntSize.m7196getHeightimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(0.0f, Key.m5324equalsimpl0(KeyEvent_androidKt.m5632getKeyZmokQxo(event), Key.INSTANCE.m5513getPageUpEK5gGoQ()) ? iM7196getHeightimpl : -iM7196getHeightimpl);
        } else {
            int iM7197getWidthimpl = IntSize.m7197getWidthimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(Key.m5324equalsimpl0(KeyEvent_androidKt.m5632getKeyZmokQxo(event), Key.INSTANCE.m5513getPageUpEK5gGoQ()) ? iM7197getWidthimpl : -iM7197getWidthimpl, 0.0f);
        }
    ...
    public void mo493onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        while (true) {
            ...
            if (getCanDrag().invoke(changes.get(i)).booleanValue()) {
                super.mo493onPointerEventH0pRuoY(pointerEvent, pass, bounds);
                break;
            }
            i++;
        }
        if (pass == PointerEventPass.Main && PointerEventType.m5723equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5732getScroll7fucELk())) {
            m768processMouseWheelEventO0kMr_c(pointerEvent, bounds);
        }
    }
    ...
    private final void setScrollSemanticsActions() {
        this.scrollByAction = new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableNode.setScrollSemanticsActions.1
            ...
            static final class C00251 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                C00251(ScrollableNode scrollableNode, float f, float f2, Continuation<? super C00251> continuation) {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (ScrollableKt.m765semanticsScrollByd4ec7I(this.this$0.scrollingLogic, OffsetKt.Offset(this.$x, this.$y), this) == coroutine_suspended) {
            ...
            public final Boolean invoke(float f, float f2) {
                BuildersKt__Builders_commonKt.launch$default(ScrollableNode.this.getCoroutineScope(), null, null, new C00251(ScrollableNode.this, f, f2, null), 3, null);
                return true;
            }
        };
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m769invoke3MmeM6k(offset.getPackedValue(), continuation);
        }

        /* JADX INFO: renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m769invoke3MmeM6k(long j, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m4316boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            long j = this.J$0;
            this.label = 1;
            Object objM765semanticsScrollByd4ec7I = ScrollableKt.m765semanticsScrollByd4ec7I(ScrollableNode.this.scrollingLogic, j, this);
            return objM765semanticsScrollByd4ec7I == coroutine_suspended ? coroutine_suspended : objM765semanticsScrollByd4ec7I;
        }
    }
    ...
    private final void m768processMouseWheelEventO0kMr_c(PointerEvent event, long size) {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$processMouseWheelEvent$2$1(this, scrollConfig.mo678calculateMouseWheelScroll8xgXZGE(DelegatableNodeKt.requireDensity(this), event, size), null), 3, null);
