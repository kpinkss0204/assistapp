...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m782toFloatk4lQ0M(nestedScrollScope.mo739scrollByWithOverscrollOzD1aCk(scrollingLogic4.m780reverseIfNeededMKHz9U(scrollingLogic4.m783toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m5668getSideEffectWNlRxjI())));
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m775toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m776updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
