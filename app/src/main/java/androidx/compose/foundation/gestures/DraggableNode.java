...
public final class DraggableNode extends DragGestureNode {
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        dragScope.dragBy(DraggableKt.m730toFloat3MmeM6k(draggableNode.m737reverseIfNeededMKHz9U(dragDelta.getDelta()), draggableNode.orientation));
                    }
                };
                this.label = 1;
    ...
    public final long m736reverseIfNeededAH228Gc(long j) {
    ...
    public final long m737reverseIfNeededMKHz9U(long j) {
