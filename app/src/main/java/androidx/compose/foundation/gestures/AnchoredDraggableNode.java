...
final class AnchoredDraggableNode<T> extends DragGestureNode {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        if (((AnchoredDraggableNode) anchoredDraggableNode).overscrollEffect != null) {
                            ...
                            long jM669reverseIfNeededMKHz9U = anchoredDraggableNode.m669reverseIfNeededMKHz9U(dragDelta.getDelta());
                            int iM5669getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m5669getUserInputWNlRxjI();
                            ...
                            overscrollEffect.mo502applyToScrollRhakbz0(jM669reverseIfNeededMKHz9U, iM5669getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                    return Offset.m4316boximpl(m676invokeMKHz9U(offset.getPackedValue()));
                                }

                                /* JADX INFO: renamed from: invoke-MK-Hz9U, reason: not valid java name */
                                public final long m676invokeMKHz9U(long j) {
                                    float fNewOffsetForDelta$foundation_release = ((AnchoredDraggableNode) anchoredDraggableNode2).state.newOffsetForDelta$foundation_release(anchoredDraggableNode2.m671toFloatk4lQ0M(j));
                                    AnchoredDraggableNode<T> anchoredDraggableNode3 = anchoredDraggableNode2;
                                    long jM672toOffsettuRUvjQ = anchoredDraggableNode3.m672toOffsettuRUvjQ(fNewOffsetForDelta$foundation_release - ((AnchoredDraggableNode) anchoredDraggableNode3).state.requireOffset());
                                    AnchoredDragScope.dragTo$default(anchoredDragScope2, fNewOffsetForDelta$foundation_release, 0.0f, 2, null);
                                    return jM672toOffsettuRUvjQ;
                                }
                            });
                            return;
                        }
                        ...
                        AnchoredDragScope.dragTo$default(anchoredDragScope3, anchoredDraggableState.newOffsetForDelta$foundation_release(anchoredDraggableNode3.m671toFloatk4lQ0M(anchoredDraggableNode3.m669reverseIfNeededMKHz9U(dragDelta.getDelta()))), 0.0f, 2, null);
                    }
                };
                this.label = 1;
    ...
    public final long m672toOffsettuRUvjQ(float f) {
    ...
    public final long m673toVelocityadjELrA(float f) {
        float f2 = this.orientation == Orientation.Horizontal ? f : 0.0f;
        if (this.orientation != Orientation.Vertical) {
            f = 0.0f;
        }
    ...
    public final float m670toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Vertical ? Velocity.m7265getYimpl(j) : Velocity.m7264getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m671toFloatk4lQ0M(long j) {
        return this.orientation == Orientation.Vertical ? Offset.m4328getYimpl(j) : Offset.m4327getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: reverseIfNeeded-AH228Gc, reason: not valid java name */
    public final long m668reverseIfNeededAH228Gc(long j) {
        return Velocity.m7270timesadjELrA(j, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m669reverseIfNeededMKHz9U(long j) {
        return Offset.m4334timestuRUvjQ(j, isReverseDirection() ? -1.0f : 1.0f);
    }
}
