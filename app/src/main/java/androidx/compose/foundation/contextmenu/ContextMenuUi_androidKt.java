...
public final class ContextMenuUi_androidKt {
    ...
    private static final ContextMenuColors DefaultContextMenuColors = new ContextMenuColors(Color.INSTANCE.m4605getWhite0d7_KjU(), Color.INSTANCE.m4594getBlack0d7_KjU(), Color.INSTANCE.m4594getBlack0d7_KjU(), Color.m4567copywmQWz5c$default(Color.INSTANCE.m4594getBlack0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4567copywmQWz5c$default(Color.INSTANCE.m4594getBlack0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    */
    ...
    public static final ContextMenuColors computeContextMenuColors(int i, int i2, Composer composer, int i3, int i4) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            long jM646resolveColorg2O1Hgs = m646resolveColorg2O1Hgs(context, i5, R.attr.colorBackground, contextMenuColors.getBackgroundColor());
            ColorStateList colorStateListResolveColorStateList = resolveColorStateList(context, i6, R.attr.textColorPrimary);
            long jM645enabledColor4WTKRHQ = m645enabledColor4WTKRHQ(colorStateListResolveColorStateList, contextMenuColors.getTextColor());
            long jM644disabledColor4WTKRHQ = m644disabledColor4WTKRHQ(colorStateListResolveColorStateList, contextMenuColors.getDisabledTextColor());
            Object contextMenuColors2 = new ContextMenuColors(jM646resolveColorg2O1Hgs, jM645enabledColor4WTKRHQ, jM645enabledColor4WTKRHQ, jM644disabledColor4WTKRHQ, jM644disabledColor4WTKRHQ, null);
    ...
    private static final long m646resolveColorg2O1Hgs(Context context, int i, int i2, long j) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, new int[]{i2});
        int iM4622toArgb8_81llA = ColorKt.m4622toArgb8_81llA(j);
        int color = typedArrayObtainStyledAttributes.getColor(0, iM4622toArgb8_81llA);
        typedArrayObtainStyledAttributes.recycle();
        return color == iM4622toArgb8_81llA ? j : ColorKt.Color(color);
    }
    ...
    private static final long m645enabledColor4WTKRHQ(ColorStateList colorStateList, long j) {
        int iM4622toArgb8_81llA = ColorKt.m4622toArgb8_81llA(j);
        Integer numValueOf = colorStateList != null ? Integer.valueOf(colorStateList.getColorForState(new int[]{R.attr.state_enabled}, iM4622toArgb8_81llA)) : null;
        return (numValueOf == null || numValueOf.intValue() == iM4622toArgb8_81llA) ? j : ColorKt.Color(numValueOf.intValue());
    }

    /* JADX INFO: renamed from: disabledColor-4WTKRHQ, reason: not valid java name */
    private static final long m644disabledColor4WTKRHQ(ColorStateList colorStateList, long j) {
        int iM4622toArgb8_81llA = ColorKt.m4622toArgb8_81llA(j);
        Integer numValueOf = colorStateList != null ? Integer.valueOf(colorStateList.getColorForState(new int[]{-16842910}, iM4622toArgb8_81llA)) : null;
        return (numValueOf == null || numValueOf.intValue() == iM4622toArgb8_81llA) ? j : ColorKt.Color(numValueOf.intValue());
    }
}
