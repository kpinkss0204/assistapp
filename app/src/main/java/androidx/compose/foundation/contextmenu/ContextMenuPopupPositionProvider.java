...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo629calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m7155getXimpl(this.localPosition), IntSize.m7197getWidthimpl(popupContentSize), IntSize.m7197getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m7156getYimpl(this.localPosition), IntSize.m7196getHeightimpl(popupContentSize), IntSize.m7196getHeightimpl(windowSize), false, 8, null));
    }
}
