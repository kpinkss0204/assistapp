...
public final class ComposerChangeListWriter {
    ...
    private final ArrayList<T> pendingDownNodes = Stack.m3997constructorimpl$default(null, 1, null);
    ...
    public final void moveUp() {
        realizeNodeMovementOperations();
        if (Stack.m4003isNotEmptyimpl(this.pendingDownNodes)) {
            Stack.m4006popimpl(this.pendingDownNodes);
            return;
        }
    ...
    public final void moveDown(Object node) {
        realizeNodeMovementOperations();
        Stack.m4007pushimpl(this.pendingDownNodes, node);
    }
    ...
    private final void pushPendingUpsAndDowns() {
        ...
        if (Stack.m4003isNotEmptyimpl(this.pendingDownNodes)) {
            this.changeList.pushDowns(Stack.m4008toArrayimpl(this.pendingDownNodes));
            Stack.m3995clearimpl(this.pendingDownNodes);
        }
    }
