...
public final class RememberEventDispatcher implements RememberManager {
    ...
    public void startResumingScope(RecomposeScopeImpl scope) {
        ...
        if (pausedCompositionRemembers != null) {
            ArrayList arrayListM3997constructorimpl$default = this.nestedRemembersLists;
            if (arrayListM3997constructorimpl$default == null) {
                arrayListM3997constructorimpl$default = Stack.m3997constructorimpl$default(null, 1, null);
                this.nestedRemembersLists = arrayListM3997constructorimpl$default;
            }
            Stack.m4007pushimpl(arrayListM3997constructorimpl$default, this.currentRememberingList);
    ...
    public void endResumingScope(RecomposeScopeImpl scope) {
        ...
        if (arrayList != 0 && (mutableVector = (MutableVector) Stack.m4006popimpl(arrayList)) != null) {
            this.currentRememberingList = mutableVector;
        }
