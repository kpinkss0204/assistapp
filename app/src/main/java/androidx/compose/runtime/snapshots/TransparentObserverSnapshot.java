...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    public void mo4151recordModified$runtime(StateObject state) {
        getCurrentSnapshot().mo4151recordModified$runtime(state);
    }
