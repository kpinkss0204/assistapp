...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    public BroadcastFrameClock(Function0<Unit> function0) {
        ...
        this.pendingAwaitersCountUnlocked = AtomicAwaitersCount.m3924constructorimpl();
    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM7875constructorimpl = Result.m7875constructorimpl(function1.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM7875constructorimpl = Result.m7875constructorimpl(ResultKt.createFailure(th));
            }
            cancellableContinuation.resumeWith(objM7875constructorimpl);
        }
        ...
        public final void resumeWithException(Throwable exception) {
            ...
            if (cancellableContinuation != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m7875constructorimpl(ResultKt.createFailure(exception)));
            }
        }
    }
    ...
    public final void sendFrame(long timeNanos) {
        ...
        synchronized (this.lock) {
            ...
            do {
                i = atomicInt.get();
            } while (!atomicInt.compareAndSet(i, AtomicAwaitersCount.m3935packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
    ...
    private static final class AtomicAwaitersCount {
        ...
        public static final /* synthetic */ AtomicAwaitersCount m3923boximpl(AtomicInt atomicInt) {
            return new AtomicAwaitersCount(atomicInt);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        private static AtomicInt m3925constructorimpl(AtomicInt atomicInt) {
            return atomicInt;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m3927equalsimpl(AtomicInt atomicInt, Object obj) {
            return (obj instanceof AtomicAwaitersCount) && Intrinsics.areEqual(atomicInt, ((AtomicAwaitersCount) obj).getValue());
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3928equalsimpl0(AtomicInt atomicInt, AtomicInt atomicInt2) {
            return Intrinsics.areEqual(atomicInt, atomicInt2);
        }

        /* JADX INFO: renamed from: getCount-impl, reason: not valid java name */
        private static final int m3929getCountimpl(AtomicInt atomicInt, int i) {
            return 134217727 & i;
        }

        /* JADX INFO: renamed from: getVersion-impl, reason: not valid java name */
        private static final int m3930getVersionimpl(AtomicInt atomicInt, int i) {
            return (i >>> 27) & 15;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m3932hashCodeimpl(AtomicInt atomicInt) {
            return atomicInt.hashCode();
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: pack-impl, reason: not valid java name */
        public static final int m3935packimpl(AtomicInt atomicInt, int i, int i2) {
            return ((i & 15) << 27) | (134217727 & i2);
        }

        public boolean equals(Object other) {
            return m3927equalsimpl(this.value, other);
        }

        public int hashCode() {
            return m3932hashCodeimpl(this.value);
        }
        ...
        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static AtomicInt m3924constructorimpl() {
            return m3925constructorimpl(new AtomicInt(0));
        }

        /* JADX INFO: renamed from: hasAwaiters-impl, reason: not valid java name */
        public static final boolean m3931hasAwaitersimpl(AtomicInt atomicInt) {
            return (atomicInt.get() & 134217727) > 0;
        }

        /* JADX INFO: renamed from: update-impl, reason: not valid java name */
        private static final int m3937updateimpl(AtomicInt atomicInt, Function1<? super Integer, Integer> function1) {
            int i;
            int iIntValue;
            do {
                i = atomicInt.get();
        ...
        public static String m3936toStringimpl(AtomicInt atomicInt) {
            int i = atomicInt.get();
        ...
        public static final void m3934incrementVersionAndResetCountimpl(AtomicInt atomicInt) {
            int i;
            do {
                i = atomicInt.get();
            } while (!atomicInt.compareAndSet(i, m3935packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
        }

        /* JADX INFO: renamed from: incrementCountAndGetVersion-impl, reason: not valid java name */
        public static final int m3933incrementCountAndGetVersionimpl(AtomicInt atomicInt, Function0<Unit> function0) {
            int i;
            int i2;
            do {
                i = atomicInt.get();
        ...
        public static final void m3926decrementCountimpl(AtomicInt atomicInt, int i) {
            int i2;
            do {
                i2 = atomicInt.get();
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th == null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m7875constructorimpl(ResultKt.createFailure(th)));
            }
        }
