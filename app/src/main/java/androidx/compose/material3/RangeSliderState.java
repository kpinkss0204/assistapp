...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long jM2698scaleToUserValueowVgs5E = m2698scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), jSliderRange);
        if (SliderRange.m2820equalsimpl0(jM2698scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m2822getStartimpl(jM2698scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m2821getEndInclusiveimpl(jM2698scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m2817boximpl(jM2698scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m2698scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        return SliderKt.m2810scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
