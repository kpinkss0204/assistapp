...
public final class NavigationBarArrangement {
    ...
    private static final int EqualWeight = m2553constructorimpl(0);
    private static final int Centered = m2553constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NavigationBarArrangement m2552boximpl(int i) {
    ...
    public static String m2557toStringimpl(int i) {
        return m2555equalsimpl0(i, EqualWeight) ? "EqualWeight" : m2555equalsimpl0(i, Centered) ? "Centered" : "Unknown";
    }
}
