...
public final class TextFieldColors {
    ...
    public final long m2960leadingIconColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledLeadingIconColor;
        }
        if (isError) {
    ...
    public final long m2966trailingIconColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledTrailingIconColor;
        }
        if (isError) {
    ...
    public final long m2958indicatorColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledIndicatorColor;
        }
        if (isError) {
    ...
    public final long m2913containerColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledContainerColor;
        }
        if (isError) {
    ...
    public final long m2961placeholderColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledPlaceholderColor;
        }
        if (isError) {
    ...
    public final long m2959labelColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledLabelColor;
        }
        if (isError) {
    ...
    public final long m2965textColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (isError) {
    ...
    public final long m2964supportingTextColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledSupportingTextColor;
        }
        if (isError) {
    ...
    public final long m2962prefixColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledPrefixColor;
        }
        if (isError) {
    ...
    public final long m2963suffixColorXeAY9LY$material3_release(boolean enabled, boolean isError, boolean focused) {
        if (!enabled) {
            return this.disabledSuffixColor;
        }
        if (isError) {
    ...
    public final long m2915cursorColorvNxB06k$material3_release(boolean isError) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4569equalsimpl0(this.focusedTextColor, textFieldColors.focusedTextColor) && Color.m4569equalsimpl0(this.unfocusedTextColor, textFieldColors.unfocusedTextColor) && Color.m4569equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m4569equalsimpl0(this.errorTextColor, textFieldColors.errorTextColor) && Color.m4569equalsimpl0(this.focusedContainerColor, textFieldColors.focusedContainerColor) && Color.m4569equalsimpl0(this.unfocusedContainerColor, textFieldColors.unfocusedContainerColor) && Color.m4569equalsimpl0(this.disabledContainerColor, textFieldColors.disabledContainerColor) && Color.m4569equalsimpl0(this.errorContainerColor, textFieldColors.errorContainerColor) && Color.m4569equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m4569equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && Intrinsics.areEqual(this.textSelectionColors, textFieldColors.textSelectionColors) && Color.m4569equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m4569equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m4569equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m4569equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m4569equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m4569equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m4569equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m4569equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m4569equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m4569equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m4569equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m4569equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m4569equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m4569equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m4569equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m4569equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m4569equalsimpl0(this.focusedPlaceholderColor, textFieldColors.focusedPlaceholderColor) && Color.m4569equalsimpl0(this.unfocusedPlaceholderColor, textFieldColors.unfocusedPlaceholderColor) && Color.m4569equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m4569equalsimpl0(this.errorPlaceholderColor, textFieldColors.errorPlaceholderColor) && Color.m4569equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m4569equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m4569equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m4569equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor) && Color.m4569equalsimpl0(this.focusedPrefixColor, textFieldColors.focusedPrefixColor) && Color.m4569equalsimpl0(this.unfocusedPrefixColor, textFieldColors.unfocusedPrefixColor) && Color.m4569equalsimpl0(this.disabledPrefixColor, textFieldColors.disabledPrefixColor) && Color.m4569equalsimpl0(this.errorPrefixColor, textFieldColors.errorPrefixColor) && Color.m4569equalsimpl0(this.focusedSuffixColor, textFieldColors.focusedSuffixColor) && Color.m4569equalsimpl0(this.unfocusedSuffixColor, textFieldColors.unfocusedSuffixColor) && Color.m4569equalsimpl0(this.disabledSuffixColor, textFieldColors.disabledSuffixColor) && Color.m4569equalsimpl0(this.errorSuffixColor, textFieldColors.errorSuffixColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m4575hashCodeimpl(this.focusedTextColor) * 31) + Color.m4575hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m4575hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4575hashCodeimpl(this.errorTextColor)) * 31) + Color.m4575hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m4575hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4575hashCodeimpl(this.errorContainerColor)) * 31) + Color.m4575hashCodeimpl(this.cursorColor)) * 31) + Color.m4575hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m4575hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m4575hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m4575hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m4575hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m4575hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4575hashCodeimpl(this.errorLabelColor)) * 31) + Color.m4575hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m4575hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m4575hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m4575hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m4575hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m4575hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m4575hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m4575hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m4575hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m4575hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m4575hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m4575hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m4575hashCodeimpl(this.errorSuffixColor);
    }
}
