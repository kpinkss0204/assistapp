...
public final class AnalogTimePickerState implements TimePickerState {
    ...
    public int mo2062getSelectionyecRtBI() {
        return this.state.mo2062getSelectionyecRtBI();
    }
    ...
    public void mo2063setSelection6_8s6DQ(int i) {
        this.state.mo2063setSelection6_8s6DQ(i);
    }
    ...
    public final Object animateToCurrent(Continuation<? super Unit> continuation) {
        ...
        if (TimePickerSelectionMode.m3050equalsimpl0(mo2062getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3054getHouryecRtBI())) {
    ...
    private final boolean isUpdated() {
        if (TimePickerSelectionMode.m3050equalsimpl0(mo2062getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3054getHouryecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.hourAngle)) {
            return false;
        }
        return (TimePickerSelectionMode.m3050equalsimpl0(mo2062getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3055getMinuteyecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.minuteAngle)) ? false : true;
    }

    public final IntList getClockFaceValues() {
        return TimePickerSelectionMode.m3050equalsimpl0(mo2062getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3055getMinuteyecRtBI()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }
    ...
    public final Object onGestureEnd(Continuation<? super Unit> continuation) {
        ...
        Object objMutate = this.mutex.mutate(MutatePriority.PreventUserInput, new C04712(endValueForAnimation(f), null), continuation);
        return objMutate == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate : Unit.INSTANCE;
    }
    ...
    static final class C04712 extends SuspendLambda implements Function1<Continuation<? super AnimationResult<Float, AnimationVector1D>>, Object> {
        final /* synthetic */ float $end;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04712(float f, Continuation<? super C04712> continuation) {
            super(1, continuation);
            this.$end = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return AnalogTimePickerState.this.new C04712(this.$end, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
            return ((C04712) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C04722 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
        final /* synthetic */ float $angle;
        final /* synthetic */ boolean $animate;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04722(float f, boolean z, Continuation<? super C04722> continuation) {
            super(1, continuation);
            this.$angle = f;
            this.$animate = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return AnalogTimePickerState.this.new C04722(this.$angle, this.$animate, continuation);
        }
        ...
        public final Object invoke2(Continuation<Object> continuation) {
            return ((C04722) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r12) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AnalogTimePickerState.C04722.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public final Object rotateTo(float f, boolean z, Continuation<? super Unit> continuation) {
        Object objMutate = this.mutex.mutate(MutatePriority.UserInput, new C04722(f, z, null), continuation);
        return objMutate == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate : Unit.INSTANCE;
    }
    ...
    public void setMinute(int i) {
        ...
        if (TimePickerSelectionMode.m3050equalsimpl0(mo2062getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3055getMinuteyecRtBI())) {
