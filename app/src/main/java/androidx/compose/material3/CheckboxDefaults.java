...
public final class CheckboxDefaults {
    ...
    public final CheckboxColors m2152colors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        CheckboxColors checkboxColorsM2139copy2qZNXz8 = getDefaultCheckboxColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2139copy2qZNXz8(jM4604getUnspecified0d7_KjU3, Color.INSTANCE.m4603getTransparent0d7_KjU(), jM4604getUnspecified0d7_KjU, Color.INSTANCE.m4603getTransparent0d7_KjU(), jM4604getUnspecified0d7_KjU4, Color.INSTANCE.m4603getTransparent0d7_KjU(), jM4604getUnspecified0d7_KjU6, jM4604getUnspecified0d7_KjU, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU4, jM4604getUnspecified0d7_KjU5, jM4604getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return checkboxColorsM2139copy2qZNXz8;
    }
