...
public final class ExposedDropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public /* synthetic */ ExposedDropdownMenuPositionProvider(Density density, int i, State state, int i2, AnonymousClass2 anonymousClass2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(density, i, (i3 & 4) != 0 ? null : state, (i3 & 8) != 0 ? density.mo651roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i2, (i3 & 16) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuPositionProvider.2
    ...
    public long mo629calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        long jIntSize = IntSizeKt.IntSize(IntSize.m7197getWidthimpl(windowSize), IntSize.m7196getHeightimpl(windowSize) + this.topWindowInsets);
        MenuPosition.Horizontal[] horizontalArr = new MenuPosition.Horizontal[3];
        int i = 0;
        horizontalArr[0] = this.startToAnchorStart;
        horizontalArr[1] = this.endToAnchorEnd;
        if (IntOffset.m7155getXimpl(anchorBounds.m7178getCenternOccac()) < IntSize.m7197getWidthimpl(jIntSize) / 2) {
        ...
        while (true) {
            ...
            iMo3194position95KtPRI = ((MenuPosition.Horizontal) listListOf.get(i2)).mo3194position95KtPRI(anchorBounds, jIntSize, IntSize.m7197getWidthimpl(popupContentSize), layoutDirection);
            if (i2 == CollectionsKt.getLastIndex(listListOf) || (iMo3194position95KtPRI >= 0 && IntSize.m7197getWidthimpl(popupContentSize) + iMo3194position95KtPRI <= IntSize.m7197getWidthimpl(jIntSize))) {
                break;
            }
            i2++;
        }
        ...
        if (IntOffset.m7156getYimpl(anchorBounds.m7178getCenternOccac()) < IntSize.m7196getHeightimpl(jIntSize) / 2) {
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            int iMo3195positionJVtK1S4 = ((MenuPosition.Vertical) listListOf2.get(i3)).mo3195positionJVtK1S4(anchorBounds, jIntSize, IntSize.m7196getHeightimpl(popupContentSize));
            if (i3 == CollectionsKt.getLastIndex(listListOf2) || (iMo3195positionJVtK1S4 >= 0 && IntSize.m7196getHeightimpl(popupContentSize) + iMo3195positionJVtK1S4 <= IntSize.m7196getHeightimpl(jIntSize))) {
