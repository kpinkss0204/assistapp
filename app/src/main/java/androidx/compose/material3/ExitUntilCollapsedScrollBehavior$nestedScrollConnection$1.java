...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo1041onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m4328getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m4343getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m4328getYimpl(available));
        if (heightOffset != this.this$0.getState().getHeightOffset()) {
            return Offset.m4321copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m4343getZeroF1C5BW0();
    }
    ...
    public long mo767onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m4328getYimpl(consumed));
        if (Offset.m4328getYimpl(available) < 0.0f || Offset.m4328getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m4328getYimpl(consumed));
            return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
        }
        if (Offset.m4328getYimpl(consumed) == 0.0f && Offset.m4328getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m4328getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo766onPostFlingRZ2iAVY(long r9, long r11, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r13) {
        /*
            r8 = this;
        ...
        L42:
            ...
            r2 = r9
            r4 = r11
            java.lang.Object r13 = super.mo766onPostFlingRZ2iAVY(r2, r4, r6)
            if (r13 != r0) goto L55
            goto L80
        L55:
            r9 = r8
        ...
        L57:
            ...
            float r11 = androidx.compose.ui.unit.Velocity.m7265getYimpl(r11)
        ...
        L82:
            ...
            long r9 = androidx.compose.ui.unit.Velocity.m7268plusAH228Gc(r9, r11)
            androidx.compose.ui.unit.Velocity r9 = androidx.compose.ui.unit.Velocity.m7255boximpl(r9)
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo766onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
