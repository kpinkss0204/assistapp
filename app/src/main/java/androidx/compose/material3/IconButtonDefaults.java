...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors iconButtonColors(Composer composer, int i) {
        ...
        IconButtonColors iconButtonColorsM2439defaultIconButtonColors4WTKRHQ$material3_release = m2439defaultIconButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), jM4578unboximpl);
        if (Color.m4569equalsimpl0(iconButtonColorsM2439defaultIconButtonColors4WTKRHQ$material3_release.getContentColor(), jM4578unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return iconButtonColorsM2439defaultIconButtonColors4WTKRHQ$material3_release;
        }
        IconButtonColors iconButtonColorsM2431copyjRlVdoo$default = IconButtonColors.m2431copyjRlVdoo$default(iconButtonColorsM2439defaultIconButtonColors4WTKRHQ$material3_release, 0L, jM4578unboximpl, 0L, Color.m4567copywmQWz5c$default(jM4578unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 5, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return iconButtonColorsM2431copyjRlVdoo$default;
    }

    /* JADX INFO: renamed from: iconButtonColors-ro_MJ88, reason: not valid java name */
    public final IconButtonColors m2447iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long jM4578unboximpl;
        long j5;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object objConsume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            jM4578unboximpl = ((Color) objConsume).m4578unboximpl();
        } else {
            jM4578unboximpl = j2;
        }
        long jM4604getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j3;
        if ((i2 & 8) != 0) {
            long j6 = jM4578unboximpl;
            jM4567copywmQWz5c$default = Color.m4567copywmQWz5c$default(j6, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j5 = j6;
        } else {
            j5 = jM4578unboximpl;
            jM4567copywmQWz5c$default = j4;
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors iconButtonColorsM2434copyjRlVdoo = m2439defaultIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) objConsume2).m4578unboximpl()).m2434copyjRlVdoo(jM4604getUnspecified0d7_KjU, j5, jM4604getUnspecified0d7_KjU2, jM4567copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m2439defaultIconButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(Color.INSTANCE.m4603getTransparent0d7_KjU(), j, Color.INSTANCE.m4603getTransparent0d7_KjU(), Color.m4567copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors iconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long jM4578unboximpl = ((Color) objConsume).m4578unboximpl();
        IconToggleButtonColors iconToggleButtonColorsM2440defaultIconToggleButtonColors4WTKRHQ$material3_release = m2440defaultIconToggleButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), jM4578unboximpl);
        if (Color.m4569equalsimpl0(iconToggleButtonColorsM2440defaultIconToggleButtonColors4WTKRHQ$material3_release.getContentColor(), jM4578unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return iconToggleButtonColorsM2440defaultIconToggleButtonColors4WTKRHQ$material3_release;
        }
        IconToggleButtonColors iconToggleButtonColorsM2456copytNS2XkQ$default = IconToggleButtonColors.m2456copytNS2XkQ$default(iconToggleButtonColorsM2440defaultIconToggleButtonColors4WTKRHQ$material3_release, 0L, jM4578unboximpl, 0L, Color.m4567copywmQWz5c$default(jM4578unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 53, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return iconToggleButtonColorsM2456copytNS2XkQ$default;
    }

    /* JADX INFO: renamed from: iconToggleButtonColors-5tl4gsc, reason: not valid java name */
    public final IconToggleButtonColors m2448iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long jM4578unboximpl;
        long j7;
        long jM4567copywmQWz5c$default;
        ...
        long jM4604getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j3;
        if ((i2 & 8) != 0) {
            long j8 = jM4578unboximpl;
            jM4567copywmQWz5c$default = Color.m4567copywmQWz5c$default(j8, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j7 = j8;
        } else {
            j7 = jM4578unboximpl;
            jM4567copywmQWz5c$default = j4;
        }
        long jM4604getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j5;
        long jM4604getUnspecified0d7_KjU4 = (i2 & 32) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object objConsume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconToggleButtonColors iconToggleButtonColorsM2457copytNS2XkQ = m2440defaultIconToggleButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) objConsume2).m4578unboximpl()).m2457copytNS2XkQ(jM4604getUnspecified0d7_KjU, j7, jM4604getUnspecified0d7_KjU2, jM4567copywmQWz5c$default, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return iconToggleButtonColorsM2457copytNS2XkQ;
    }

    /* JADX INFO: renamed from: defaultIconToggleButtonColors-4WTKRHQ$material3_release, reason: not valid java name */
    public final IconToggleButtonColors m2440defaultIconToggleButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.INSTANCE.m4603getTransparent0d7_KjU(), j, Color.INSTANCE.m4603getTransparent0d7_KjU(), Color.m4567copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m4603getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, IconButtonTokens.INSTANCE.getSelectedIconColor()), null);
    ...
    public final IconButtonColors m2443filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM4604getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j3;
        long jM4604getUnspecified0d7_KjU3 = (i2 & 8) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColorsM2434copyjRlVdoo = getDefaultFilledIconButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2434copyjRlVdoo(jM4604getUnspecified0d7_KjU, jM2233contentColorForek8zF_U, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledIconButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m2232contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor())), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m2444filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM4604getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j;
        long jM4604getUnspecified0d7_KjU2 = (i2 & 2) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j2;
        long jM4604getUnspecified0d7_KjU3 = (i2 & 4) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j3;
        long jM4604getUnspecified0d7_KjU4 = (i2 & 8) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j4;
        long jM4604getUnspecified0d7_KjU5 = (i2 & 16) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j5;
        long jM2233contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2233contentColorForek8zF_U(jM4604getUnspecified0d7_KjU5, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColorsM2457copytNS2XkQ = getDefaultFilledIconToggleButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2457copytNS2XkQ(jM4604getUnspecified0d7_KjU, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU4, jM4604getUnspecified0d7_KjU5, jM2233contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledIconToggleButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getToggleUnselectedColor()), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m2232contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final IconButtonColors m2445filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        IconButtonColors iconButtonColorsM2434copyjRlVdoo = getDefaultFilledTonalIconButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2434copyjRlVdoo(jM4604getUnspecified0d7_KjU, jM2233contentColorForek8zF_U, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledTonalIconButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m2232contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor())), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m2446filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM4604getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j3;
        long jM4604getUnspecified0d7_KjU3 = (i2 & 8) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j4;
        long jM4604getUnspecified0d7_KjU4 = (i2 & 16) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j5;
        long jM4604getUnspecified0d7_KjU5 = (i2 & 32) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColorsM2457copytNS2XkQ = getDefaultFilledTonalIconToggleButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2457copytNS2XkQ(jM4604getUnspecified0d7_KjU, jM2233contentColorForek8zF_U, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU4, jM4604getUnspecified0d7_KjU5);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledTonalIconToggleButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.m2232contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor())), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4567copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getToggleSelectedColor()), null);
    ...
    public final IconButtonColors outlinedIconButtonColors(Composer composer, int i) {
        ...
        Object objConsume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors iconButtonColorsM2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release = m2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) objConsume).m4578unboximpl());
        ProvidableCompositionLocal<Color> localContentColor2 = ContentColorKt.getLocalContentColor();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        Object objConsume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        long jM4578unboximpl = ((Color) objConsume2).m4578unboximpl();
        if (Color.m4569equalsimpl0(iconButtonColorsM2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release.getContentColor(), jM4578unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return iconButtonColorsM2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release;
        }
        IconButtonColors iconButtonColorsM2431copyjRlVdoo$default = IconButtonColors.m2431copyjRlVdoo$default(iconButtonColorsM2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release, 0L, jM4578unboximpl, 0L, Color.m4567copywmQWz5c$default(jM4578unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 5, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconButtonColors m2449outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long jM4578unboximpl;
        long j5;
        long jM4567copywmQWz5c$default;
        ...
        Object objConsume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors iconButtonColorsM2434copyjRlVdoo = m2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) objConsume2).m4578unboximpl()).m2434copyjRlVdoo(jM4604getUnspecified0d7_KjU, j5, jM4604getUnspecified0d7_KjU2, jM4567copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m2441defaultOutlinedIconButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
    ...
    public final IconToggleButtonColors outlinedIconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long jM4578unboximpl = ((Color) objConsume).m4578unboximpl();
        IconToggleButtonColors iconToggleButtonColorsM2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release = m2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), jM4578unboximpl);
        if (Color.m4569equalsimpl0(iconToggleButtonColorsM2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.getContentColor(), jM4578unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return iconToggleButtonColorsM2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release;
        }
        IconToggleButtonColors iconToggleButtonColorsM2456copytNS2XkQ$default = IconToggleButtonColors.m2456copytNS2XkQ$default(iconToggleButtonColorsM2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release, 0L, jM4578unboximpl, 0L, Color.m4567copywmQWz5c$default(jM4578unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 53, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconToggleButtonColors m2450outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long jM4578unboximpl;
        long j7;
        long jM4567copywmQWz5c$default;
        ...
        long jM4604getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j5;
        long jM2233contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2233contentColorForek8zF_U(jM4604getUnspecified0d7_KjU3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object objConsume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconToggleButtonColors iconToggleButtonColorsM2457copytNS2XkQ = m2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) objConsume2).m4578unboximpl()).m2457copytNS2XkQ(jM4604getUnspecified0d7_KjU, j7, jM4604getUnspecified0d7_KjU2, jM4567copywmQWz5c$default, jM4604getUnspecified0d7_KjU3, jM2233contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors m2442defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        IconToggleButtonColors defaultIconToggleButtonColorsCached = colorScheme.getDefaultIconToggleButtonColorsCached();
        if (defaultIconToggleButtonColorsCached != null) {
            return defaultIconToggleButtonColorsCached;
        }
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.INSTANCE.m4603getTransparent0d7_KjU(), j, Color.INSTANCE.m4603getTransparent0d7_KjU(), Color.m4567copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m2232contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object objConsume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            jM4567copywmQWz5c$default = ((Color) objConsume).m4578unboximpl();
            composer.endReplaceGroup();
        } else {
            ...
            Object objConsume2 = composer.consume(localContentColor2);
            ComposerKt.sourceInformationMarkerEnd(composer);
            jM4567copywmQWz5c$default = Color.m4567copywmQWz5c$default(((Color) objConsume2).m4578unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        ComposerKt.sourceInformationMarkerStart(composer, 176816691, "CC(remember):IconButton.kt#9igjgp");
        boolean zChanged = composer.changed(jM4567copywmQWz5c$default);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = BorderStrokeKt.m547BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m3659getUnselectedOutlineWidthD9Ej5fM(), jM4567copywmQWz5c$default);
