...
public final class RadioButtonColors {
    ...
    public static /* synthetic */ RadioButtonColors m2691copyjRlVdoo$default(RadioButtonColors radioButtonColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return radioButtonColors.m2692copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? radioButtonColors.disabledUnselectedColor : j4);
    }

    /* JADX INFO: renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RadioButtonColors m2692copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            stateRememberUpdatedState = SingleValueAnimationKt.m398animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer2, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4569equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m4569equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m4569equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m4569equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m4575hashCodeimpl(this.selectedColor) * 31) + Color.m4575hashCodeimpl(this.unselectedColor)) * 31) + Color.m4575hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m4575hashCodeimpl(this.disabledUnselectedColor);
    }
}
