...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m7025boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
            Object animatable2 = new Animatable(Dp.m7025boximpl(f), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        Dp dpM7025boximpl = Dp.m7025boximpl(f);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(dpM7025boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue4, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7032equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m7032equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m7032equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m7032equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m7032equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m7033hashCodeimpl(this.defaultElevation) * 31) + Dp.m7033hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7033hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7033hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7033hashCodeimpl(this.disabledElevation);
    }
}
