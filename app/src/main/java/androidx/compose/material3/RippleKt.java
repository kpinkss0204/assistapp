...
public final class RippleKt {
    ...
    public static /* synthetic */ IndicationNodeFactory m2707rippleH2RKhps$default(boolean z, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        if ((i & 2) != 0) {
        ...
        return m2706rippleH2RKhps(z, f, j);
    }

    /* JADX INFO: renamed from: ripple-H2RKhps, reason: not valid java name */
    public static final IndicationNodeFactory m2706rippleH2RKhps(boolean z, float f, long j) {
    ...
    public static /* synthetic */ IndicationNodeFactory m2709ripplewH6b6FI$default(ColorProducer colorProducer, boolean z, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m2708ripplewH6b6FI(colorProducer, z, f);
    }

    /* JADX INFO: renamed from: ripple-wH6b6FI, reason: not valid java name */
    public static final IndicationNodeFactory m2708ripplewH6b6FI(ColorProducer colorProducer, boolean z, float f) {
    ...
    public static final Indication m2710rippleOrFallbackImplementation9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        Composer composer2;
        IndicationNodeFactory indicationNodeFactoryM2706rippleH2RKhps;
        ...
        if (((Boolean) objConsume).booleanValue()) {
            composer2 = composer;
            indicationNodeFactoryM2706rippleH2RKhps = androidx.compose.material.ripple.RippleKt.m2049rememberRipple9IZ8Weo(z2, f2, j2, composer2, i & 1022, 0);
        } else {
            composer2 = composer;
            indicationNodeFactoryM2706rippleH2RKhps = m2706rippleH2RKhps(z2, f2, j2);
        }
        ...
        return indicationNodeFactoryM2706rippleH2RKhps;
    }
}
