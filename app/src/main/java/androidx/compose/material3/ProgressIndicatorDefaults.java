...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = ProgressIndicatorTokens.INSTANCE.m3771getTrackThicknessD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4922getRoundKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4922getRoundKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4922getRoundKaPHkGw();
    private static final float LinearTrackStopIndicatorSize = ProgressIndicatorTokens.INSTANCE.m3770getStopSizeD9Ej5fM();
    private static final float LinearIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3767getActiveTrackSpaceD9Ej5fM();
    private static final float CircularIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3767getActiveTrackSpaceD9Ej5fM();
    ...
    public static /* synthetic */ void m2656getCircularIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }
    ...
    public static /* synthetic */ void m2657getLinearIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }

    /* JADX INFO: renamed from: getLinearTrackStopIndicatorSize-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m2658getLinearTrackStopIndicatorSizeD9Ej5fM$annotations() {
    }
    ...
    public final long getCircularTrackColor(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return jM4603getTransparent0d7_KjU;
    }
    ...
    public final int m2661getCircularIndeterminateStrokeCapKaPHkGw() {
    ...
    public final float m2666getLinearTrackStopIndicatorSizeD9Ej5fM() {
    ...
    public final float m2664getLinearIndicatorTrackGapSizeD9Ej5fM() {
    ...
    public final float m2662getCircularIndicatorTrackGapSizeD9Ej5fM() {
    ...
    public final void m2659drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float fMin = Math.min(drawScope.mo657toPx0680j_4(stopSize), Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()));
        float fM4393getHeightimpl = (Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) - fMin) / 2;
        if (StrokeCap.m4917equalsimpl0(strokeCap, StrokeCap.INSTANCE.m4922getRoundKaPHkGw())) {
            float f = fMin / 2.0f;
            DrawScope.m5105drawCircleVaOC9Bg$default(drawScope, color, f, OffsetKt.Offset((Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc()) - f) - fM4393getHeightimpl, Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, 120, null);
        } else {
            DrawScope.m5118drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m4396getWidthimpl(drawScope.mo5124getSizeNHjbRc()) - fMin) - fM4393getHeightimpl, (Size.m4393getHeightimpl(drawScope.mo5124getSizeNHjbRc()) - fMin) / 2.0f), SizeKt.Size(fMin, fMin), 0.0f, null, null, 0, 120, null);
        }
    }
}
