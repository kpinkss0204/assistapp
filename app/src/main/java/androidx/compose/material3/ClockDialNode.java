...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState analogTimePickerState, boolean z, int i) {
        ...
        this.selection = i;
        this.center = IntOffset.INSTANCE.m7165getZeronOccac();
    ...
    public final float getMaxDist() {
        return DelegatableNodeKt.requireDensity(this).mo657toPx0680j_4(TimePickerKt.MaxDistance);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* JADX INFO: renamed from: onRemeasured-ozmzZPI */
    public void mo647onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m7203getCenterozmzZPI(size);
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* JADX INFO: renamed from: onPointerEvent-H0pRuoY */
    public void mo493onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo493onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo493onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m2186updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (TimePickerSelectionMode.m3050equalsimpl0(this.selection, selection)) {
            return;
        }
