...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo375measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.initialWidth != null) {
            ...
            if (!Dp.m7032equalsimpl0(width, animatable.getTargetValue().m7041unboximpl())) {
            ...
            this.initialWidth = Dp.m7025boximpl(width);
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m7032equalsimpl0(left, animatable3.getTargetValue().m7041unboximpl())) {
            ...
            this.initialOffset = Dp.m7025boximpl(left);
        }
        Animatable<Dp, AnimationVector1D> animatable5 = this.offsetAnimatable;
        if (animatable5 != null) {
            left = animatable5.getValue().m7041unboximpl();
        }
        Animatable<Dp, AnimationVector1D> animatable6 = this.widthAnimatable;
        if (animatable6 != null) {
            width = animatable6.getValue().m7041unboximpl();
        }
        final Placeable placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(Constraints.m6971copyZbe2FdA$default(j, measureScope.mo651roundToPx0680j_4(width), measureScope.mo651roundToPx0680j_4(width), 0, 0, 12, null));
        final float f = left;
        return MeasureScope.layout$default(measureScope, placeableMo5903measureBRTryo0.getWidth(), placeableMo5903measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5903measureBRTryo0, measureScope.mo651roundToPx0680j_4(f), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
