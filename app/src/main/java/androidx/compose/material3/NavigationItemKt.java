...
public final class NavigationItemKt {
    ...
    public static final void m2614NavigationItemSHbi2eg(final boolean z, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final Shape shape, final float f, final float f2, final float f3, final float f4, final float f5, final float f6, final NavigationItemColors navigationItemColors, final Modifier modifier, final boolean z2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final int i, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i2, final int i3) {
        ...
        if ((i4 & 306783379) != 306783378 || (4793491 & i6) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            final ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-44329638, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledIcon$1
                ...
                public final void invoke(Composer composer3, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4558boximpl(jM2603iconColorWaAFU9c)), function24, composer3, ProvidedValue.$stable);
                ...
                composableLambdaRememberComposableLambda2 = ComposableLambdaKt.rememberComposableLambda(-254668050, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledLabel$1$1
                    ...
                    public final void invoke(Composer composer3, int i8) {
                        ...
                        if ((i8 & 3) != 2 || !composer3.getSkipping()) {
                            ...
                            ProvideContentColorTextStyleKt.m3206ProvideContentColorTextStyle3JVO9M(navigationItemColors.m2604textColorWaAFU9c(z, z2), textStyle, function22, composer3, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            Modifier modifierM994defaultMinSizeVpY3zN4 = SizeKt.m994defaultMinSizeVpY3zN4(SelectableKt.m1216selectableO2vRcR0(modifier, z, mutableInteractionSource, null, z2, Role.m6315boximpl(Role.INSTANCE.m6328getTabo7Vup1c()), function0), NavigationItemMinWidth, NavigationItemMinHeight);
            ...
            if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$1$1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                        m2623invokeozmzZPI(intSize.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
                    public final void m2623invokeozmzZPI(long j) {
                        mutableIntState.setIntValue(IntSize.m7197getWidthimpl(j));
                    }
                };
                composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
            }
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            Modifier modifierOnSizeChanged = OnRemeasuredModifierKt.onSizeChanged(modifierM994defaultMinSizeVpY3zN4, (Function1) objRememberedValue2);
            ...
            if (NavigationItemIconPosition.m2608equalsimpl0(i, NavigationItemIconPosition.INSTANCE.m2613getTopxw1Ddg())) {
                ...
                long jOffset = OffsetKt.Offset((NavigationItem_SHbi2eg$lambda$2(mutableIntState) - r4.mo651roundToPx0680j_4(f)) / 2, ((Density) objConsume).mo657toPx0680j_4(IndicatorVerticalOffset));
            ...
            ComposerKt.sourceInformationMarkerEnd(composer2);
            int i8 = i7 << 3;
            m2615NavigationItemLayoutKmRXDg(interactionSource, selectedIndicatorColor, shape2, composableLambda, i, composableLambda2, (Function0) objRememberedValue4, f2, f3, f4, f5, f6, composer2, ((i7 >> 6) & 896) | ((i6 >> 6) & 57344) | (29360128 & i8) | (234881024 & i8) | (i8 & 1879048192), ((i7 >> 27) & 14) | ((i6 << 3) & 112));
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$3
                ...
                public final void invoke(Composer composer3, int i9) {
                    NavigationItemKt.m2614NavigationItemSHbi2eg(z, function0, function2, textStyle, shape, f, f2, f3, f4, f5, f6, navigationItemColors, modifier, z2, function22, function23, i, mutableInteractionSource, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final void m2615NavigationItemLayoutKmRXDg(final InteractionSource interactionSource, final long j, final Shape shape, final Function2<? super Composer, ? super Integer, Unit> function2, final int i, Function2<? super Composer, ? super Integer, Unit> function22, Function0<Float> function0, final float f, final float f2, final float f3, final float f4, final float f5, Composer composer, final int i2, final int i3) {
        ...
        if ((i4 & 306783379) != 306783378 || (i7 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (function23 == null || NavigationItemIconPosition.m2608equalsimpl0(i, NavigationItemIconPosition.INSTANCE.m2613getTopxw1Ddg())) {
                i6 = i4;
                composer2 = composerStartRestartGroup;
                function02 = function0;
                topIconOrIconOnlyMeasurePolicy = new TopIconOrIconOnlyMeasurePolicy(function23 != null, function0, f, f2, f3, f5, null);
            } else {
                i6 = i4;
            ...
            Updater.m4020setimpl(composerM4013constructorimpl, topIconOrIconOnlyMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m4020setimpl(composerM4013constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
            if (composerM4013constructorimpl.getInserting() || !Intrinsics.areEqual(composerM4013constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                composerM4013constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            ...
            BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.INSTANCE, IndicatorRippleLayoutIdTag), shape), interactionSource, RippleKt.m2710rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, composerStartRestartGroup, 0, 7)), composerStartRestartGroup, 0);
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            BoxKt.Box(BackgroundKt.m519backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(modifierLayoutId, (Function1) objRememberedValue), j, shape), composerStartRestartGroup, 0);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItemLayout$2
                ...
                public final void invoke(Composer composer3, int i8) {
                    NavigationItemKt.m2615NavigationItemLayoutKmRXDg(interactionSource, j, shape, function2, i, function23, function02, f, f2, f3, f4, f5, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final MeasureResult m2620placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        int iM6997constrainWidthK40F9xA = ConstraintsKt.m6997constrainWidthK40F9xA(j, placeable2.getWidth());
        int iM6996constrainHeightK40F9xA = ConstraintsKt.m6996constrainHeightK40F9xA(j, placeable2.getHeight());
        final int width = (iM6997constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int height = (iM6996constrainHeightK40F9xA - placeable3.getHeight()) / 2;
        final int width2 = (iM6997constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height2 = (iM6996constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width3 = (iM6997constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height3 = (iM6996constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, iM6997constrainWidthK40F9xA, iM6996constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasureResult m2622placeLabelAndTopIconqoqLrGI(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, float f, float f2, float f3) {
        int iM6997constrainWidthK40F9xA = ConstraintsKt.m6997constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), placeable3.getWidth()));
        int iM6996constrainHeightK40F9xA = ConstraintsKt.m6996constrainHeightK40F9xA(j, MathKt.roundToInt(placeable3.getHeight() + measureScope.mo657toPx0680j_4(f) + placeable.getHeight() + (measureScope.mo657toPx0680j_4(f3) * 2)));
        final int i = measureScope.mo651roundToPx0680j_4(Dp.m7027constructorimpl(f3 + f2));
        final int width = (iM6997constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width2 = (iM6997constrainWidthK40F9xA - placeable4.getWidth()) / 2;
        final int i2 = i - measureScope.mo651roundToPx0680j_4(f2);
        final int width3 = (iM6997constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = i + placeable2.getHeight() + measureScope.mo651roundToPx0680j_4(Dp.m7027constructorimpl(f + f2));
        final int width4 = (iM6997constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        return MeasureScope.layout$default(measureScope, iM6997constrainWidthK40F9xA, iM6996constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeLabelAndTopIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasureResult m2621placeLabelAndStartIconnru01g4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, float f) {
        int iM6997constrainWidthK40F9xA = ConstraintsKt.m6997constrainWidthK40F9xA(j, placeable3.getWidth());
        int iM6996constrainHeightK40F9xA = ConstraintsKt.m6996constrainHeightK40F9xA(j, placeable3.getHeight());
        final int width = (iM6997constrainWidthK40F9xA - placeable4.getWidth()) / 2;
        final int height = (iM6996constrainHeightK40F9xA - placeable4.getHeight()) / 2;
        final int height2 = (iM6996constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        final int height3 = (iM6996constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width2 = (iM6997constrainWidthK40F9xA - ((placeable2.getWidth() + measureScope.mo651roundToPx0680j_4(f)) + placeable.getWidth())) / 2;
        final int width3 = placeable2.getWidth() + width2 + measureScope.mo651roundToPx0680j_4(f);
        final int width4 = (iM6997constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int height4 = (iM6996constrainHeightK40F9xA - placeable3.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, iM6997constrainWidthK40F9xA, iM6996constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeLabelAndStartIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
