...
public final class DateRangePickerKt {
    ...
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m962PaddingValuesa9UjIt4$default(Dp.m7027constructorimpl(24), Dp.m7027constructorimpl(20), 0.0f, Dp.m7027constructorimpl(8), 4, null);
    private static final float HeaderHeightOffset = Dp.m7027constructorimpl(60);
    ...
    */
    ...
    public static final DateRangePickerState m2351rememberDateRangePickerStateIlFM19s(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        final int iM2372getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.INSTANCE.m2372getPickerjFl4v0() : i;
        ...
        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function0) new Function0<DateRangePickerStateImpl>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1$1
                ...
                public final DateRangePickerStateImpl invoke() {
                    return new DateRangePickerStateImpl(l4, l5, l6, yearRange, iM2372getPickerjFl4v0, allDates, localeDefaultLocale, null);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        DateRangePickerStateImpl dateRangePickerStateImpl = (DateRangePickerStateImpl) RememberSaveableKt.m4139rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static /* synthetic */ DateRangePickerState m2347DateRangePickerStateHVP43zI$default(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        if ((i2 & 4) != 0) {
        ...
        return m2346DateRangePickerStateHVP43zI(locale, l, l2, l3, intRange, i, selectableDates);
    }

    /* JADX INFO: renamed from: DateRangePickerState-HVP43zI, reason: not valid java name */
    public static final DateRangePickerState m2346DateRangePickerStateHVP43zI(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates) {
    ...
    public static final void m2348SwitchableDateEntryContentRN2D1Q(final Long l, final Long l2, final long j, final int i, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i2, final int i3) {
        int i4;
        Long l3;
        long j2;
        ...
        if ((i4 & 306783379) != 306783378 || (i5 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(DisplayMode.m2364boximpl(i), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer3, Integer num) {
                    m2353invokeQujVXRc(displayMode.getValue(), composer3, num.intValue());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m2353invokeQujVXRc(int i6, Composer composer3, int i7) {
                    int i8;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$3
                ...
                public final void invoke(Composer composer3, int i6) {
                    DateRangePickerKt.m2348SwitchableDateEntryContentRN2D1Q(l, l2, j, i, function2, function1, calendarModel, intRange, datePickerFormatter, selectableDates, datePickerColors, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final void DateRangePickerContent(final Long l, final Long l2, final long j, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 306783379) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM967paddingVpY3zN4$default = PaddingKt.m967paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, obj);
            ...
            Modifier modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composerStartRestartGroup, modifierM967paddingVpY3zN4$default);
            ...
            TextKt.ProvideTextStyle(TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getDateLabelTextFont(), composerStartRestartGroup, 6), ComposableLambdaKt.rememberComposableLambda(1090773432, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        String strM3278getString2EP1pXo = Strings_androidKt.m3278getString2EP1pXo(Strings.m3208constructorimpl(R.string.m3c_date_range_picker_scroll_to_previous_month), composer2, 0);
                        Strings.Companion companion2 = Strings.INSTANCE;
                        String strM3278getString2EP1pXo2 = Strings_androidKt.m3278getString2EP1pXo(Strings.m3208constructorimpl(R.string.m3c_date_range_picker_scroll_to_next_month), composer2, 0);
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        final List listCustomScrollActions = DateRangePickerKt.customScrollActions(lazyListState2, coroutineScope, strM3278getString2EP1pXo, strM3278getString2EP1pXo2);
                                                ...
                                                TextKt.ProvideTextStyle(TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont(), composer3, 6), ComposableLambdaKt.rememberComposableLambda(1622100276, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1$1
                                                    ...
                                                    public final void invoke(Composer composer4, int i8) {
                                                        ...
                                                        if ((i8 & 3) != 2 || !composer4.getSkipping()) {
                                                            ...
                                                            TextKt.m2996Text4IGK_g(monthYear, SemanticsModifierKt.semantics$default(modifierPadding, false, (Function1) objRememberedValue5, 1, null), datePickerColors4.getSubheadContentColor(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 131064);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                                ComposerKt.traceEventEnd();
                                                                return;
                                                            }
    ...
    public static final void m2350drawRangeBackgroundmxwnekA(ContentDrawScope contentDrawScope, SelectedRangeInfo selectedRangeInfo, long j) {
        float fM4396getWidthimpl;
        float f = contentDrawScope.mo657toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = contentDrawScope.mo657toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = contentDrawScope.mo657toPx0680j_4(DatePickerModalTokens.INSTANCE.m3447getDateStateLayerHeightD9Ej5fM());
        float f4 = 2;
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float fM4396getWidthimpl2 = (Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()) - (f6 * f)) / f6;
        long gridStartCoordinates = selectedRangeInfo.getGridStartCoordinates();
        int iM7155getXimpl = IntOffset.m7155getXimpl(gridStartCoordinates);
        int iM7156getYimpl = IntOffset.m7156getYimpl(gridStartCoordinates);
        long gridEndCoordinates = selectedRangeInfo.getGridEndCoordinates();
        int iM7155getXimpl2 = IntOffset.m7155getXimpl(gridEndCoordinates);
        int iM7156getYimpl2 = IntOffset.m7156getYimpl(gridEndCoordinates);
        float f7 = f + fM4396getWidthimpl2;
        float f8 = fM4396getWidthimpl2 / f4;
        float fM4396getWidthimpl3 = (iM7155getXimpl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f9 = (iM7156getYimpl * f2) + f5;
        float f10 = iM7155getXimpl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float fM4396getWidthimpl4 = f10 + f + f8;
        float f11 = (iM7156getYimpl2 * f2) + f5;
        boolean z = contentDrawScope.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            fM4396getWidthimpl3 = Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()) - fM4396getWidthimpl3;
            fM4396getWidthimpl4 = Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()) - fM4396getWidthimpl4;
        }
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        long jOffset = OffsetKt.Offset(fM4396getWidthimpl3, f9);
        if (iM7156getYimpl == iM7156getYimpl2) {
            fM4396getWidthimpl = fM4396getWidthimpl4 - fM4396getWidthimpl3;
        } else {
            fM4396getWidthimpl = z ? -fM4396getWidthimpl3 : Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()) - fM4396getWidthimpl3;
        }
        DrawScope.m5118drawRectnJ9OG0$default(contentDrawScope2, j, jOffset, SizeKt.Size(fM4396getWidthimpl, f3), 0.0f, null, null, 0, 120, null);
        if (iM7156getYimpl != iM7156getYimpl2) {
            for (int i = (iM7156getYimpl2 - iM7156getYimpl) - 1; i > 0; i--) {
                DrawScope.m5118drawRectnJ9OG0$default(contentDrawScope2, j, OffsetKt.Offset(0.0f, (i * f2) + f9), SizeKt.Size(Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()), f3), 0.0f, null, null, 0, 120, null);
            }
            long jOffset2 = OffsetKt.Offset(contentDrawScope.getLayoutDirection() != LayoutDirection.Ltr ? Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc()) : 0.0f, f11);
            if (z) {
                fM4396getWidthimpl4 -= Size.m4396getWidthimpl(contentDrawScope.mo5124getSizeNHjbRc());
            }
            DrawScope.m5118drawRectnJ9OG0$default(contentDrawScope2, j, jOffset2, SizeKt.Size(fM4396getWidthimpl4, f3), 0.0f, null, null, 0, 120, null);
        }
    }
    ...
    static {
        float f = 64;
        float f2 = 12;
        DateRangePickerTitlePadding = PaddingKt.m962PaddingValuesa9UjIt4$default(Dp.m7027constructorimpl(f), 0.0f, Dp.m7027constructorimpl(f2), 0.0f, 10, null);
        DateRangePickerHeadlinePadding = PaddingKt.m962PaddingValuesa9UjIt4$default(Dp.m7027constructorimpl(f), 0.0f, Dp.m7027constructorimpl(f2), Dp.m7027constructorimpl(f2), 2, null);
    }
}
