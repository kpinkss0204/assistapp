...
public final class CarouselAlignment {
    ...
    private static final int Start = m3173constructorimpl(-1);
    private static final int Center = m3173constructorimpl(0);
    private static final int End = m3173constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CarouselAlignment m3172boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m3174equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3176hashCodeimpl(this.value);
    }

    public String toString() {
        return m3177toStringimpl(this.value);
    }
