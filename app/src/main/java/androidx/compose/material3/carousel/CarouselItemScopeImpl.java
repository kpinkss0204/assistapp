...
public final class CarouselItemScopeImpl implements CarouselItemScope {
    ...
    public Modifier maskClip(Modifier modifier, Shape shape, Composer composer, int i) {
        ...
        Modifier modifierClip = ClipKt.clip(modifier, rememberMaskShape(shape, composer, (i >> 3) & WebSocketProtocol.PAYLOAD_SHORT));
        if (ComposerKt.isTraceInProgress()) {
    ...
    public Modifier maskBorder(Modifier modifier, BorderStroke borderStroke, Shape shape, Composer composer, int i) {
        ...
        Modifier modifierBorder = BorderKt.border(modifier, borderStroke, rememberMaskShape(shape, composer, (i >> 6) & WebSocketProtocol.PAYLOAD_SHORT));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$rememberMaskShape$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                    m3185invoke12SF9DM(path, size.getPackedValue(), layoutDirection);
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-12SF9DM, reason: not valid java name */
                public final void m3185invoke12SF9DM(Path path, long j, LayoutDirection layoutDirection) {
                    Rect rectIntersect = this.this$0.getItemInfo().getMaskRect().intersect(SizeKt.m4417toRectuvyYCjk(j));
                    OutlineKt.addOutline(path, shape.mo568createOutlinePq9zytI(rectIntersect.m4360getSizeNHjbRc(), layoutDirection, density));
                    path.mo4463translatek4lQ0M(OffsetKt.Offset(rectIntersect.getLeft(), rectIntersect.getTop()));
                }
            });
