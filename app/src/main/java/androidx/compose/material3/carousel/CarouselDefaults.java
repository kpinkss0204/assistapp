...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m7027constructorimpl(40);
    private static final float MaxSmallItemSize = Dp.m7027constructorimpl(56);
    private static final float AnchorSize = Dp.m7027constructorimpl(10);
