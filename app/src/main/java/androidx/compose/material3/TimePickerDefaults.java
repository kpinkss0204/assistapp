...
public final class TimePickerDefaults {
    ...
    public final TimePickerColors m3020colorsu3YEpmA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, Composer composer, int i, int i2, int i3) {
        ...
        long jM4604getUnspecified0d7_KjU14 = (i3 & 8192) != 0 ? Color.INSTANCE.m4604getUnspecified0d7_KjU() : j14;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-646352288, i, i2, "androidx.compose.material3.TimePickerDefaults.colors (TimePicker.kt:317)");
        }
        TimePickerColors timePickerColorsM3001copydVHXu7A = getDefaultTimePickerColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m3001copydVHXu7A(jM4604getUnspecified0d7_KjU, jM4604getUnspecified0d7_KjU4, jM4604getUnspecified0d7_KjU5, jM4604getUnspecified0d7_KjU6, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU7, jM4604getUnspecified0d7_KjU8, jM4604getUnspecified0d7_KjU9, jM4604getUnspecified0d7_KjU10, jM4604getUnspecified0d7_KjU11, jM4604getUnspecified0d7_KjU12, jM4604getUnspecified0d7_KjU13, jM4604getUnspecified0d7_KjU14);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return timePickerColorsM3001copydVHXu7A;
    }
    ...
    public final int m3021layoutTypesDNSZnc(Composer composer, int i) {
