...
public final class SliderTokens {
    ...
    private static final float ValueIndicatorActiveBottomSpace = Dp.m7027constructorimpl((float) 12.0d);
    ...
    static {
        float f = (float) 44.0d;
        ActiveHandleHeight = Dp.m7027constructorimpl(f);
        float f2 = (float) 6.0d;
        ActiveHandleLeadingSpace = Dp.m7027constructorimpl(f2);
        ActiveHandlePadding = Dp.m7027constructorimpl(f2);
        ActiveHandleTrailingSpace = Dp.m7027constructorimpl(f2);
        float f3 = (float) 4.0d;
        ActiveHandleWidth = Dp.m7027constructorimpl(f3);
        float f4 = (float) 16.0d;
        ActiveTrackHeight = Dp.m7027constructorimpl(f4);
        DisabledHandleWidth = Dp.m7027constructorimpl(f3);
        float f5 = (float) 2.0d;
        FocusHandleWidth = Dp.m7027constructorimpl(f5);
        HandleHeight = Dp.m7027constructorimpl(f);
        HandleWidth = Dp.m7027constructorimpl(f3);
        HoverHandleWidth = Dp.m7027constructorimpl(f3);
        InactiveTrackHeight = Dp.m7027constructorimpl(f4);
        PressedHandleWidth = Dp.m7027constructorimpl(f5);
        StopIndicatorSize = Dp.m7027constructorimpl(f3);
        StopIndicatorTrailingSpace = Dp.m7027constructorimpl(f2);
    }
    ...
    public final float m3792getActiveHandleTrailingSpaceD9Ej5fM() {
        return ActiveHandleTrailingSpace;
    }

    /* JADX INFO: renamed from: getActiveHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m3793getActiveHandleWidthD9Ej5fM() {
    ...
    public final float m3794getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3795getDisabledHandleWidthD9Ej5fM() {
    ...
    public final float m3796getFocusHandleWidthD9Ej5fM() {
    ...
    public final float m3797getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3798getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3799getHoverHandleWidthD9Ej5fM() {
    ...
    public final float m3800getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3802getStopIndicatorSizeD9Ej5fM() {
        return StopIndicatorSize;
    }

    /* JADX INFO: renamed from: getStopIndicatorTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m3803getStopIndicatorTrailingSpaceD9Ej5fM() {
    ...
    public final float m3804getValueIndicatorActiveBottomSpaceD9Ej5fM() {
