...
public final class ProgressIndicatorTokens {
    ...
    private static final float Size = Dp.m7027constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveThickness = Dp.m7027constructorimpl(f);
        ActiveTrackSpace = Dp.m7027constructorimpl(f);
        StopShape = Dp.m7027constructorimpl(f);
        StopSize = Dp.m7027constructorimpl(f);
        TrackThickness = Dp.m7027constructorimpl(f);
    }
    ...
    public final float m3766getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* JADX INFO: renamed from: getActiveTrackSpace-D9Ej5fM, reason: not valid java name */
    public final float m3767getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3769getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* JADX INFO: renamed from: getStopSize-D9Ej5fM, reason: not valid java name */
    public final float m3770getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3771getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* JADX INFO: renamed from: getSize-D9Ej5fM, reason: not valid java name */
    public final float m3768getSizeD9Ej5fM() {
        return Size;
    }
}
