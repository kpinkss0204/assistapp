...
public final class OutlinedTextFieldTokens {
    ...
    private static final float FocusOutlineWidth = Dp.m7027constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 1.0d;
        DisabledOutlineWidth = Dp.m7027constructorimpl(f);
        HoverOutlineWidth = Dp.m7027constructorimpl(f);
        float f2 = (float) 24.0d;
        LeadingIconSize = Dp.m7027constructorimpl(f2);
        OutlineWidth = Dp.m7027constructorimpl(f);
        TrailingIconSize = Dp.m7027constructorimpl(f2);
    }
    ...
    public final float m3663getContainerHeightD9Ej5fM() {
    ...
    public final float m3664getDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m3665getFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m3666getHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m3667getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3668getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
    ...
    public final float m3669getTrailingIconSizeD9Ej5fM() {
