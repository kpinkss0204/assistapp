...
public final class TimeInputTokens {
    ...
    private static final float PeriodSelectorContainerWidth = Dp.m7027constructorimpl((float) 52.0d);
    ...
    private static final float TimeFieldContainerWidth = Dp.m7027constructorimpl((float) 96.0d);
    ...
    private static final float TimeFieldFocusOutlineWidth = Dp.m7027constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 72.0d;
        PeriodSelectorContainerHeight = Dp.m7027constructorimpl(f);
        TimeFieldContainerHeight = Dp.m7027constructorimpl(f);
    }
    ...
    public final float m3835getContainerElevationD9Ej5fM() {
    ...
    public final float m3836getPeriodSelectorContainerHeightD9Ej5fM() {
    ...
    public final float m3837getPeriodSelectorContainerWidthD9Ej5fM() {
    ...
    public final float m3838getPeriodSelectorOutlineWidthD9Ej5fM() {
    ...
    public final float m3839getTimeFieldContainerHeightD9Ej5fM() {
    ...
    public final float m3840getTimeFieldContainerWidthD9Ej5fM() {
    ...
    public final float m3841getTimeFieldFocusOutlineWidthD9Ej5fM() {
