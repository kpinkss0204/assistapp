...
public final class InputChipTokens {
    ...
    private static final float SelectedOutlineWidth = Dp.m7027constructorimpl((float) AudioStats.AUDIO_AMPLITUDE_NONE);
    ...
    private static final float UnselectedOutlineWidth = Dp.m7027constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m7027constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m7027constructorimpl(f);
        TrailingIconSize = Dp.m7027constructorimpl(f);
    }
    ...
    public final float m3598getDraggedContainerElevationD9Ej5fM() {
    ...
    public final float m3600getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m3602getUnselectedOutlineWidthD9Ej5fM() {
    ...
    public final float m3595getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m3599getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3601getTrailingIconSizeD9Ej5fM() {
