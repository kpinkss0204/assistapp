...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m7027constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m3478getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m7027constructorimpl((float) 80.0d);
    ...
    public final float m3621getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3622getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m3624getContainerHeightD9Ej5fM() {
    ...
    public final float m3625getIconSizeD9Ej5fM() {
        return IconSize;
    }
