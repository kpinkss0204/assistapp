...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m7027constructorimpl((float) 112.0d);
    ...
    public final float m3860getContainerHeightD9Ej5fM() {
    ...
    public final float m3861getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3862getTrailingIconSizeD9Ej5fM() {
