...
public final class SecondaryNavigationTabTokens {
    ...
    private static final float DividerHeight = Dp.m7027constructorimpl((float) 1.0d);
    ...
    public final float m3781getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3782getContainerHeightD9Ej5fM() {
    ...
    public final float m3783getDividerHeightD9Ej5fM() {
    ...
    public final float m3784getIconSizeD9Ej5fM() {
        return IconSize;
    }
