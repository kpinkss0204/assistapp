...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m7027constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m7027constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m7027constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m3477getLevel1D9Ej5fM();
    private static final ColorSchemeKeyTokens StandardContainerColor = ColorSchemeKeyTokens.Surface;
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m3476getLevel0D9Ej5fM();
    ...
    public final float m3626getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3627getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m3630getModalContainerElevationD9Ej5fM() {
    ...
    public final float m3631getStandardContainerElevationD9Ej5fM() {
