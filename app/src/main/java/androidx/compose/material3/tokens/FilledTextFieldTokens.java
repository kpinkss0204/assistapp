...
public final class FilledTextFieldTokens {
    ...
    private static final float FocusActiveIndicatorHeight = Dp.m7027constructorimpl((float) 2.0d);
    ...
    static {
        ...
        DisabledActiveIndicatorHeight = Dp.m7027constructorimpl(f);
        HoverActiveIndicatorHeight = Dp.m7027constructorimpl(f);
    ...
    public final float m3560getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3561getDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3562getFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3563getHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3565getTrailingIconSizeD9Ej5fM() {
