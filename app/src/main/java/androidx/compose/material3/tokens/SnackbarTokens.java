...
public final class SnackbarTokens {
    ...
    private static final float SingleLineContainerHeight = Dp.m7027constructorimpl((float) 48.0d);
    private static final float TwoLinesContainerHeight = Dp.m7027constructorimpl((float) 68.0d);
    ...
    public final float m3806getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m3807getSingleLineContainerHeightD9Ej5fM() {
        return SingleLineContainerHeight;
    }

    /* JADX INFO: renamed from: getTwoLinesContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3808getTwoLinesContainerHeightD9Ej5fM() {
