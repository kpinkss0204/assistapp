...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m7027constructorimpl((float) 512.0d);
    ...
    public final float m3437getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3438getContainerHeightD9Ej5fM() {
