...
public final class OutlinedAutocompleteTokens {
    ...
    private static final float TextFieldFocusOutlineWidth = Dp.m7027constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 1.0d;
        TextFieldDisabledOutlineWidth = Dp.m7027constructorimpl(f);
        TextFieldHoverOutlineWidth = Dp.m7027constructorimpl(f);
        float f2 = (float) 24.0d;
        TextFieldLeadingIconSize = Dp.m7027constructorimpl(f2);
        TextFieldOutlineWidth = Dp.m7027constructorimpl(f);
        TextFieldTrailingIconSize = Dp.m7027constructorimpl(f2);
    }
    ...
    public final float m3639getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m3640getTextFieldDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m3641getTextFieldFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m3642getTextFieldHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m3643getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3644getTextFieldOutlineWidthD9Ej5fM() {
    ...
    public final float m3645getTextFieldTrailingIconSizeD9Ej5fM() {
