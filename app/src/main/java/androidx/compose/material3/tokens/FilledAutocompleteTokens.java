...
public final class FilledAutocompleteTokens {
    ...
    private static final float MenuContainerElevation = ElevationTokens.INSTANCE.m3478getLevel2D9Ej5fM();
    ...
    private static final float TextFieldFocusActiveIndicatorHeight = Dp.m7027constructorimpl((float) 2.0d);
    ...
    private static final float TextFieldLeadingIconSize = Dp.m7027constructorimpl((float) 20.0d);
    ...
    private static final float TextFieldTrailingIconSize = Dp.m7027constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 1.0d;
        TextFieldActiveIndicatorHeight = Dp.m7027constructorimpl(f);
        TextFieldDisabledActiveIndicatorHeight = Dp.m7027constructorimpl(f);
        TextFieldHoverActiveIndicatorHeight = Dp.m7027constructorimpl(f);
    }
    ...
    public final float m3536getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m3537getTextFieldActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3538getTextFieldDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3539getTextFieldFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3540getTextFieldHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3541getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3542getTextFieldTrailingIconSizeD9Ej5fM() {
