...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m7027constructorimpl((float) 152.0d);
    ...
    public final float m3855getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3856getContainerHeightD9Ej5fM() {
    ...
    public final float m3857getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3858getTrailingIconSizeD9Ej5fM() {
