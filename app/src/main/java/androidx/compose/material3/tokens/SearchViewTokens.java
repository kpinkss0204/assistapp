...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m7027constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m7027constructorimpl((float) 72.0d);
    ...
    public final float m3778getContainerElevationD9Ej5fM() {
    ...
    public final float m3779getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m3780getFullScreenHeaderContainerHeightD9Ej5fM() {
