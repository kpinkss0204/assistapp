...
public final class TypeScaleTokens {
    ...
    static {
        ...
        TextUnitKt.m7233checkArithmeticR2X_6o(sp);
        DisplayLargeTracking = TextUnitKt.pack(TextUnit.m7218getRawTypeimpl(sp), -TextUnit.m7220getValueimpl(sp));
