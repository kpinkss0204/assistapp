...
public final class OutlinedCardTokens {
    ...
    private static final float OutlineWidth = Dp.m7027constructorimpl((float) 1.0d);
    ...
    public final float m3650getDisabledContainerElevationD9Ej5fM() {
    ...
    public final float m3651getDraggedContainerElevationD9Ej5fM() {
    ...
    public final float m3652getFocusContainerElevationD9Ej5fM() {
    ...
    public final float m3653getHoverContainerElevationD9Ej5fM() {
    ...
    public final float m3655getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
