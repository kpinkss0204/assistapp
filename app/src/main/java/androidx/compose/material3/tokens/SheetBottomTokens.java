...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m7027constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m7027constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m3477getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m3477getLevel1D9Ej5fM();
    ...
    public final float m3785getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m3786getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m3787getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m3788getDockedStandardContainerElevationD9Ej5fM() {
