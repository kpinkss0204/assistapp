...
public final class PrimaryNavigationTabTokens {
    ...
    private static final float ContainerHeight = Dp.m7027constructorimpl((float) 48.0d);
    ...
    private static final float IconAndLabelTextContainerHeight = Dp.m7027constructorimpl((float) 64.0d);
    ...
    static {
        float f = (float) 3.0d;
        ActiveIndicatorHeight = Dp.m7027constructorimpl(f);
        ActiveIndicatorShape = RoundedCornerShapeKt.m1248RoundedCornerShape0680j_4(Dp.m7027constructorimpl(f));
    }
    ...
    public final float m3761getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3762getContainerElevationD9Ej5fM() {
    ...
    public final float m3764getIconAndLabelTextContainerHeightD9Ej5fM() {
