...
final class StartIconMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo322measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        float f = 2;
        long jM6999offsetNN6EwU = ConstraintsKt.m6999offsetNN6EwU(jM6971copyZbe2FdA$default, -measureScope2.mo651roundToPx0680j_4(Dp.m7027constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope2.mo651roundToPx0680j_4(Dp.m7027constructorimpl(this.indicatorVerticalPadding * f)));
        int size = list.size();
        int i = 0;
        while (i < size) {
            Measurable measurable = list.get(i);
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                Placeable placeableMo5903measureBRTryo0 = measurable.mo5903measureBRTryo0(jM6999offsetNN6EwU);
                int size2 = list.size();
                int i2 = 0;
                while (i2 < size2) {
                    Measurable measurable2 = list.get(i2);
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "label")) {
                        Placeable placeableMo5903measureBRTryo02 = measurable2.mo5903measureBRTryo0(ConstraintsKt.m7000offsetNN6EwU$default(jM6999offsetNN6EwU, -(placeableMo5903measureBRTryo0.getWidth() + measureScope2.mo651roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, null));
                        int width = placeableMo5903measureBRTryo0.getWidth() + placeableMo5903measureBRTryo02.getWidth() + measureScope2.mo651roundToPx0680j_4(Dp.m7027constructorimpl(this.startIconToLabelHorizontalPadding + Dp.m7027constructorimpl(this.indicatorHorizontalPadding * f)));
                        int iMax = Math.max(placeableMo5903measureBRTryo0.getHeight(), placeableMo5903measureBRTryo02.getHeight()) + measureScope2.mo651roundToPx0680j_4(Dp.m7027constructorimpl(this.indicatorVerticalPadding * f));
                        ...
                        while (i3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                Placeable placeableMo5903measureBRTryo03 = measurable3.mo5903measureBRTryo0(ConstraintsKt.m6995constrainN9IONVI(jM6971copyZbe2FdA$default, Constraints.INSTANCE.m6990fixedJhjzzOo(width, iMax)));
                                int size4 = list.size();
                                int i4 = 0;
                                while (i4 < size4) {
                                    Measurable measurable4 = list.get(i4);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "indicator")) {
                                        return NavigationItemKt.m2621placeLabelAndStartIconnru01g4(measureScope2, placeableMo5903measureBRTryo02, placeableMo5903measureBRTryo0, placeableMo5903measureBRTryo03, measurable4.mo5903measureBRTryo0(ConstraintsKt.m6995constrainN9IONVI(jM6971copyZbe2FdA$default, Constraints.INSTANCE.m6990fixedJhjzzOo(iRoundToInt, iMax))), j, this.startIconToLabelHorizontalPadding);
                                    }
                                    i4++;
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return iMaxIntrinsicWidth + intrinsicMeasurable2.maxIntrinsicWidth(i) + intrinsicMeasureScope.mo651roundToPx0680j_4(Dp.m7027constructorimpl(Dp.m7027constructorimpl(this.indicatorHorizontalPadding * 2) + this.startIconToLabelHorizontalPadding));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    IntrinsicMeasurable intrinsicMeasurable2 = list.get(i3);
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return Math.max(iMaxIntrinsicHeight, intrinsicMeasurable2.maxIntrinsicHeight(i)) + intrinsicMeasureScope.mo651roundToPx0680j_4(Dp.m7027constructorimpl(this.indicatorVerticalPadding * 2));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
