...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4569equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m4569equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m4575hashCodeimpl(this.containerColor) * 31) + Color.m4575hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
