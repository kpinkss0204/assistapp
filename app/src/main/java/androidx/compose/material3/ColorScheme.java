...
public final class ColorScheme {
    ...
    public static /* synthetic */ ColorScheme m2192copyG1PFcw$default(ColorScheme colorScheme, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, long j25, long j26, long j27, long j28, long j29, int i, Object obj) {
        long j30;
        long j31;
        long j32;
        long j33;
        ...
        return colorScheme2.m2194copyG1PFcw(j65, j53, j54, j55, j56, j57, j46, j47, j48, j49, j50, j51, j52, j39, j40, j41, j42, j43, j44, j45, j32, j33, j34, j35, j36, j37, j38, j31, j30);
    }
    ...
    public final /* synthetic */ ColorScheme m2194copyG1PFcw(long primary, long onPrimary, long primaryContainer, long onPrimaryContainer, long inversePrimary, long secondary, long onSecondary, long secondaryContainer, long onSecondaryContainer, long tertiary, long onTertiary, long tertiaryContainer, long onTertiaryContainer, long background, long onBackground, long surface, long onSurface, long surfaceVariant, long onSurfaceVariant, long surfaceTint, long inverseSurface, long inverseOnSurface, long error, long onError, long errorContainer, long onErrorContainer, long outline, long outlineVariant, long scrim) {
        return m2191copyCXl9yA$default(this, primary, onPrimary, primaryContainer, onPrimaryContainer, inversePrimary, secondary, onSecondary, secondaryContainer, onSecondaryContainer, tertiary, onTertiary, tertiaryContainer, onTertiaryContainer, background, onBackground, surface, onSurface, surfaceVariant, onSurfaceVariant, surfaceTint, inverseSurface, inverseOnSurface, error, onError, errorContainer, onErrorContainer, outline, outlineVariant, scrim, 0L, 0L, 0L, 0L, 0L, 0L, 0L, -536870912, 15, null);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("ColorScheme(primary=");
        sb.append((Object) Color.m4576toStringimpl(this.primary)).append("onPrimary=").append((Object) Color.m4576toStringimpl(this.onPrimary)).append("primaryContainer=").append((Object) Color.m4576toStringimpl(this.primaryContainer)).append("onPrimaryContainer=").append((Object) Color.m4576toStringimpl(this.onPrimaryContainer)).append("inversePrimary=").append((Object) Color.m4576toStringimpl(this.inversePrimary)).append("secondary=").append((Object) Color.m4576toStringimpl(this.secondary)).append("onSecondary=").append((Object) Color.m4576toStringimpl(this.onSecondary)).append("secondaryContainer=").append((Object) Color.m4576toStringimpl(this.secondaryContainer)).append("onSecondaryContainer=").append((Object) Color.m4576toStringimpl(this.onSecondaryContainer)).append("tertiary=").append((Object) Color.m4576toStringimpl(this.tertiary)).append("onTertiary=").append((Object) Color.m4576toStringimpl(this.onTertiary)).append("tertiaryContainer=");
        sb.append((Object) Color.m4576toStringimpl(this.tertiaryContainer)).append("onTertiaryContainer=").append((Object) Color.m4576toStringimpl(this.onTertiaryContainer)).append("background=").append((Object) Color.m4576toStringimpl(this.background)).append("onBackground=").append((Object) Color.m4576toStringimpl(this.onBackground)).append("surface=").append((Object) Color.m4576toStringimpl(this.surface)).append("onSurface=").append((Object) Color.m4576toStringimpl(this.onSurface)).append("surfaceVariant=").append((Object) Color.m4576toStringimpl(this.surfaceVariant)).append("onSurfaceVariant=").append((Object) Color.m4576toStringimpl(this.onSurfaceVariant)).append("surfaceTint=").append((Object) Color.m4576toStringimpl(this.surfaceTint)).append("inverseSurface=").append((Object) Color.m4576toStringimpl(this.inverseSurface)).append("inverseOnSurface=").append((Object) Color.m4576toStringimpl(this.inverseOnSurface)).append("error=").append((Object) Color.m4576toStringimpl(this.error));
        sb.append("onError=").append((Object) Color.m4576toStringimpl(this.onError)).append("errorContainer=").append((Object) Color.m4576toStringimpl(this.errorContainer)).append("onErrorContainer=").append((Object) Color.m4576toStringimpl(this.onErrorContainer)).append("outline=").append((Object) Color.m4576toStringimpl(this.outline)).append("outlineVariant=").append((Object) Color.m4576toStringimpl(this.outlineVariant)).append("scrim=").append((Object) Color.m4576toStringimpl(this.scrim)).append("surfaceBright=").append((Object) Color.m4576toStringimpl(this.surfaceBright)).append("surfaceDim=").append((Object) Color.m4576toStringimpl(this.surfaceDim)).append("surfaceContainer=").append((Object) Color.m4576toStringimpl(this.surfaceContainer)).append("surfaceContainerHigh=").append((Object) Color.m4576toStringimpl(this.surfaceContainerHigh)).append("surfaceContainerHighest=").append((Object) Color.m4576toStringimpl(this.surfaceContainerHighest)).append("surfaceContainerLow=");
        sb.append((Object) Color.m4576toStringimpl(this.surfaceContainerLow)).append("surfaceContainerLowest=").append((Object) Color.m4576toStringimpl(this.surfaceContainerLowest)).append(')');
        return sb.toString();
    }
