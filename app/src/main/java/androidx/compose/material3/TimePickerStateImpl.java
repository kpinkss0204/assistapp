...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int i, int i2, boolean z) {
        ...
        this.is24hour = z;
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m3047boximpl(TimePickerSelectionMode.INSTANCE.m3054getHouryecRtBI()), null, 2, null);
    ...
    public int mo2062getSelectionyecRtBI() {
        return ((TimePickerSelectionMode) this.selection.getValue()).m3053unboximpl();
    }

    @Override // androidx.compose.material3.TimePickerState
    /* JADX INFO: renamed from: setSelection-6_8s6DQ */
    public void mo2063setSelection6_8s6DQ(int i) {
        this.selection.setValue(TimePickerSelectionMode.m3047boximpl(i));
    }
