...
public final class SegmentedButtonDefaults {
    ...
    private static final float BorderWidth = OutlinedSegmentedButtonTokens.INSTANCE.m3662getOutlineWidthD9Ej5fM();
    private static final float IconSize = OutlinedSegmentedButtonTokens.INSTANCE.m3661getIconSizeD9Ej5fM();
    ...
    public final SegmentedButtonColors m2755colorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        SegmentedButtonColors segmentedButtonColorsM2740copy2qZNXz8 = getDefaultSegmentedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2740copy2qZNXz8(jM4604getUnspecified0d7_KjU, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU4, jM4604getUnspecified0d7_KjU5, jM4604getUnspecified0d7_KjU6, jM4604getUnspecified0d7_KjU7, jM4604getUnspecified0d7_KjU8, jM4604getUnspecified0d7_KjU9, jM4604getUnspecified0d7_KjU10, jM4604getUnspecified0d7_KjU11, jM4604getUnspecified0d7_KjU12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return segmentedButtonColorsM2740copy2qZNXz8;
    }
    ...
    public final float m2756getBorderWidthD9Ej5fM() {
        return BorderWidth;
    }
    ...
    public final float m2757getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final void ActiveIcon(Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            IconKt.m2453Iconww6aTOc(CheckKt.getCheck(Icons.Filled.INSTANCE), (String) null, SizeKt.m1010size3ABfNKs(Modifier.INSTANCE, IconSize), 0L, composerStartRestartGroup, 48, 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    */
    ...
    public static /* synthetic */ BorderStroke m2753borderStrokel07J4OM$default(SegmentedButtonDefaults segmentedButtonDefaults, long j, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            f = BorderWidth;
        }
        return segmentedButtonDefaults.m2754borderStrokel07J4OM(j, f);
    }

    /* JADX INFO: renamed from: borderStroke-l07J4OM, reason: not valid java name */
    public final BorderStroke m2754borderStrokel07J4OM(long color, float width) {
        return BorderStrokeKt.m547BorderStrokecXLIe8U(width, color);
    }
}
