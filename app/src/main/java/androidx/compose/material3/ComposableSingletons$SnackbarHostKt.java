...
public final class ComposableSingletons$SnackbarHostKt {
    ...
    public static Function3<SnackbarData, Composer, Integer, Unit> f64lambda1 = ComposableLambdaKt.composableLambdaInstance(818736383, false, new Function3<SnackbarData, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$SnackbarHostKt$lambda-1$1
        ...
        public final void invoke(SnackbarData snackbarData, Composer composer, int i) {
            ...
            SnackbarKt.m2832SnackbarsDKtq54(snackbarData2, null, false, null, 0L, 0L, 0L, 0L, 0L, composer, i2 & 14, TypedValues.PositionType.TYPE_POSITION_TYPE);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<SnackbarData, Composer, Integer, Unit> m2284getLambda1$material3_release() {
        return f64lambda1;
    }
}
