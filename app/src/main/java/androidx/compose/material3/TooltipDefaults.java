...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m7049DpSizeYgX7TsA(Dp.m7027constructorimpl(16), Dp.m7027constructorimpl(8));
    ...
    public final long m3143getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m3146richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors richTooltipColorsM2700copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2700copyjRlVdoo(jM4604getUnspecified0d7_KjU, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return richTooltipColorsM2700copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m3144rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        final int iMo651roundToPx0680j_4 = ((Density) objConsume).mo651roundToPx0680j_4(f);
        ComposerKt.sourceInformationMarkerStart(composer, 1994502237, "CC(remember):Tooltip.kt#9igjgp");
        boolean zChanged = composer.changed(iMo651roundToPx0680j_4);
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo629calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7197getWidthimpl(popupContentSize)) / 2);
                    int top = (anchorBounds.getTop() - IntSize.m7196getHeightimpl(popupContentSize)) - iMo651roundToPx0680j_4;
                    if (top < 0) {
                        top = iMo651roundToPx0680j_4 + anchorBounds.getBottom();
                    }
    ...
    public final PopupPositionProvider m3145rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo629calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m7197getWidthimpl(popupContentSize) + left > IntSize.m7197getWidthimpl(windowSize) && (left = anchorBounds.getRight() - IntSize.m7197getWidthimpl(popupContentSize)) < 0) {
                        left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7197getWidthimpl(popupContentSize)) / 2);
                    }
                    int top = (anchorBounds.getTop() - IntSize.m7196getHeightimpl(popupContentSize)) - iMo651roundToPx0680j_4;
                    if (top < 0) {
                        top = iMo651roundToPx0680j_4 + anchorBounds.getBottom();
