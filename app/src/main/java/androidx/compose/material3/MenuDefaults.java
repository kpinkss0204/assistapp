...
public final class MenuDefaults {
    ...
    private static final float ShadowElevation = MenuTokens.INSTANCE.m3620getContainerElevationD9Ej5fM();
    private static final PaddingValues DropdownMenuItemContentPadding = PaddingKt.m959PaddingValuesYgX7TsA(MenuKt.DropdownMenuItemHorizontalPadding, Dp.m7027constructorimpl(0));
    ...
    public final MenuItemColors m2532itemColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        MenuItemColors menuItemColorsM2534copytNS2XkQ = getDefaultMenuItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2534copytNS2XkQ(jM4604getUnspecified0d7_KjU, jM4604getUnspecified0d7_KjU2, jM4604getUnspecified0d7_KjU3, jM4604getUnspecified0d7_KjU4, jM4604getUnspecified0d7_KjU5, jM4604getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return menuItemColorsM2534copytNS2XkQ;
    }
