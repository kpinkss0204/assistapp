...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m7027constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m7027constructorimpl(8);
    ...
    public static final void m2544DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long j, final float f, final float f2, final BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 306783379) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                obj = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        ...
                        graphicsLayerScope.mo4761setTransformOrigin__ExYCQ(mutableState.getValue().getPackedValue());
                    }
                };
            ...
            ComposableLambda composableLambdaRememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1573559053, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        Modifier modifierVerticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m967paddingVpY3zN4$default(modifier, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
            ...
            int i4 = i3 >> 9;
            int i5 = i3 >> 6;
            SurfaceKt.m2846SurfaceT9BRK9s(modifierGraphicsLayer, shape, j, 0L, f, f2, borderStroke, composableLambdaRememberComposableLambda, composerStartRestartGroup, (i4 & 896) | (i4 & 112) | 12582912 | (57344 & i5) | (458752 & i5) | (i5 & 3670016), 8);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$3
                ...
                public final void invoke(Composer composer3, int i6) {
                    MenuKt.m2544DropdownMenuContentQj0Zi0g(modifier, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> function2, final Function0<Unit> function0, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final boolean z, final MenuItemColors menuItemColors, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i) {
        ...
        if ((38347923 & i2) != 38347922 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierPadding = PaddingKt.padding(SizeKt.m1014sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m551clickableO2vRcR0$default(modifier, mutableInteractionSource, RippleKt.m2710rippleOrFallbackImplementation9IZ8Weo(true, 0.0f, 0L, composerStartRestartGroup, 6, 6), z, null, null, function0, 24, null), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuListItemContainerHeight, DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), paddingValues);
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6).getLabelLarge(), ComposableLambdaKt.rememberComposableLambda(1065051884, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            ProvidedValue<Color> providedValueProvides = ContentColorKt.getLocalContentColor().provides(Color.m4558boximpl(menuItemColors.m2541leadingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(providedValueProvides, ComposableLambdaKt.rememberComposableLambda(2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier modifierM995defaultMinSizeVpY3zN4$default = SizeKt.m995defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m3609getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Modifier modifierMaterializeModifier2 = ComposedModifierKt.materializeModifier(composer3, modifierM995defaultMinSizeVpY3zN4$default);
                        ...
                        ProvidedValue<Color> providedValueProvides2 = ContentColorKt.getLocalContentColor().provides(Color.m4558boximpl(menuItemColors.m2542textColorvNxB06k$material3_release(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(providedValueProvides2, ComposableLambdaKt.rememberComposableLambda(-1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (function25 != null) {
                                        fM7027constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        fM7027constructorimpl = Dp.m7027constructorimpl(0);
                                    }
                                    float f = fM7027constructorimpl;
                                    if (function26 != null) {
                                        fM7027constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        fM7027constructorimpl2 = Dp.m7027constructorimpl(0);
                                    }
                                    Modifier modifierM969paddingqDBjuR0$default = PaddingKt.m969paddingqDBjuR0$default(modifierWeight$default, f, 0.0f, fM7027constructorimpl2, 0.0f, 10, null);
                                    ...
                                    int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(composer3, 0);
                                    CompositionLocalMap currentCompositionLocalMap2 = composer3.getCurrentCompositionLocalMap();
                                    Modifier modifierMaterializeModifier2 = ComposedModifierKt.materializeModifier(composer3, modifierM969paddingqDBjuR0$default);
                                    Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                                    ComposerKt.sourceInformationMarkerStart(composer3, -692256719, "CC(ReusableComposeNode)P(1,2)376@14062L9:Composables.kt#9igjgp");
                                    if (!(composer3.getApplier() instanceof Applier)) {
                                        ComposablesKt.invalidApplier();
                        ...
                        if (function23 != null) {
                            ProvidedValue<Color> providedValueProvides3 = ContentColorKt.getLocalContentColor().provides(Color.m4558boximpl(menuItemColors.m2543trailingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(providedValueProvides3, ComposableLambdaKt.rememberComposableLambda(580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier modifierM995defaultMinSizeVpY3zN4$default = SizeKt.m995defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m3617getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
    ...
    */
    ...
    static {
        float f = 48;
        MenuVerticalMargin = Dp.m7027constructorimpl(f);
        MenuListItemContainerHeight = Dp.m7027constructorimpl(f);
    }
}
