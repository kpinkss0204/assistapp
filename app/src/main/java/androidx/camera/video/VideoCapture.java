...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(final String str, VideoCaptureConfig<T> videoCaptureConfig, final StreamSpec streamSpec) {
        Timebase timebase;
        final VideoCaptureConfig<T> videoCaptureConfig2;
        ...
        VideoEncoderInfo videoEncoderInfo = videoCapture.getVideoEncoderInfo(videoCaptureConfig.getVideoEncoderInfoFinder(), videoCapabilities, dynamicRange, mediaSpec, resolution, range);
        videoCapture.mRotationDegrees = videoCapture.adjustRotationWithInProgressTransformation(videoCapture.getRelativeRotation(cameraInternal, videoCapture.isMirroringRequired(cameraInternal)));
        Rect rectCalculateCropRect = videoCapture.calculateCropRect(resolution, videoEncoderInfo);
        ...
        SurfaceProcessorNode surfaceProcessorNodeCreateNodeIfNeeded = videoCapture.createNodeIfNeeded(cameraInternal, videoCapture.mCropRect, resolution, dynamicRange);
        ...
        if (videoCapture.mNode != null) {
            SurfaceProcessorNode.OutConfig outConfigOf = SurfaceProcessorNode.OutConfig.of(videoCapture.mCameraEdge);
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m223lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig2, timebase2);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m224lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        videoCaptureConfig2.getVideoOutput().onSurfaceRequested(videoCapture.mSurfaceRequest, timebase2);
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda6
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m225lambda$createPipeline$3$androidxcameravideoVideoCapture(str, videoCaptureConfig2, streamSpec, sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m224lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    /* synthetic */ void m225lambda$createPipeline$3$androidxcameravideoVideoCapture(String str, VideoCaptureConfig videoCaptureConfig, StreamSpec streamSpec, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
    ...
    public void m223lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda2
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m226xc7537f7(builder, completer);
            }
        });
    ...
    /* synthetic */ Object m226xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(CameraCaptureResult cameraCaptureResult) {
            ...
            scheduledExecutorServiceMainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m227lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onCaptureCompleted$0$androidx-camera-video-VideoCapture$2, reason: not valid java name */
        /* synthetic */ void m227lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
