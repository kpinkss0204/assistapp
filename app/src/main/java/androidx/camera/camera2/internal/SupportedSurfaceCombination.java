...
final class SupportedSurfaceCombination {
    ...
    Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecifications(int i, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map) {
        ...
        int i4 = i;
        FeatureSettings featureSettingsCreateFeatureSettings = createFeatureSettings(i4, mapResolveAndValidateDynamicRanges);
        ...
        if (!this.mIsStreamUseCaseSupported || zContainsZslUseCase) {
            ...
            while (true) {
                if (!it2.hasNext()) {
                    ...
                    map2 = map10;
                    map3 = map13;
                    z = zIsUseCasesCombinationSupported;
                    map4 = map12;
                    break;
                }
                z = zIsUseCasesCombinationSupported;
                map4 = map12;
                Pair<List<SurfaceConfig>, Integer> surfaceConfigListAndFpsCeiling = getSurfaceConfigListAndFpsCeiling(i4, list, it2.next(), arrayList, useCasesPriorityOrder, maxSupportedFpsFromAttachedSurfaces, map10, map11);
                HashMap map14 = map11;
                i2 = maxSupportedFpsFromAttachedSurfaces;
                map2 = map10;
                map3 = map14;
                ...
                i4 = i;
                map12 = map4;
                zIsUseCasesCombinationSupported = z;
            }
            if (orderedSupportedStreamUseCaseSurfaceConfigList == null && !z) {
                throw new IllegalArgumentException("No supported surface combination is found for camera device - Id : " + this.mCameraId + ".  May be attempting to bind too many use cases. Existing surfaces: " + list + " New configs: " + arrayList);
            }
        ...
        while (true) {
            ...
            str2 = str4;
            map6 = map15;
            Pair<List<SurfaceConfig>, Integer> surfaceConfigListAndFpsCeiling2 = getSurfaceConfigListAndFpsCeiling(i, list, next, arrayList, useCasesPriorityOrder, i8, null, null);
            ...
            boolean z4 = targetFpsRange == null || i8 <= iIntValue || iIntValue >= ((Integer) targetFpsRange.getLower()).intValue();
            if (!z2 && checkSupported(featureSettingsCreateFeatureSettings, list8)) {
                if (i9 == i10 || i9 < iIntValue) {
                    list6 = next;
                    i9 = iIntValue;
                }
                if (z4) {
            ...
            if (list3 == null || z3 || getOrderedSupportedStreamUseCaseSurfaceConfigList(featureSettingsCreateFeatureSettings, list8) == null) {
                i7 = i7;
            } else {
                int i11 = i7;
