...
public class CameraAccessExceptionCompat extends Exception {
    ...
    static final Set<Integer> COMPAT_ERRORS = Collections.unmodifiableSet(new HashSet(Arrays.asList(10001, Integer.valueOf(CAMERA_CHARACTERISTICS_CREATION_ERROR))));
