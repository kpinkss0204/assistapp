...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo7289clone() {
        CLContainer cLContainer = (CLContainer) super.mo7289clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo7289clone = it.next().mo7289clone();
            cLElementMo7289clone.setContainer(cLContainer);
            arrayList.add(cLElementMo7289clone);
        }
