...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m7467putCharSequenceListimpl(SavedStateWriter.m7455constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7389getCharSequenceListimpl(SavedStateReader.m7369constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
