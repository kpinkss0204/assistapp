...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m7486putSizeFimpl(SavedStateWriter.m7455constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7433getSizeFimpl(SavedStateReader.m7369constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
