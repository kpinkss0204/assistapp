...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    public void serialize(Encoder encoder, CharSequence[] value) {
        ...
        SavedStateWriter.m7466putCharSequenceArrayimpl(SavedStateWriter.m7455constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7387getCharSequenceArrayimpl(SavedStateReader.m7369constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
