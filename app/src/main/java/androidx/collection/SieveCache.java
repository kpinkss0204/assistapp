...
public final class SieveCache<K, V> {
    ...
    */
    ...
    public final void adjustStorage$collection() {
        if (this._capacity > 8 && Long.compare(ULong.m8053constructorimpl(ULong.m8053constructorimpl(get_count()) * 32) ^ Long.MIN_VALUE, ULong.m8053constructorimpl(ULong.m8053constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
