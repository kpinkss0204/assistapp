        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: androidx.activity.compose.ActivityResultRegistryKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return ActivityResultRegistryKt.rememberLauncherForActivityResult$lambda$1$lambda$0();
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        final String str2 = (String) RememberSaveableKt.m4139rememberSaveable(objArr, (Saver) null, (String) null, (Function0) objRememberedValue, composer, 3072, 6);
        ...
        if (zChangedInstance || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
            ...
            Object obj = new Function1() { // from class: androidx.activity.compose.ActivityResultRegistryKt$$ExternalSyntheticLambda1
                ...
                public final Object invoke(Object obj2) {
                    return ActivityResultRegistryKt.rememberLauncherForActivityResult$lambda$8$lambda$7(activityResultLauncherHolder, activityResultRegistry, str2, activityResultContract, stateRememberUpdatedState2, (DisposableEffectScope) obj2);
                }
            };
            str = str2;
    ...
    public static final DisposableEffectResult rememberLauncherForActivityResult$lambda$8$lambda$7(final ActivityResultLauncherHolder activityResultLauncherHolder, ActivityResultRegistry activityResultRegistry, String str, ActivityResultContract activityResultContract, final State state, DisposableEffectScope disposableEffectScope) {
        activityResultLauncherHolder.setLauncher(activityResultRegistry.register(str, activityResultContract, new ActivityResultCallback() { // from class: androidx.activity.compose.ActivityResultRegistryKt$$ExternalSyntheticLambda2
            ...
            public final void onActivityResult(Object obj) {
                ActivityResultRegistryKt.rememberLauncherForActivityResult$lambda$8$lambda$7$lambda$5(state, obj);
            }
        }));
