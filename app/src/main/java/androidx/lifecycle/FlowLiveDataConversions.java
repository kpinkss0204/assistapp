...
public final class FlowLiveDataConversions {
    ...
    static final class C06831<T> extends SuspendLambda implements Function2<LiveDataScope<T>, Continuation<? super Unit>, Object> {
        ...
        C06831(Flow<? extends T> flow, Continuation<? super C06831> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06831 c06831 = new C06831(this.$this_asLiveData, continuation);
            c06831.L$0 = obj;
            return c06831;
        }
        ...
        public final Object invoke(LiveDataScope<T> liveDataScope, Continuation<? super Unit> continuation) {
            return ((C06831) create(liveDataScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> LiveData<T> asLiveData(Flow<? extends T> flow, CoroutineContext context, long j) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        Camera2CameraInfoImpl.RedirectableLiveData redirectableLiveData = (LiveData<T>) CoroutineLiveDataKt.liveData(context, j, new C06831(flow, null));
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
            ...
            if (r1 == 0) {
                ...
                Observer observer2 = new Observer() { // from class: androidx.lifecycle.FlowLiveDataConversions$asFlow$1$$ExternalSyntheticLambda0
                    ...
                    public final void onChanged(Object obj2) {
                        producerScope.mo9384trySendJP2dKIU(obj2);
                    }
                };
                this.L$0 = observer2;
                this.label = 1;
                Object objWithContext = BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C01561(this.$this_asFlow, observer2, null), this);
                observer = observer2;
        ...
        static final class C01561 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01561(LiveData<T> liveData, Observer<T> observer, Continuation<? super C01561> continuation) {
                super(2, continuation);
                this.$this_asFlow = liveData;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01561(this.$this_asFlow, this.$observer, continuation);
            }
