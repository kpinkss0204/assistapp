...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C06811 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06811(Set<String> set, Continuation<? super C06811> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06811 c06811 = new C06811(this.$keysToMigrate, continuation);
            c06811.L$0 = obj;
            return c06811;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C06811) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
