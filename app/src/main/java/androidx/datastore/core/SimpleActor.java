...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM9404getOrNullimpl = ChannelResult.m9404getOrNullimpl(((SimpleActor) this).messageQueue.mo9392tryReceivePtdJZtk());
                        if (objM9404getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM9404getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo9384trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM9403exceptionOrNullimpl = ChannelResult.m9403exceptionOrNullimpl(obj);
            if (thM9403exceptionOrNullimpl != null) {
                throw thM9403exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m9409isSuccessimpl(obj)) {
