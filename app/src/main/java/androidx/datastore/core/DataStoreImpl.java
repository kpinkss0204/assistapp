...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    static final class C06651 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06651(DataStoreImpl<T> dataStoreImpl, Continuation<? super C06651> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C06661 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06661(DataStoreImpl<T> dataStoreImpl, Continuation<? super C06661> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C06671 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06671(DataStoreImpl<T> dataStoreImpl, Continuation<? super C06671> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C06681 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06681(DataStoreImpl<T> dataStoreImpl, Continuation<? super C06681> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C06701 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06701(DataStoreImpl<T> dataStoreImpl, Continuation<? super C06701> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    */
    public final java.lang.Object incrementCollector(kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        /*
            r11 = this;
            boolean r0 = r12 instanceof androidx.datastore.core.DataStoreImpl.C06661
            if (r0 == 0) goto L14
            r0 = r12
            androidx.datastore.core.DataStoreImpl$incrementCollector$1 r0 = (androidx.datastore.core.DataStoreImpl.C06661) r0
            int r1 = r0.label
    ...
    */
    ...
    public Object updateData(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        return BuildersKt.withContext(new UpdatingDataContextElement(updatingDataContextElement, this), new C06742(this, function2, null), continuation);
    }
    ...
    static final class C06742 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C06742(DataStoreImpl<T> dataStoreImpl, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C06742> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06742 c06742 = new C06742(this.this$0, this.$transform, continuation);
            c06742.L$0 = obj;
            return c06742;
        }
    ...
    static final class C06722 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super State<T>>, Object> {
        final /* synthetic */ boolean $requireLock;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06722(DataStoreImpl<T> dataStoreImpl, boolean z, Continuation<? super C06722> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
            this.$requireLock = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06722(this.this$0, this.$requireLock, continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L5d:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl.C06722.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final Object readState(boolean z, Continuation<? super State<T>> continuation) {
        return BuildersKt.withContext(this.scope.getCoroutineContext(), new C06722(this, z, null), continuation);
    }
    ...
    */
    public final java.lang.Object readAndInitOrPropagateAndThrowFailure(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.datastore.core.DataStoreImpl.C06671
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.core.DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1 r0 = (androidx.datastore.core.DataStoreImpl.C06671) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    ...
    static final class C06693 extends SuspendLambda implements Function1<Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        Object L$0;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06693(DataStoreImpl<T> dataStoreImpl, Continuation<? super C06693> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C06693(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Pair<? extends State<T>, Boolean>> continuation) {
            return ((C06693) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C06732 extends SuspendLambda implements Function1<Continuation<? super T>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06732(DataStoreImpl<T> dataStoreImpl, CoroutineContext coroutineContext, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C06732> continuation) {
            super(1, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C06732(this.this$0, this.$callerContext, this.$transform, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super T> continuation) {
            return ((C06732) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) throws androidx.datastore.core.CorruptionException {
            ...
            L76:
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl.C06732.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public final Object transformAndWrite(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, CoroutineContext coroutineContext, Continuation<? super T> continuation) {
        return getCoordinator().lock(new C06732(this, coroutineContext, function2, null), continuation);
    }
    ...
    */
    ...
    static final class C06713 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06713(Ref.ObjectRef<T> objectRef, DataStoreImpl<T> dataStoreImpl, Ref.IntRef intRef, Continuation<? super C06713> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C06713(this.$newData, this.this$0, this.$version, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C06713) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
