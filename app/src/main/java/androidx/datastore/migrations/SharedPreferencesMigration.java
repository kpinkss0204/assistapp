...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C06801 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C06801(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C06801> continuation) {
            super(continuation);
    ...
    */
    public java.lang.Object shouldMigrate(T r5, kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.datastore.migrations.SharedPreferencesMigration.C06801
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.migrations.SharedPreferencesMigration$shouldMigrate$1 r0 = (androidx.datastore.migrations.SharedPreferencesMigration.C06801) r0
            int r1 = r0.label
